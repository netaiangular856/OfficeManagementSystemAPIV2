        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelationshipScore = table.Column<byte>(type: "tinyint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredChannel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "email"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZone = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false, defaultValue: "Asia/Dubai"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Employee_ManagerNotSelf", "[ManagerId] IS NULL OR [ManagerId] <> [Id]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibleToEmployee = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeNotes_AspNetUsers_AddedByUserId",
                        column: x => x.AddedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmployeeNotes_AspNetUsers_EmployeeUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceNumbers = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedByUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Letters_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleInMeeting = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "required"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SummaryAI = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Recommendations_Meetings_MeetingId",
                        column: x => x.MeetingId,
                        principalTable: "Meetings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskUpdates_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeNotes_AddedByUserId",
                table: "EmployeeNotes",
                column: "AddedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeNotes_EmployeeUserId_CreatedAt",
                table: "EmployeeNotes",
                columns: new[] { "EmployeeUserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_LetterAttachments_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingAttachments_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingAttendees_AttendanceStatus",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskUpdates_CreatedAt",
                table: "TaskUpdates",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_TaskUpdates_CreatedByUserId",
                table: "TaskUpdates",
                column: "CreatedByUserId");

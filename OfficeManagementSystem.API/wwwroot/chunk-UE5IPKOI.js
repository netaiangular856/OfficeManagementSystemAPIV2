...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "users",
        loadChildren: () => import("./chunk-CI3HVERU.js").then((m) => m.UsersModule),
        canActivate: [PermissionGuard],
        data: { permission: "user.index" }
      },
      {
        path: "roles",
        loadChildren: () => import("./chunk-N2553MB2.js").then((m) => m.RolesModule),
        canActivate: [PermissionGuard],
        data: { permission: "admin.index" }
      },
      {
        path: "employees",
        loadChildren: () => import("./chunk-BOSP3TS7.js").then((m) => m.EmployeesModule),
        canActivate: [PermissionGuard],
      ...
      {
        path: "departments",
        loadChildren: () => import("./chunk-KAPDLUCD.js").then((m) => m.DepartmentsModule),
        canActivate: [PermissionGuard],
        data: { permission: "department.index" }
      },
      {
        path: "tasks",
        loadChildren: () => import("./chunk-2CJILGQ5.js").then((m) => m.TasksModule)
      },
      {
        path: "partners",
      ...
      {
        path: "visits",
        loadChildren: () => import("./chunk-64PFKNLZ.js").then((m) => m.VisitsModule),
        canActivate: [PermissionGuard],
      ...
      {
        path: "meetings",
        loadChildren: () => import("./chunk-3IIZBXUO.js").then((m) => m.MeetingsModule),
        canActivate: [PermissionGuard],
        data: { permission: "meeting.index" }
      },
      {
        path: "my-calendar",
        loadChildren: () => import("./chunk-2MWF64VK.js").then((m) => m.CalendarModule),
        canActivate: [PermissionGuard],
      ...
      {
        path: "letters",
        loadChildren: () => import("./chunk-5AIQ6D7G.js").then((m) => m.LettersModule)
      },
      {
        path: "documents",
      ...
      {
        path: "notifications",
        loadComponent: () => import("./chunk-VSSPSTZH.js").then((m) => m.NotificationsComponent)
      }
      // {
      //   path: '',
...
//# sourceMappingURL=chunk-UE5IPKOI.js.map

...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-J5YBCW4V.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-YQHLP4C5.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-L2RND3UW.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-IRDYBMGT.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-NJGI2BH3.js.map

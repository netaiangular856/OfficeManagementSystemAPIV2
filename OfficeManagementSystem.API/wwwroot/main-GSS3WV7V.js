...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-MN33V5OY.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-G6S3FKD4.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-K7JGVALV.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-PVMBLAML.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-GSS3WV7V.js.map

...
function SidebarComponent_span_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.dashboard"));
  }
}
function SidebarComponent_span_26_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.users"));
  }
}
function SidebarComponent_span_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.employees"));
  }
}
function SidebarComponent_span_40_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.tasks"));
  }
}
function SidebarComponent_span_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.partners"));
  }
}
function SidebarComponent_span_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.visits"));
  }
}
function SidebarComponent_span_68_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.travel"));
  }
}
function SidebarComponent_span_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.meetings"));
  }
}
function SidebarComponent_span_82_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.letters"));
  }
}
function SidebarComponent_span_91_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.documents"));
  }
}
function SidebarComponent_span_100_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.workflow"));
  }
}
function SidebarComponent_span_108_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.departments"));
  }
}
function SidebarComponent_span_118_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.send_notification"));
  }
}
function SidebarComponent_span_124_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.settings"));
  }
}
function SidebarComponent_div_127_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 96)(1, "div", 97)(2, "div", 98)(3, "img", 99);
    \u0275\u0275listener("error", function SidebarComponent_div_127_Template_img_error_3_listener($event) {
      \u0275\u0275restoreView(_r2);
      return \u0275\u0275resetView($event.target.src = "assets/images/user.png");
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 100)(5, "span", 101);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("src", ctx_r0.getUserImageUrl(), \u0275\u0275sanitizeUrl)("alt", ctx_r0.getFullName());
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.getFullName());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.getPrimaryRole());
  }
}
function SidebarComponent_span_134_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 95);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.translate("sidebar.logout"));
  }
}
var SidebarComponent = class _SidebarComponent {
  ...
  constructor(router, translationService, langService, authService, profileService, imageService) {
    this.router = router;
  ...
  static \u0275fac = function SidebarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SidebarComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(TranslationService), \u0275\u0275directiveInject(LangService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(ProfileService), \u0275\u0275directiveInject(ImageService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], inputs: { rtl: "rtl" }, outputs: { collapsedChange: "collapsedChange", logoutConfirmRequested: "logoutConfirmRequested", notificationModalRequested: "notificationModalRequested" }, standalone: false, decls: 135, vars: 32, consts: [[1, "sidebar"], [1, "sidebar-header"], ["class", "logo-section", 4, "ngIf"], [1, "collapse-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "chevron-icon"], ["points", "15,18 9,12 15,6"], [1, "mobile-expand-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "3", "y1", "12", "x2", "21", "y2", "12"], ["x1", "3", "y1", "6", "x2", "21", "y2", "6"], ["x1", "3", "y1", "18", "x2", "21", "y2", "18"], [1, "sidebar-nav", "custom-scrollbar"], [1, "nav-list"], [1, "nav-item"], ["routerLink", "/dashboard", "routerLinkActive", "active", 1, "nav-link"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "nav-icon"], ["d", "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"], ["points", "9,22 9,12 15,12 15,22"], ["class", "nav-text", 4, "ngIf"], ["routerLink", "/users", "routerLinkActive", "active", 1, "nav-link"], ["d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 0 1 0 7.75"], ["d", "M16 3.13a4 4 0 0 1 0 7.75"], ["routerLink", "/employees", "routerLinkActive", "active", 1, "nav-link"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "nav-icon"], ["d", "M3 21v-2a4 4 0 0 1 4-4h4"], ["cx", "20", "cy", "9", "r", "3"], ["d", "M17 21v-2a3 3 0 0 1 3-3h3"], ["routerLink", "/tasks", "routerLinkActive", "active", 1, "nav-link"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], ["routerLink", "/partners", "routerLinkActive", "active", 1, "nav-link"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "lucide", "lucide-handshake-icon", "lucide-handshake"], ["d", "m11 17 2 2a1 1 0 1 0 3-3"], ["d", "m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"], ["d", "m21 3 1 11h-2"], ["d", "M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"], ["d", "M3 4h8"], ["routerLink", "/visits", "routerLinkActive", "active", 1, "nav-link"], ["x", "3", "y", "4", "width", "18", "height", "18", "rx", "2", "ry", "2"], ["x1", "16", "y1", "2", "x2", "16", "y2", "6"], ["x1", "8", "y1", "2", "x2", "8", "y2", "6"], ["x1", "3", "y1", "10", "x2", "21", "y2", "10"], ["cx", "8", "cy", "14", "r", "1.5", "fill", "currentColor"], ["cx", "12", "cy", "14", "r", "1.5", "fill", "currentColor"], ["cx", "16", "cy", "14", "r", "1.5", "fill", "currentColor"], ["cx", "12", "cy", "18", "r", "2"], ["x1", "12", "y1", "18", "x2", "12", "y2", "16", "stroke-width", "1.5"], ["x1", "12", "y1", "18", "x2", "13.5", "y2", "18", "stroke-width", "1.5"], ["routerLink", "/travel", "routerLinkActive", "active", 1, "nav-link"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "lucide", "lucide-plane-icon", "lucide-plane"], ["d", "M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"], ["routerLink", "/meetings", "routerLinkActive", "active", 1, "nav-link"], ["d", "M2 3h20"], ["d", "M21 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V3"], ["d", "m7 21 5-5 5 5"], ["routerLink", "/letters", "routerLinkActive", "active", 1, "nav-link"], ["d", "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"], ["points", "22,6 12,13 2,6"], ["d", "M2 8l10 5 10-5"], ["routerLink", "/documents", "routerLinkActive", "active", 1, "nav-link"], ["d", "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"], ["points", "14,2 14,8 20,8"], ["x1", "16", "y1", "13", "x2", "8", "y2", "13"], ["x1", "16", "y1", "17", "x2", "8", "y2", "17"], ["points", "10,9 9,9 8,9"], ["routerLink", "/workflow", "routerLinkActive", "active", 1, "nav-link"], ["d", "M3 3h6l3 3h9v12H3z"], ["d", "M9 3v6h6"], ["d", "M12 9h6"], ["d", "M12 12h6"], ["d", "M12 15h6"], ["routerLink", "/departments", "routerLinkActive", "active", 1, "nav-link"], ["x", "3", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "14", "width", "7", "height", "7"], ["x", "3", "y", "14", "width", "7", "height", "7"], [1, "nav-divider"], [1, "nav-link", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-label", "Send notification", "role", "img", 1, "nav-icon", "icon-send-notification"], ["d", "M18 10a6 6 0 10-12 0v2c0 1.6-.6 3.1-1.6 4.2h15.2A6.2 6.2 0 0 1 18 12v-2"], ["d", "M13.5 20a1.5 1.5 0 0 1-3 0"], ["d", "M15 5h6v6"], ["d", "M21 5L13 13"], ["routerLink", "/settings", "routerLinkActive", "active", 1, "nav-link"], ["cx", "12", "cy", "12", "r", "3"], ["d", "M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1 1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09A1.65 1.65 0 0 0 19.4 15z"], ["class", "user-profile-section", "routerLink", "/profile", "style", "cursor: pointer", 4, "ngIf"], [1, "nav-link", "logout-btn", 3, "click"], ["d", "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"], ["points", "16,17 21,12 16,7"], ["x1", "21", "y1", "12", "x2", "9", "y2", "12"], [1, "logo-section"], ["src", "/logo.png", "alt", "EcoOffice", 1, "logo"], [1, "nav-text"], ["routerLink", "/profile", 1, "user-profile-section", 2, "cursor", "pointer"], [1, "user-profile-info"], [1, "user-avatar"], [1, "profile-pic", 3, "error", "src", "alt"], [1, "user-details"], [1, "user-name"], [1, "user-role"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "aside", 0)(1, "div", 1);
      \u0275\u0275template(2, SidebarComponent_div_2_Template, 2, 0, "div", 2);
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(11, "nav", 11)(12, "ul", 12)(13, "li", 13)(14, "a", 14);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(15, "svg", 15);
      \u0275\u0275element(16, "path", 16)(17, "polyline", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275template(18, SidebarComponent_span_18_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(19, "li", 13)(20, "a", 19);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(21, "svg", 15);
      \u0275\u0275element(22, "path", 20)(23, "circle", 21)(24, "path", 22)(25, "path", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275template(26, SidebarComponent_span_26_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(27, "li", 13)(28, "a", 24);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(29, "svg", 25);
      \u0275\u0275element(30, "circle", 21)(31, "path", 26)(32, "circle", 27)(33, "path", 28);
      \u0275\u0275elementEnd();
      \u0275\u0275template(34, SidebarComponent_span_34_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(35, "li", 13)(36, "a", 29);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(37, "svg", 15);
      \u0275\u0275element(38, "path", 30)(39, "polyline", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275template(40, SidebarComponent_span_40_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(41, "li", 13)(42, "a", 32);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(43, "svg", 33);
      \u0275\u0275element(44, "path", 34)(45, "path", 35)(46, "path", 36)(47, "path", 37)(48, "path", 38);
      \u0275\u0275elementEnd();
      \u0275\u0275template(49, SidebarComponent_span_49_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(50, "li", 13)(51, "a", 39);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(52, "svg", 25);
      \u0275\u0275element(53, "rect", 40)(54, "line", 41)(55, "line", 42)(56, "line", 43)(57, "circle", 44)(58, "circle", 45)(59, "circle", 46)(60, "circle", 47)(61, "line", 48)(62, "line", 49);
      \u0275\u0275elementEnd();
      \u0275\u0275template(63, SidebarComponent_span_63_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(64, "li", 13)(65, "a", 50);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(66, "svg", 51);
      \u0275\u0275element(67, "path", 52);
      \u0275\u0275elementEnd();
      \u0275\u0275template(68, SidebarComponent_span_68_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(69, "li", 13)(70, "a", 53);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(71, "svg", 25);
      \u0275\u0275element(72, "path", 54)(73, "path", 55)(74, "path", 56);
      \u0275\u0275elementEnd();
      \u0275\u0275template(75, SidebarComponent_span_75_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(76, "li", 13)(77, "a", 57);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(78, "svg", 15);
      \u0275\u0275element(79, "path", 58)(80, "polyline", 59)(81, "path", 60);
      \u0275\u0275elementEnd();
      \u0275\u0275template(82, SidebarComponent_span_82_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(83, "li", 13)(84, "a", 61);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(85, "svg", 15);
      \u0275\u0275element(86, "path", 62)(87, "polyline", 63)(88, "line", 64)(89, "line", 65)(90, "polyline", 66);
      \u0275\u0275elementEnd();
      \u0275\u0275template(91, SidebarComponent_span_91_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(92, "li", 13)(93, "a", 67);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(94, "svg", 15);
      \u0275\u0275element(95, "path", 68)(96, "path", 69)(97, "path", 70)(98, "path", 71)(99, "path", 72);
      \u0275\u0275elementEnd();
      \u0275\u0275template(100, SidebarComponent_span_100_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(101, "li", 13)(102, "a", 73);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(103, "svg", 15);
      \u0275\u0275element(104, "rect", 74)(105, "rect", 75)(106, "rect", 76)(107, "rect", 77);
      \u0275\u0275elementEnd();
      \u0275\u0275template(108, SidebarComponent_span_108_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275element(109, "div", 78);
      \u0275\u0275elementStart(110, "ul", 12)(111, "li", 13)(112, "button", 79);
      \u0275\u0275listener("click", function SidebarComponent_Template_button_click_112_listener() {
        return ctx.openNotificationModal();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(113, "svg", 80);
      \u0275\u0275element(114, "path", 81)(115, "path", 82)(116, "path", 83)(117, "path", 84);
      \u0275\u0275elementEnd();
      \u0275\u0275template(118, SidebarComponent_span_118_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(119, "li", 13)(120, "a", 85);
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(121, "svg", 15);
      \u0275\u0275element(122, "circle", 86)(123, "path", 87);
      \u0275\u0275elementEnd();
      \u0275\u0275template(124, SidebarComponent_span_124_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275element(125, "div", 78);
      \u0275\u0275elementStart(126, "ul", 12);
      \u0275\u0275template(127, SidebarComponent_div_127_Template, 9, 4, "div", 88);
      \u0275\u0275elementStart(128, "li", 13)(129, "button", 89);
      \u0275\u0275listener("click", function SidebarComponent_Template_button_click_129_listener() {
        return ctx.openLogoutConfirm();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(130, "svg", 15);
      \u0275\u0275element(131, "path", 90)(132, "polyline", 91)(133, "line", 92);
      \u0275\u0275elementEnd();
      \u0275\u0275template(134, SidebarComponent_span_134_Template, 2, 1, "span", 18);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275classProp("collapsed", ctx.isCollapsed())("expanded", ctx.isExpanded())("rtl", ctx.isRTL());
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", !ctx.isCollapsed() || ctx.isExpanded());
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-expanded", !ctx.isCollapsed())("aria-label", ctx.isCollapsed() ? "Expand sidebar" : "Collapse sidebar");
      \u0275\u0275advance();
      \u0275\u0275classProp("rotated", ctx.isCollapsed());
      \u0275\u0275advance(2);
      \u0275\u0275attribute("aria-expanded", ctx.isExpanded())("aria-label", ctx.isExpanded() ? "Collapse sidebar" : "Expand sidebar");
      \u0275\u0275advance(8);
      \u0275\u0275attribute("aria-current", ctx.isActiveRoute("dashboard") ? "page" : null);
      \u0275\u0275advance(4);
      \u0275\u0275property("ngIf", !ctx.isCollapsed() || ctx.isExpanded());
      \u0275\u0275advance(2);
      \u0275\u0275attribute("aria-current", ctx.isActiveRoute("users") ? "page" : null);
      \u0275\u0275advance(6);
      \u0275\u0275property("ngIf", !ctx.isCollapsed() || ctx.isExpanded());
      \u0275\u0275advance(2);
      \u0275\u0275attribute("aria-current", ctx.isActiveRoute("employees") ? "page" : null);
      \u0275\u0275advance(6);
      \u0275\u0275property("ngIf", !ctx.isCollapsed() || ctx.isExpanded());
      \u0275\u0275advance(6);
      \u0275\u0275property("ngIf", !ctx.isCollapsed() || ctx.isExpanded());
...
>\r
  <div class="sidebar-header">\r
    <div class="logo-section" *ngIf="!isCollapsed() || isExpanded()">\r
...
\r
    <!-- Mobile expand button -->\r
    <button\r
      class="mobile-expand-btn"\r
      (click)="toggleExpand()"\r
      [attr.aria-expanded]="isExpanded()"\r
      [attr.aria-label]="isExpanded() ? 'Collapse sidebar' : 'Expand sidebar'"\r
    >\r
      <svg\r
        width="20"\r
        height="20"\r
    ...
    <ul class="nav-list">\r
      <li class="nav-item">\r
        ...
        >\r
          ...
          <span class="nav-text" *ngIf="!isCollapsed() || isExpanded()">{{\r
...
\r
      <li class="nav-item">\r
        <a routerLink="/tasks" routerLinkActive="active" class="nav-link">\r
          <svg\r
            class="nav-icon"\r
            width="20"\r
            height="20"\r
...
\r
      <li class="nav-item">\r
        <a routerLink="/letters" routerLinkActive="active" class="nav-link">\r
          <svg\r
            class="nav-icon"\r
            width="20"\r
            height="20"\r
...
\r
    <ul class="nav-list">\r
      <li class="nav-item">\r
        <button class="nav-link" (click)="openNotificationModal()">\r
          <!-- Send Notification (LTR) -->\r
          <svg\r
            class="nav-icon icon-send-notification"\r
            width="20"\r
            height="20"\r
            viewBox="0 0 24 24"\r
            fill="none"\r
          ...
          >\r
            ...
            <!-- send arrow (top-right) -->\r
            <path d="M15 5h6v6" />\r
            <path d="M21 5L13 13" />\r
          </svg>\r
\r
          <span class="nav-text" *ngIf="!isCollapsed() || isExpanded()">{{\r
      ...
      <li class="nav-item">\r
        <a routerLink="/settings" routerLinkActive="active" class="nav-link">\r
          <svg\r
            class="nav-icon"\r
            width="20"\r
            height="20"\r
          ...
          >\r
            ...
            <path\r
              d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1 1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09A1.65 1.65 0 0 0 19.4 15z"\r
            ></path>\r
          </svg>\r
          <span class="nav-text" *ngIf="!isCollapsed() || isExpanded()">{{\r
            translate("sidebar.settings")\r
          }}</span>\r
        </a>\r
      </li>\r
    </ul>\r
...
`, styles: ['/* src/app/components/shared/sidebar/sidebar.component.css */\n.sidebar {\n  position: fixed;\n  top: 10px;\n  left: 0;\n  height: 100vh;\n  width: var(--sidebar-w);\n  background-color: #f2f2f254;\n  -webkit-backdrop-filter: blur(50px) !important;\n  backdrop-filter: blur(50px) !important;\n  border-right: 1px solid var(--border-color);\n  transition:\n    width 0.3s ease,\n    padding 0.3s ease,\n    left 0.3s ease,\n    right 0.3s ease;\n  overflow: hidden;\n  border-radius: 0 30px 30px 0;\n  display: flex;\n  flex-direction: column;\n}\n.sidebar.rtl {\n  left: auto;\n  right: 0px;\n  border-right: none;\n  border-left: 1px solid var(--border-color);\n  border-radius: 30px 0px 0px 0px;\n}\n.sidebar:not(.rtl) {\n  left: 0px;\n  right: auto;\n  border-right: 1px solid var(--border-color);\n  border-radius: 0px 30px 0px 0px;\n}\n.sidebar.collapsed {\n  width: var(--sidebar-w-collapsed);\n}\n.sidebar.collapsed .logo-section {\n  opacity: 0;\n  pointer-events: none;\n  display: none;\n}\n.sidebar.collapsed .nav-text {\n  opacity: 0;\n  pointer-events: none;\n  display: none;\n}\n.sidebar-header {\n  padding: 1rem;\n  border-bottom: 1px solid var(--border-color);\n  display: flex;\n  align-items: center;\n  gap: 2.5rem;\n}\n.collapse-btn {\n  background: none;\n  border: 2px solid rgb(0, 0, 0, 0.12);\n  color: #8b8b8b !important;\n  cursor: pointer;\n  padding: 0.5rem;\n  border-radius: 999rem;\n  color: var(--text-secondary);\n  transition: background-color 0.2s ease, color 0.2s ease;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.collapse-btn:hover {\n  background-color: #09365f;\n  color: #ecf4e9 !important;\n  color: var(--text-primary);\n}\n.mobile-expand-btn {\n  background: none;\n  border: 1px solid #158638;\n  color: #158638 !important;\n  cursor: pointer;\n  padding: 0.5rem;\n  border-radius: 999rem;\n  transition: background-color 0.2s ease, color 0.2s ease;\n  display: none;\n  align-items: center;\n  justify-content: center;\n}\n.mobile-expand-btn:hover {\n  background-color: #158638;\n  color: #ecf4e9 !important;\n}\n.chevron-icon {\n  transition: transform 0.3s ease;\n}\n.chevron-icon.rotated {\n  transform: rotate(180deg);\n}\n.logo-section {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  opacity: 1;\n  transition: opacity 0.3s ease;\n}\n.logo {\n  width: 151px;\n  height: 50px;\n  object-fit: contain;\n}\n.logo-text {\n  font-family: "Poppins", sans-serif;\n  font-weight: 600;\n  color: var(--brand-green);\n  font-size: 1.25rem;\n}\n.sidebar-nav {\n  padding: 1rem 0;\n  height: calc(100vh - 80px);\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  overflow-y: auto;\n  overflow-x: hidden;\n  flex: 1;\n}\n.nav-list {\n  list-style: none;\n  padding: 0;\n  margin: 0;\n}\n.nav-item {\n  margin: 0.25rem 0;\n}\n.nav-link {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  padding: 0.75rem 1rem;\n  color: #333333be;\n  text-decoration: none;\n  border-radius: 0.375rem;\n  font-size: 16px !important;\n  margin: 0 0.5rem;\n  font-weight: 600;\n  transition:\n    background-color 0.2s ease,\n    color 0.2s ease,\n    box-shadow 0.2s ease;\n  position: relative;\n}\n.nav-link:hover {\n  background-color: rgba(85, 85, 85, 0.05);\n}\n.nav-link.active {\n  background: linear-gradient(#09365f 100%);\n  color: white;\n  font-size: 18px !important;\n  box-shadow: var(--shadow-light);\n}\n.nav-link.active::before {\n  content: "";\n  position: absolute;\n  inset-inline-start: 0;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 4px;\n  height: 20px;\n  background-color: #ffffff;\n  border-radius: 0 2px 2px 0;\n}\n.nav-link.rtl.active::before {\n  inset-inline-end: 0;\n  inset-inline-start: auto;\n  border-radius: 2px 0 0 2px;\n}\n.nav-icon {\n  flex-shrink: 0;\n  color: currentColor;\n}\n.nav-text {\n  font-family: inherit;\n  font-size: 18px !important;\n  font-weight: 600;\n  white-space: nowrap;\n  opacity: 1;\n  transition: opacity 0.3s ease;\n}\n.logout-btn {\n  background: transparent;\n  border: none;\n  width: 95%;\n  text-align: start;\n  cursor: pointer;\n  transition: all 0.3s ease;\n}\n.logout-btn:hover {\n  background: rgba(239, 68, 68, 0.1) !important;\n  color: #ef4444 !important;\n  transform: translateY(-1px);\n  box-shadow: 0 4px 12px rgba(239, 68, 68, 0.2);\n}\n.logout-btn:active {\n  transform: translateY(0);\n  box-shadow: 0 2px 8px rgba(239, 68, 68, 0.3);\n}\n.nav-divider {\n  height: 1px;\n  background-color: var(--border-color);\n  margin: 1rem 0.5rem;\n}\n.sidebar.collapsed .nav-link {\n  position: relative;\n}\n.sidebar.collapsed .nav-link::after {\n  content: attr(data-tooltip);\n  position: absolute;\n  inset-inline-start: 100%;\n  top: 50%;\n  transform: translateY(-50%);\n  background-color: var(--text-primary);\n  color: white;\n  padding: 0.5rem;\n  border-radius: 0.375rem;\n  font-size: 0.75rem;\n  white-space: nowrap;\n  opacity: 0;\n  pointer-events: none;\n  transition: opacity 0.2s ease;\n  z-index: 1001;\n  margin-inline-start: 0.5rem;\n}\n.sidebar.collapsed .nav-link:hover::after {\n  opacity: 1;\n}\n.sidebar.rtl.collapsed .nav-link::after {\n  inset-inline-end: 100%;\n  inset-inline-start: auto;\n  margin-inline-end: 0.5rem;\n  margin-inline-start: 0;\n}\n@media (max-width: 768px) {\n  .sidebar {\n    height: 100vh;\n    position: fixed;\n    top: 0;\n    left: 0;\n    right: 0;\n    z-index: 1;\n    transition: all 0.3s ease;\n  }\n  .sidebar.expanded {\n    width: 250px;\n    z-index: 1000 !important;\n  }\n  .users-page {\n    z-index: 999 !important;\n  }\n  .sidebar {\n    z-index: 1 !important;\n  }\n  .sidebar:not(.expanded) {\n    width: 60px;\n  }\n  .sidebar:not(.expanded) .logo-section,\n  .sidebar:not(.expanded) .nav-text {\n    opacity: 0;\n    pointer-events: none;\n    display: none;\n  }\n  .sidebar:not(.expanded) .nav-link {\n    justify-content: center;\n    padding: 1rem 0.5rem;\n  }\n  .mobile-expand-btn {\n    display: block;\n  }\n  .collapse-btn {\n    display: none;\n  }\n}\n@media (min-width: 769px) {\n  .sidebar.collapsed {\n    width: var(--sidebar-w-collapsed);\n  }\n  .sidebar.collapsed .logo-section {\n    opacity: 0;\n    pointer-events: none;\n    display: none;\n  }\n  .sidebar.collapsed .nav-text {\n    opacity: 0;\n    pointer-events: none;\n    display: none;\n  }\n  .sidebar.collapsed .nav-link {\n    justify-content: center;\n    padding: 1rem 0.5rem;\n  }\n  .sidebar.collapsed .nav-link svg {\n    margin: 0;\n  }\n  .mobile-expand-btn {\n    display: none;\n  }\n  .collapse-btn {\n    display: flex;\n  }\n}\n.user-profile-section {\n  color: #09365f;\n  margin: 0 0.5rem;\n  background: rgba(255, 255, 255, 0.1);\n  border-radius: 12px;\n  border: 1px solid rgba(255, 255, 255, 0.2);\n  transition: all 0.3s ease;\n  cursor: pointer;\n  width: 95%;\n}\n.user-profile-info:hover {\n  background: #09365f !important;\n  transform: translateY(-2px);\n  box-shadow: 0 8px 25px rgba(255, 255, 255, 0.3);\n}\n.user-profile-info:hover .user-name {\n  color: #ffffff !important;\n}\n.user-profile-section:hover .user-role {\n  color: #666666 !important;\n}\n.user-profile-info {\n  border: 1px solid #080264 !important;\n  border-radius: 12px;\n  padding: 0.5rem;\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  transition: all 0.3s ease;\n  width: 100%;\n}\n.user-avatar {\n  flex-shrink: 0;\n}\n.user-avatar .profile-pic {\n  width: 40px;\n  height: 40px;\n  border-radius: 50%;\n  object-fit: cover;\n  border: 2px solid rgba(255, 255, 255, 0.3);\n}\n.user-avatar svg {\n  width: 40px;\n  height: 40px;\n  color: #8b8b8b;\n  border: 2px solid rgba(255, 255, 255, 0.3);\n  border-radius: 50%;\n  padding: 8px;\n  background: rgba(255, 255, 255, 0.1);\n}\n.user-details {\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n  min-width: 0;\n}\n.user-name {\n  font-weight: 600;\n  color: #333333;\n  font-size: 14px;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.user-role {\n  font-size: 12px;\n  color: #8b8b8b;\n  font-weight: 500;\n}\n.logout-btn {\n  background: #ffdcd4 !important;\n  color: #ff7253 !important;\n  border-radius: 8px !important;\n  margin: 0 0.5rem !important;\n  padding: 0.75rem 1rem !important;\n  font-weight: 600 !important;\n  transition: all 0.3s ease !important;\n  margin-bottom: 1rem !important;\n}\n.logout-btn:hover {\n  background: #dc2626 !important;\n  border-color: #dc2626 !important;\n  color: white !important;\n  transform: translateY(-2px) !important;\n  box-shadow: 0 8px 25px rgba(239, 68, 68, 0.4) !important;\n}\n.logout-btn:active {\n  transform: translateY(0) !important;\n  box-shadow: 0 4px 15px rgba(239, 68, 68, 0.3) !important;\n}\n/*# sourceMappingURL=sidebar.component.css.map */\n'] }]
  }], () => [{ type: Router }, { type: TranslationService }, { type: LangService }, { type: AuthService }, { type: ProfileService }, { type: ImageService }], { rtl: [{
    type: Input
  }], collapsedChange: [{
    type: Output
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/components/shared/sidebar/sidebar.component.ts", lineNumber: 17 });
})();
...
function NotificationDropdownComponent_button_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 16);
    \u0275\u0275listener("click", function NotificationDropdownComponent_button_10_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
function NotificationDropdownComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function NotificationDropdownComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 23)(2, "circle", 24);
    \u0275\u0275element(3, "animate", 25)(4, "animate", 26);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
...
function NotificationDropdownComponent_div_14_button_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 37);
    \u0275\u0275listener("click", function NotificationDropdownComponent_div_14_button_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const notification_r4 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.markAsRead(notification_r4.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 38);
    \u0275\u0275element(2, "polyline", 39);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function NotificationDropdownComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(12, NotificationDropdownComponent_div_14_button_12_Template, 3, 1, "button", 36);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const notification_r4 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275classProp("unread", !notification_r4.isRead)("read", notification_r4.isRead)("rtl", ctx_r0.isRTL);
    \u0275\u0275advance();
    \u0275\u0275classMap(ctx_r0.getNotificationClass(notification_r4.type || "info"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.getNotificationIcon(notification_r4.type || "info"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(notification_r4.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(notification_r4.message);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.getTimeAgo(notification_r4.timestamp));
    \u0275\u0275advance(2);
...
var NotificationDropdownComponent = class _NotificationDropdownComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotificationDropdownComponent, selectors: [["app-notification-dropdown"]], hostBindings: function NotificationDropdownComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function NotificationDropdownComponent_Template_div_click_6_listener($event) {
        return $event.stopPropagation();
      });
      \u0275\u0275elementStart(7, "div", 7)(8, "h3", 8);
      \u0275\u0275text(9);
      \u0275\u0275elementEnd();
      \u0275\u0275template(10, NotificationDropdownComponent_button_10_Template, 2, 1, "button", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275template(11, NotificationDropdownComponent_div_11_Template, 6, 1, "div", 10);
      \u0275\u0275elementStart(12, "div", 11);
      \u0275\u0275template(13, NotificationDropdownComponent_div_13_Template, 7, 1, "div", 12)(14, NotificationDropdownComponent_div_14_Template, 13, 13, "div", 13)(15, NotificationDropdownComponent_div_15_Template, 6, 1, "div", 14);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
...
function AddNotificationModalComponent__svg_svg_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function AddNotificationModalComponent__svg_svg_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
var AddNotificationModalComponent = class _AddNotificationModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddNotificationModalComponent, selectors: [["app-add-notification-modal"]], hostBindings: function AddNotificationModalComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function AddNotificationModalComponent_Template_button_click_37_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275template(38, AddNotificationModalComponent__svg_svg_38_Template, 3, 0, "svg", 31)(39, AddNotificationModalComponent__svg_svg_39_Template, 4, 0, "svg", 32);
      \u0275\u0275text(40);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-NGX3ER46.js.map

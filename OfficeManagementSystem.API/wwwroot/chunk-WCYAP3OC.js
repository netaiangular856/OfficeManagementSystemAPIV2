...
var PermissionsAssignmentModalComponent = class _PermissionsAssignmentModalComponent {
  ...
  isMandatoryPermission(permission) {
    const isDashboard = permission.controller === "dashboard" && permission.action === "index" || permission.controller === "overview" && permission.action === "get" || permission.controller === "dashboard" && permission.action === "get" || permission.displayName?.toLowerCase().includes("dashboard") && (permission.controller === "overview" || permission.controller === "dashboard");
    const isCalendar = permission.controller === "calendar" && permission.action === "index" || permission.controller === "calendar" && permission.action === "get" || (permission.displayName?.toLowerCase().includes("my calendar") || permission.displayName?.toLowerCase().includes("calendar"));
    return isDashboard || isCalendar;
  }
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;926075da3b2e4aca4d6f849a2cbe3914adceef284f93df8451bbd0395da44b75;D:/web/EXSUS/\u062B\u0624\u062E\u0629/v2/echo-office-new/src/app/components/shared/permissions-assignment-modal/permissions-assignment-modal.component.ts */\n.permissions-modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 1000;\n  padding: 1rem;\n}\n.permissions-modal {\n  background: white;\n  border-radius: 12px;\n  width: 100%;\n  max-width: 800px;\n  max-height: 90vh;\n  display: flex;\n  flex-direction: column;\n  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);\n}\n.modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.5rem 2rem;\n  border-bottom: 1px solid #e5e7eb;\n  background: #D4AF5F;\n  color: white;\n  border-radius: 12px 12px 0 0;\n}\n.modal-header.rtl {\n  flex-direction: row-reverse;\n}\n.modal-header.ltr {\n  flex-direction: row;\n}\n.modal-header.rtl h3 {\n  order: 2;\n}\n.modal-header.rtl .close-btn {\n  order: 1;\n}\n.modal-header.ltr h3 {\n  order: 1;\n}\n.modal-header.ltr .close-btn {\n  order: 2;\n}\n.modal-header h3 {\n  font-size: 1.5rem;\n  font-weight: 600;\n  margin: 0;\n}\n.close-btn {\n  background: none;\n  border: none;\n  color: white;\n  cursor: pointer;\n  padding: 0.5rem;\n  border-radius: 6px;\n  transition: all 0.2s ease;\n}\n.close-btn:hover {\n  background: rgba(255, 255, 255, 0.1);\n}\n.modal-content {\n  flex: 1;\n  overflow-y: auto;\n  padding: 2rem;\n}\n.modal-actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 1rem;\n  padding: 1.5rem 2rem;\n  border-top: 1px solid #e5e7eb;\n  background: #f9fafb;\n  border-radius: 0 0 12px 12px;\n}\n.permission-group {\n  background: #f8fafc;\n  border: 1px solid #e2e8f0;\n  border-radius: 8px;\n  padding: 1.5rem;\n  margin-bottom: 1rem;\n}\n.group-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 1rem;\n}\n.group-title {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #1e293b;\n  margin: 0;\n}\n.group-actions {\n  display: flex;\n  gap: 0.5rem;\n}\n.btn-select-all,\n.btn-deselect-all {\n  background: #f1f5f9;\n  border: 1px solid #cbd5e1;\n  color: #475569;\n  padding: 0.375rem 0.75rem;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s ease;\n}\n.btn-select-all:hover {\n  background: #e2e8f0;\n  color: #334155;\n}\n.btn-deselect-all:hover {\n  background: #fef2f2;\n  color: #dc2626;\n  border-color: #fecaca;\n}\n.permissions-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));\n  gap: 1rem;\n}\n.permission-item {\n  background: white;\n  border: 1px solid #e2e8f0;\n  border-radius: 8px;\n  padding: 1rem;\n  transition: all 0.2s ease;\n  cursor: pointer;\n  width: 80% !important;\n  box-sizing: border-box;\n}\n.permission-item:hover {\n  border-color: #cbd5e1;\n  box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1);\n}\n.permission-item.assigned {\n  border-color: #158638;\n  background: #f0fdf4;\n}\n.permission-item.mandatory {\n  border-color: #B68A35;\n  background: #fdf8f0;\n}\n.permission-item.disabled {\n  cursor: not-allowed;\n  opacity: 0.8;\n}\n.mandatory-badge {\n  display: inline-block;\n  background: #B68A35;\n  color: white;\n  font-size: 0.7rem;\n  padding: 0.15rem 0.4rem;\n  border-radius: 4px;\n  margin-left: 0.5rem;\n  font-weight: 600;\n}\n.permission-input:disabled {\n  cursor: not-allowed;\n  opacity: 0.7;\n}\n.permission-checkbox {\n  display: flex;\n  align-items: flex-start;\n  gap: 0.75rem;\n  cursor: pointer;\n  width: 100%;\n}\n.permission-input {\n  margin: 0;\n  width: 18px;\n  height: 18px;\n  accent-color: #158638;\n  flex-shrink: 0;\n  margin-top: 2px;\n}\n.permission-custom {\n  display: none;\n}\n.permission-content {\n  flex: 1;\n}\n.permission-name {\n  font-weight: 500;\n  color: #1e293b;\n  margin-bottom: 0.25rem;\n  font-size: 0.95rem;\n}\n.permission-description {\n  color: #64748b;\n  font-size: 0.875rem;\n  margin-bottom: 0.5rem;\n  line-height: 1.4;\n}\n.permission-meta {\n  display: flex;\n  gap: 0.5rem;\n  flex-wrap: wrap;\n}\n.permission-controller,\n.permission-action {\n  background: #f1f5f9;\n  color: #475569;\n  padding: 0.25rem 0.5rem;\n  border-radius: 4px;\n  font-size: 0.75rem;\n  font-weight: 500;\n}\n.btn-loading {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.loading-spinner-small {\n  width: 16px;\n  height: 16px;\n  border: 2px solid #f3f4f6;\n  border-top: 2px solid #158638;\n  border-radius: 50%;\n  animation: spin 1s linear infinite;\n}\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.loading-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 3rem;\n  text-align: center;\n}\n.loading-spinner {\n  width: 40px;\n  height: 40px;\n  border: 4px solid #f3f4f6;\n  border-top: 4px solid #158638;\n  border-radius: 50%;\n  animation: spin 1s linear infinite;\n  margin-bottom: 1rem;\n}\n@media (max-width: 360px) {\n  .permissions-grid {\n    display: flex;\n    flex-direction: column;\n    gap: 8px;\n  }\n  .permission-item {\n    width: 80% !important;\n    box-sizing: border-box;\n  }\n  .permission-item.assigned {\n    justify-content: center !important;\n  }\n}\n/*# sourceMappingURL=permissions-assignment-modal.component-EZ2PUFEX.css.map */\n"] }]
  }], null, { isVisible: [{
    type: Input
  }], roleId: [{
    type: Input
...
function RolesListComponent_button_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 32);
    \u0275\u0275listener("click", function RolesListComponent_button_23_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RolesListComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
...
function RolesListComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 37)(1, "div", 38);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 39);
    \u0275\u0275element(3, "path", 40)(4, "circle", 41)(5, "path", 42)(6, "path", 43);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(7, "h3");
    \u0275\u0275text(8);
    ...
    \u0275\u0275listener("click", function RolesListComponent_div_34_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(13, "line", 10)(14, "line", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
  }
...
function RolesListComponent_div_35_tr_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 47)(1, "td", 48)(2, "div", 49)(3, "h4");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(5, "td", 50)(6, "p");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "td", 51)(9, "span", 24);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "td", 52)(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td", 53)(15, "div", 54)(16, "button", 55);
    \u0275\u0275listener("click", function RolesListComponent_div_35_tr_15_Template_button_click_16_listener() {
    ...
    \u0275\u0275element(18, "path", 56)(19, "circle", 57);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(20, "button", 58);
    \u0275\u0275listener("click", function RolesListComponent_div_35_tr_15_Template_button_click_20_listener() {
      const role_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function RolesListComponent_div_35_tr_15_Template_button_click_24_listener() {
      const role_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(26, "path", 63)(27, "path", 64)(28, "path", 65);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(29, "button", 66);
    \u0275\u0275listener("click", function RolesListComponent_div_35_tr_15_Template_button_click_29_listener() {
      const role_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(31, "polyline", 67)(32, "path", 68)(33, "line", 69)(34, "line", 70);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function RolesListComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, RolesListComponent_div_35_tr_15_Template, 35, 8, "tr", 46);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function RolesListComponent_div_36_button_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 85);
    \u0275\u0275listener("click", function RolesListComponent_div_36_button_22_Template_button_click_0_listener() {
...
function RolesListComponent_div_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("change", function RolesListComponent_div_36_Template_select_change_7_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function RolesListComponent_div_36_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(19, "polyline", 81);
    \u0275\u0275elementEnd();
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(21, "div", 82);
    \u0275\u0275template(22, RolesListComponent_div_36_button_22_Template, 2, 3, "button", 83);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "button", 80);
    \u0275\u0275listener("click", function RolesListComponent_div_36_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage() + 1));
    });
...
function RolesListComponent_div_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "path", 90)(5, "polyline", 91);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7);
    ...
    \u0275\u0275listener("click", function RolesListComponent_div_38_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
...
var RolesListComponent = class _RolesListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RolesListComponent, selectors: [["app-roles-list"]], standalone: false, decls: 40, vars: 37, consts: [[1, "roles-container", "rounded-5"], [1, "page-header"], [1, "header-content"], [1, "title-section"], [1, "page-title"], [1, "page-subtitle"], [1, "header-actions"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "search-section"], [1, "search-container"], [1, "search-input-group"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "search-icon"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.35-4.35"], ["type", "text", 1, "search-input", 3, "input", "keyup.enter", "placeholder", "value"], ["class", "clear-search-btn", 3, "click", 4, "ngIf"], [1, "btn", "btn-outline", 3, "click"], [1, "table-container"], [1, "table-header"], [1, "table-title"], [1, "count-badge"], ["class", "loading-container", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "table-wrapper", 4, "ngIf"], ["class", "pagination-container", 4, "ngIf"], [3, "confirm", "cancel", "data", "isVisible", "isRTL"], ["class", "success-modal", 4, "ngIf"], [3, "assign", "cancel", "isVisible", "roleId"], [1, "clear-search-btn", 3, "click"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "loading-container"], [1, "loading-spinner"], [1, "empty-state"], [1, "empty-icon"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 0 0-3-3.87"], ["d", "M16 3.13a4 4 0 0 1 0 7.75"], [1, "table-wrapper"], [1, "roles-table"], ["class", "role-row", 4, "ngFor", "ngForOf"], [1, "role-row"], [1, "role-name"], [1, "role-info"], [1, "role-description"], [1, "permissions-count"], [1, "created-date"], [1, "actions"], [1, "action-buttons"], [1, "btn-icon", "btn-view", 3, "click"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"], ["cx", "12", "cy", "12", "r", "3"], [1, "btn-icon", "btn-edit", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], [1, "btn-icon", "btn-permissions", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"], ["d", "M12 8v4"], ["d", "M12 16h.01"], [1, "btn-icon", "btn-delete", 3, "click"], ["points", "3,6 5,6 21,6"], ["d", "M19,6v14a2,2,0,0,1-2,2H7a2,2,0,0,1-2-2V6m3,0V4a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2v6"], ["x1", "10", "y1", "11", "x2", "10", "y2", "17"], ["x1", "14", "y1", "11", "x2", "14", "y2", "17"], [1, "pagination-container"], [1, "pagination-info"], [1, "page-size-selector"], [3, "change", "value"], ["value", "5"], ["value", "10"], ["value", "20"], ["value", "50"], [1, "pagination-controls"], [1, "btn-pagination", 3, "click", "disabled"], ["points", "15,18 9,12 15,6"], [1, "page-numbers"], ["class", "btn-page", 3, "active", "click", 4, "ngFor", "ngForOf"], ["points", "9,18 15,12 9,6"], [1, "btn-page", 3, "click"], [1, "success-modal"], [1, "success-content"], [1, "success-icon"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], [1, "close-success", 3, "click"]], template: function RolesListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(20, "circle", 16)(21, "path", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(22, "input", 18);
      \u0275\u0275listener("input", function RolesListComponent_Template_input_input_22_listener($event) {
        return ctx.onSearchChange($event.target.value);
      })("keyup.enter", function RolesListComponent_Template_input_keyup_enter_22_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, RolesListComponent_button_23_Template, 4, 1, "button", 19);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "button", 20);
      \u0275\u0275listener("click", function RolesListComponent_Template_button_click_24_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275text(25);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(26, "div", 21)(27, "div", 22)(28, "div", 23)(29, "h3");
      \u0275\u0275text(30);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "span", 24);
      \u0275\u0275text(32);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(33, RolesListComponent_div_33_Template, 4, 1, "div", 25)(34, RolesListComponent_div_34_Template, 16, 3, "div", 26)(35, RolesListComponent_div_35_Template, 16, 6, "div", 27)(36, RolesListComponent_div_36_Template, 27, 14, "div", 28);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "app-confirmation-modal", 29);
      \u0275\u0275listener("confirm", function RolesListComponent_Template_app_confirmation_modal_confirm_37_listener() {
        return ctx.onDeleteConfirm();
      })("cancel", function RolesListComponent_Template_app_confirmation_modal_cancel_37_listener() {
        return ctx.onDeleteCancel();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(38, RolesListComponent_div_38_Template, 12, 1, "div", 30);
      \u0275\u0275elementStart(39, "app-permissions-assignment-modal", 31);
      \u0275\u0275listener("assign", function RolesListComponent_Template_app_permissions_assignment_modal_assign_39_listener($event) {
        return ctx.onPermissionsAssign($event);
      })("cancel", function RolesListComponent_Template_app_permissions_assignment_modal_cancel_39_listener() {
...
function PermissionsManagementComponent_div_33_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_33_tr_19_Template_button_click_24_listener() {
    ...
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_33_tr_19_Template_button_click_28_listener() {
      const permission_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function PermissionsManagementComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(19, PermissionsManagementComponent_div_33_tr_19_Template, 34, 13, "tr", 48);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PermissionsManagementComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(22, PermissionsManagementComponent_div_34_button_22_Template, 2, 3, "button", 82);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "button", 80);
...
function PermissionsManagementComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(17, PermissionsManagementComponent_div_35_div_17_Template, 2, 1, "div", 95);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(24, PermissionsManagementComponent_div_35_div_24_Template, 2, 1, "div", 95);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(31, PermissionsManagementComponent_div_35_div_31_Template, 2, 1, "div", 95);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(38, PermissionsManagementComponent_div_35_div_38_Template, 2, 1, "div", 95);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(45, PermissionsManagementComponent_div_35_div_45_Template, 2, 1, "div", 95);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(54, PermissionsManagementComponent_div_35_div_54_Template, 3, 1, "div", 111)(55, PermissionsManagementComponent_div_35_div_55_Template, 2, 1, "div", 112);
    \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-WCYAP3OC.js.map

...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadChildren: () => import("./chunk-WK7BV3VI.js").then((m) => m.DashboardModule),
        canActivate: [PermissionGuard],
        data: { permission: "dashboard.index" }
      },
      {
        path: "users",
        loadChildren: () => import("./chunk-HOIVX2ZY.js").then((m) => m.UsersModule),
        canActivate: [PermissionGuard],
        data: { permission: "user.index" }
      },
      {
        path: "roles",
        loadChildren: () => import("./chunk-WCYAP3OC.js").then((m) => m.RolesModule),
        canActivate: [PermissionGuard],
        data: { permission: "admin.index" }
      },
      {
        path: "employees",
        loadChildren: () => import("./chunk-CIV6XOJK.js").then((m) => m.EmployeesModule),
        canActivate: [PermissionGuard],
        data: { permission: "employee.index" }
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-XTHJIYDQ.js").then((m) => m.ProfileComponent)
      },
      {
        path: "departments",
        loadChildren: () => import("./chunk-KTFYGJT7.js").then((m) => m.DepartmentsModule),
        canActivate: [PermissionGuard],
        data: { permission: "department.index" }
      },
      {
        path: "tasks",
        loadChildren: () => import("./chunk-L6QHFAMA.js").then((m) => m.TasksModule)
      },
      {
        path: "partners",
        loadChildren: () => import("./chunk-6HYBTOOK.js").then((m) => m.PartnersModule),
        canActivate: [PermissionGuard],
        data: { permission: "partners.index" }
      },
      {
        path: "visits",
        loadChildren: () => import("./chunk-UEKX3GKR.js").then((m) => m.VisitsModule),
        canActivate: [PermissionGuard],
        data: { permission: "visits.index" }
      },
      {
        path: "travel",
        loadChildren: () => import("./chunk-QALPPKXQ.js").then((m) => m.TravelModule),
        canActivate: [PermissionGuard],
        data: { permission: "travel.index" }
      },
      {
        path: "meetings",
        loadChildren: () => import("./chunk-HSWGOMVM.js").then((m) => m.MeetingsModule),
        canActivate: [PermissionGuard],
        data: { permission: "meeting.index" }
      },
      {
        path: "my-calendar",
        loadChildren: () => import("./chunk-WKN2SVLA.js").then((m) => m.CalendarModule),
        canActivate: [PermissionGuard],
        data: { permission: "calendar.index" }
      },
      {
        path: "calendar",
        loadChildren: () => import("./chunk-MXXBZZFI.js").then((m) => m.SystemCalendarModule),
        canActivate: [PermissionGuard],
        data: { permission: "calendar.events.get" }
      },
      {
        path: "letters",
        loadChildren: () => import("./chunk-ZENODQW3.js").then((m) => m.LettersModule)
      },
      {
        path: "documents",
        loadChildren: () => import("./chunk-T5OJZHPX.js").then((m) => m.DocumentsModule),
        canActivate: [PermissionGuard],
        data: { permission: "documents.index" }
      },
      {
        path: "workflow",
        loadChildren: () => import("./chunk-I7FPWU6R.js").then((m) => m.WorkflowModule),
        canActivate: [PermissionGuard],
...
//# sourceMappingURL=chunk-UZ3YQVVO.js.map

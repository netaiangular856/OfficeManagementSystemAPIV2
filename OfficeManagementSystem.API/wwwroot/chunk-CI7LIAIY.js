...
function SidebarComponent_li_11_span_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "path", 55)(4, "path", 56)(5, "path", 57)(6, "path", 58)(7, "path", 59);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, SidebarComponent_li_11_span_8_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_12_span_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 60);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 46);
    \u0275\u0275element(3, "rect", 61)(4, "line", 62)(5, "line", 63)(6, "line", 64)(7, "circle", 65)(8, "circle", 66)(9, "circle", 67)(10, "circle", 68)(11, "line", 69)(12, "line", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, SidebarComponent_li_12_span_13_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_13_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "path", 73);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, SidebarComponent_li_13_span_4_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_14_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 74);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 46);
    \u0275\u0275element(3, "path", 75)(4, "path", 76)(5, "path", 77);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, SidebarComponent_li_14_span_6_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_15_span_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 46);
    \u0275\u0275element(3, "rect", 61)(4, "line", 62)(5, "line", 63)(6, "line", 64)(7, "circle", 79)(8, "circle", 80)(9, "circle", 81);
    \u0275\u0275elementEnd();
    \u0275\u0275template(10, SidebarComponent_li_15_span_10_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "path", 84)(4, "polyline", 85)(5, "path", 86);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_18_span_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 87);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "path", 88)(4, "polyline", 89)(5, "line", 90)(6, "line", 91)(7, "polyline", 92);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, SidebarComponent_li_18_span_8_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "path", 94)(4, "path", 95)(5, "path", 96)(6, "path", 97)(7, "path", 98);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "rect", 100)(4, "rect", 101)(5, "rect", 102)(6, "rect", 103);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 104);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 105);
    \u0275\u0275element(3, "path", 106)(4, "path", 107)(5, "circle", 108);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, SidebarComponent_li_23_span_6_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_span_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_span_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], inputs: { rtl: "rtl", isMobile: "isMobile", mobileOpen: "mobileOpen" }, outputs: { collapsedChange: "collapsedChange", logoutConfirmRequested: "logoutConfirmRequested", notificationModalRequested: "notificationModalRequested", mobileSidebarClose: "mobileSidebarClose" }, standalone: false, decls: 45, vars: 33, consts: [[1, "sidebar"], [1, "sidebar-header"], ["class", "logo-section", 4, "ngIf"], ["class", "mobile-close-btn", 3, "click", 4, "ngIf"], ["class", "collapse-btn", 3, "click", 4, "ngIf"], [1, "sidebar-nav", "custom-scrollbar"], [1, "nav-list"], ["class", "nav-item", 4, "ngIf"], [1, "nav-divider"], [1, "sidebar-bottom"], [1, "bottom-section"], [1, "nav-link", "notification-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-label", "Send notification", "role", "img", 1, "nav-icon"], ["d", "M18 10a6 6 0 10-12 0v2c0 1.6-.6 3.1-1.6 4.2h15.2A6.2 6.2 0 0 1 18 12v-2"], ["d", "M13.5 20a1.5 1.5 0 0 1-3 0"], ["class", "nav-text", 4, "ngIf"], ["routerLink", "/profile", 1, "user-profile-section", 2, "cursor", "pointer"], [1, "user-profile-info"], [1, "user-avatar"], [1, "profile-pic", 3, "error", "src", "alt"], ["class", "user-details", 4, "ngIf"], [1, "nav-link", "logout-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "nav-icon"], ["d", "M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"], ["points", "16,17 21,12 16,7"], ["x1", "21", "y1", "12", "x2", "9", "y2", "12"], [1, "logo-section"], ["src", "/logo.png", "alt", "EcoOffice", 1, "logo"], [1, "mobile-close-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "collapse-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "chevron-icon"], ["points", "15,18 9,12 15,6"], [1, "nav-item"], ["routerLink", "/dashboard", "routerLinkActive", "active", 1, "nav-link"], ["d", "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"], ["points", "9,22 9,12 15,12 15,22"], [1, "nav-text"], ["routerLink", "/users", "routerLinkActive", "active", 1, "nav-link"], ["d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 0 1 0 7.75"], ["d", "M16 3.13a4 4 0 0 1 0 7.75"], ["routerLink", "/employees", "routerLinkActive", "active", 1, "nav-link"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "nav-icon"], ["d", "M3 21v-2a4 4 0 0 1 4-4h4"], ["cx", "20", "cy", "9", "r", "3"], ["d", "M17 21v-2a3 3 0 0 1 3-3h3"], ["routerLink", "/tasks", "routerLinkActive", "active", 1, "nav-link"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], ["routerLink", "/partners", "routerLinkActive", "active", 1, "nav-link"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "lucide", "lucide-handshake-icon", "lucide-handshake"], ["d", "m11 17 2 2a1 1 0 1 0 3-3"], ["d", "m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4"], ["d", "m21 3 1 11h-2"], ["d", "M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3"], ["d", "M3 4h8"], ["routerLink", "/visits", "routerLinkActive", "active", 1, "nav-link"], ["x", "3", "y", "4", "width", "18", "height", "18", "rx", "2", "ry", "2"], ["x1", "16", "y1", "2", "x2", "16", "y2", "6"], ["x1", "8", "y1", "2", "x2", "8", "y2", "6"], ["x1", "3", "y1", "10", "x2", "21", "y2", "10"], ["cx", "8", "cy", "14", "r", "1.5", "fill", "currentColor"], ["cx", "12", "cy", "14", "r", "1.5", "fill", "currentColor"], ["cx", "16", "cy", "14", "r", "1.5", "fill", "currentColor"], ["cx", "12", "cy", "18", "r", "2"], ["x1", "12", "y1", "18", "x2", "12", "y2", "16", "stroke-width", "1.5"], ["x1", "12", "y1", "18", "x2", "13.5", "y2", "18", "stroke-width", "1.5"], ["routerLink", "/travel", "routerLinkActive", "active", 1, "nav-link"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "lucide", "lucide-plane-icon", "lucide-plane"], ["d", "M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"], ["routerLink", "/meetings", "routerLinkActive", "active", 1, "nav-link"], ["d", "M2 3h20"], ["d", "M21 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V3"], ["d", "m7 21 5-5 5 5"], ["routerLink", "/my-calendar", "routerLinkActive", "active", 1, "nav-link"], ["cx", "8", "cy", "14", "r", "1"], ["cx", "12", "cy", "14", "r", "1"], ["cx", "16", "cy", "14", "r", "1"], ["routerLink", "/calendar", "routerLinkActive", "active", 1, "nav-link"], ["routerLink", "/letters", "routerLinkActive", "active", 1, "nav-link"], ["d", "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"], ["points", "22,6 12,13 2,6"], ["d", "M2 8l10 5 10-5"], ["routerLink", "/documents", "routerLinkActive", "active", 1, "nav-link"], ["d", "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"], ["points", "14,2 14,8 20,8"], ["x1", "16", "y1", "13", "x2", "8", "y2", "13"], ["x1", "16", "y1", "17", "x2", "8", "y2", "17"], ["points", "10,9 9,9 8,9"], ["routerLink", "/workflow", "routerLinkActive", "active", 1, "nav-link"], ["d", "M3 3h6l3 3h9v12H3z"], ["d", "M9 3v6h6"], ["d", "M12 9h6"], ["d", "M12 12h6"], ["d", "M12 15h6"], ["routerLink", "/departments", "routerLinkActive", "active", 1, "nav-link"], ["x", "3", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "14", "width", "7", "height", "7"], ["x", "3", "y", "14", "width", "7", "height", "7"], ["routerLink", "/roles", "routerLinkActive", "active", 1, "nav-link"], ["xmlns", "http://www.w3.org/2000/svg", "width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "lucide", "lucide-shield-user-icon", "lucide-shield-user"], ["d", "M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"], ["d", "M6.376 18.91a6 6 0 0 1 11.249.003"], ["cx", "12", "cy", "11", "r", "4"], [1, "user-details"], [1, "user-name"], [1, "user-role"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(7, SidebarComponent_li_7_Template, 6, 2, "li", 7)(8, SidebarComponent_li_8_Template, 8, 2, "li", 7)(9, SidebarComponent_li_9_Template, 8, 2, "li", 7)(10, SidebarComponent_li_10_Template, 6, 1, "li", 7)(11, SidebarComponent_li_11_Template, 9, 1, "li", 7)(12, SidebarComponent_li_12_Template, 14, 1, "li", 7)(13, SidebarComponent_li_13_Template, 5, 1, "li", 7)(14, SidebarComponent_li_14_Template, 7, 1, "li", 7)(15, SidebarComponent_li_15_Template, 11, 1, "li", 7)(16, SidebarComponent_li_16_Template, 11, 1, "li", 7)(17, SidebarComponent_li_17_Template, 7, 1, "li", 7)(18, SidebarComponent_li_18_Template, 9, 1, "li", 7)(19, SidebarComponent_li_19_Template, 9, 1, "li", 7)(20, SidebarComponent_li_20_Template, 8, 1, "li", 7);
      \u0275\u0275elementEnd();
      \u0275\u0275element(21, "div", 8);
      \u0275\u0275elementStart(22, "ul", 6);
      \u0275\u0275template(23, SidebarComponent_li_23_Template, 7, 2, "li", 7);
      \u0275\u0275elementEnd();
      \u0275\u0275element(24, "div", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "div", 9)(26, "div", 10)(27, "button", 11);
      \u0275\u0275listener("click", function SidebarComponent_Template_button_click_27_listener() {
        return ctx.openNotificationModal();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(28, "svg", 12);
      \u0275\u0275element(29, "path", 13)(30, "path", 14);
      \u0275\u0275elementEnd();
      \u0275\u0275template(31, SidebarComponent_span_31_Template, 2, 1, "span", 15);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(32, "div", 10)(33, "div", 16)(34, "div", 17)(35, "div", 18)(36, "img", 19);
      \u0275\u0275listener("error", function SidebarComponent_Template_img_error_36_listener($event) {
        return $event.target.src = "assets/images/user.png";
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275template(37, SidebarComponent_div_37_Template, 5, 2, "div", 20);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(38, "div", 10)(39, "button", 21);
      \u0275\u0275listener("click", function SidebarComponent_Template_button_click_39_listener() {
        return ctx.openLogoutConfirm();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(40, "svg", 22);
      \u0275\u0275element(41, "path", 23)(42, "polyline", 24)(43, "line", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275template(44, SidebarComponent_span_44_Template, 2, 1, "span", 15);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-CI7LIAIY.js.map

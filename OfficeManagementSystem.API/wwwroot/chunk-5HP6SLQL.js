...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "profile",
        loadComponent: () => import("./chunk-BBQRH47N.js").then((m) => m.ProfileComponent)
      },
      {
        path: "departments",
        loadChildren: () => import("./chunk-QSW6Z52W.js").then((m) => m.DepartmentsModule),
        canActivate: [PermissionGuard],
        data: { permission: "department.index" }
      },
      {
        path: "tasks",
        loadChildren: () => import("./chunk-SUIUUXUT.js").then((m) => m.TasksModule),
        canActivate: [PermissionGuard],
      ...
      {
        path: "visits",
        loadChildren: () => import("./chunk-BHF4GIPG.js").then((m) => m.VisitsModule),
        canActivate: [PermissionGuard],
      ...
      {
        path: "meetings",
        loadChildren: () => import("./chunk-PLO6AVTA.js").then((m) => m.MeetingsModule),
        canActivate: [PermissionGuard],
        data: { permission: "meeting.index" }
      },
      {
        path: "my-calendar",
        loadChildren: () => import("./chunk-5P7NS4QW.js").then((m) => m.CalendarModule),
        canActivate: [PermissionGuard],
      ...
      {
        path: "letters",
        loadChildren: () => import("./chunk-BITH75QK.js").then((m) => m.LettersModule),
        canActivate: [PermissionGuard],
...
//# sourceMappingURL=chunk-5HP6SLQL.js.map

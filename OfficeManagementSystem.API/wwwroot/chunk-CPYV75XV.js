...
function CalendarComponent_div_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46)(1, "div", 47)(2, "h4", 48);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(6, 5, event_r2.startDate, "short"));
    \u0275\u0275advance(2);
...
function CalendarComponent_div_55_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 53);
    \u0275\u0275template(1, CalendarComponent_div_55_div_1_Template, 2, 1, "div", 54);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function CalendarComponent_div_56_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_58_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_58_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 67)(1, "div", 57);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function CalendarComponent_div_58_div_3_div_1_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 76);
    \u0275\u0275element(1, "div", 77);
    \u0275\u0275elementStart(2, "div", 78)(3, "div", 48);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(event_r8.type);
  }
}
function CalendarComponent_div_58_div_3_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 72)(1, "h3", 73);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 74);
    \u0275\u0275template(4, CalendarComponent_div_58_div_3_div_1_div_4_Template, 11, 12, "div", 75);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CalendarComponent_div_58_div_3_div_2_div_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(7, 4, reminder_r9.reminderTime, "shortTime"));
  }
}
function CalendarComponent_div_58_div_3_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 81)(1, "h3", 73);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 82);
    \u0275\u0275template(4, CalendarComponent_div_58_div_3_div_2_div_4_Template, 8, 7, "div", 83);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const day_r7 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.translate("reminders.all_reminders"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.getRemindersForDate(day_r7));
  }
}
function CalendarComponent_div_58_div_3_div_3_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_58_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 68);
    \u0275\u0275template(1, CalendarComponent_div_58_div_3_div_1_Template, 5, 2, "div", 69)(2, CalendarComponent_div_58_div_3_div_2_Template, 5, 2, "div", 70)(3, CalendarComponent_div_58_div_3_div_3_Template, 3, 1, "div", 71);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const day_r7 = \u0275\u0275nextContext().$implicit;
...
function CalendarComponent_div_58_div_4_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_58_div_4_div_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(reminder_r11.title);
  }
}
function CalendarComponent_div_58_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 90);
    \u0275\u0275template(1, CalendarComponent_div_58_div_4_div_1_Template, 2, 4, "div", 91);
    \u0275\u0275pipe(2, "slice");
    \u0275\u0275template(3, CalendarComponent_div_58_div_4_div_3_Template, 2, 2, "div", 92);
    \u0275\u0275pipe(4, "slice");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind3(2, 2, ctx_r2.getUserEventsForDate(day_r7), 0, ctx_r2.isLargeScreen() ? 3 : ctx_r2.getUserEventsForDate(day_r7).length));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind3(4, 6, ctx_r2.getRemindersForDate(day_r7), 0, ctx_r2.isLargeScreen() ? 3 : ctx_r2.getRemindersForDate(day_r7).length));
  }
}
function CalendarComponent_div_58_div_5_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 98);
  }
  if (rf & 2) {
    const reminder_r12 = ctx.$implicit;
    \u0275\u0275property("title", reminder_r12.title);
  }
}
function CalendarComponent_div_58_div_5_div_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const day_r7 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275styleProp("background-color", ctx_r2.getAdditionalEventsColor(day_r7));
    \u0275\u0275property("title", "+" + (ctx_r2.getUserEventsForDate(day_r7).length + ctx_r2.getRemindersForDate(day_r7).length - 3) + " more events");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" +", ctx_r2.getUserEventsForDate(day_r7).length + ctx_r2.getRemindersForDate(day_r7).length - 3, " ");
  }
}
function CalendarComponent_div_58_div_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 95);
    \u0275\u0275template(1, CalendarComponent_div_58_div_5_div_1_Template, 1, 1, "div", 96);
    \u0275\u0275pipe(2, "slice");
    \u0275\u0275template(3, CalendarComponent_div_58_div_5_div_3_Template, 2, 4, "div", 97);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const day_r7 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind3(2, 2, ctx_r2.getRemindersForDate(day_r7), 0, ctx_r2.isLargeScreen() ? 3 : ctx_r2.getRemindersForDate(day_r7).length));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r2.isLargeScreen() && ctx_r2.getUserEventsForDate(day_r7).length + ctx_r2.getRemindersForDate(day_r7).length > 3);
  }
}
function CalendarComponent_div_58_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CalendarComponent_div_58_Template_div_click_0_listener() {
      const day_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onDateClick(day_r7));
    });
    \u0275\u0275template(1, CalendarComponent_div_58_div_1_Template, 3, 5, "div", 60)(2, CalendarComponent_div_58_div_2_Template, 5, 6, "div", 61)(3, CalendarComponent_div_58_div_3_Template, 4, 3, "div", 62)(4, CalendarComponent_div_58_div_4_Template, 5, 10, "div", 63)(5, CalendarComponent_div_58_div_5_Template, 4, 6, "div", 64);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function CalendarComponent_div_59_div_12_p_4_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_59_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 76)(1, "div", 107)(2, "h4", 48);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, CalendarComponent_div_59_div_12_p_4_Template, 2, 1, "p", 108);
    \u0275\u0275elementStart(5, "div", 109)(6, "span", 79);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "date");
    \u0275\u0275pipe(9, "date");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(8, 10, event_r14.startDate, "short"), " - ", \u0275\u0275pipeBind2(9, 13, event_r14.endDate, "short"), " ");
    \u0275\u0275advance(3);
...
function CalendarComponent_div_59_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 89)(1, "p");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function CalendarComponent_div_59_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CalendarComponent_div_59_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.selectedDate.set(null));
    });
    \u0275\u0275elementStart(1, "div", 101);
    \u0275\u0275listener("click", function CalendarComponent_div_59_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r13);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 102)(3, "h3");
    \u0275\u0275text(4);
    \u0275\u0275pipe(5, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 103);
    \u0275\u0275listener("click", function CalendarComponent_div_59_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r13);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.selectedDate.set(null));
    });
    ...
    \u0275\u0275element(8, "line", 104)(9, "line", 105);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(10, "div", 106)(11, "div", 74);
    \u0275\u0275template(12, CalendarComponent_div_59_div_12_Template, 14, 16, "div", 75)(13, CalendarComponent_div_59_div_13_Template, 3, 1, "div", 71);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function CalendarComponent_div_60_div_11_p_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 111);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CalendarComponent_div_60_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 76)(1, "div", 107)(2, "h4", 48);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, CalendarComponent_div_60_div_11_p_4_Template, 2, 1, "p", 108);
    \u0275\u0275elementStart(5, "div", 109)(6, "span", 79);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "date");
    \u0275\u0275pipe(9, "date");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.getEventTypeLabel(event_r16.type), " ");
    \u0275\u0275advance();
...
function CalendarComponent_div_60_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 89)(1, "p");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function CalendarComponent_div_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "div", 101);
    \u0275\u0275listener("click", function CalendarComponent_div_60_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r15);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 102)(3, "h3");
    ...
    \u0275\u0275listener("click", function CalendarComponent_div_60_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r15);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeAllUserEventsModal());
    });
    ...
    \u0275\u0275element(7, "line", 104)(8, "line", 105);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "div", 106)(10, "div", 74);
    \u0275\u0275template(11, CalendarComponent_div_60_div_11_Template, 14, 16, "div", 75)(12, CalendarComponent_div_60_div_12_Template, 3, 1, "div", 71);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function CalendarComponent_div_62_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "circle", 10)(4, "line", 119)(5, "line", 120);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7);
    ...
    \u0275\u0275listener("click", function CalendarComponent_div_62_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r2 = \u0275\u0275nextContext();
...
function CalendarComponent_div_66_div_12_p_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const reminder_r19 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(reminder_r19.description);
  }
}
function CalendarComponent_div_66_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 84)(1, "div", 124)(2, "h4", 87);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, CalendarComponent_div_66_div_12_p_4_Template, 2, 1, "p", 125);
    \u0275\u0275elementStart(5, "div", 126)(6, "div", 127)(7, "span", 128);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span", 129);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 127)(12, "span", 128);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "span", 129);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const reminder_r19 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(reminder_r19.title);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", reminder_r19.description);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r2.translate("reminders.event_time"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatDateTime(reminder_r19.eventTime));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r2.translate("reminders.reminder_time"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatDateTime(reminder_r19.reminderTime));
  }
}
function CalendarComponent_div_66_div_13_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarComponent_div_66_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 122);
    \u0275\u0275listener("click", function CalendarComponent_div_66_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeDayRemindersModal());
    });
    \u0275\u0275elementStart(1, "div", 101);
    \u0275\u0275listener("click", function CalendarComponent_div_66_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r18);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 102)(3, "h3");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 103);
    \u0275\u0275listener("click", function CalendarComponent_div_66_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r18);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeDayRemindersModal());
    });
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(10, "div", 106)(11, "div", 82);
    \u0275\u0275template(12, CalendarComponent_div_66_div_12_Template, 16, 6, "div", 83)(13, CalendarComponent_div_66_div_13_Template, 9, 2, "div", 123);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var CalendarComponent = class _CalendarComponent {
  ...
  }, standalone: false, decls: 67, vars: 40, consts: [["allRemindersModal", ""], [1, "calendar-container", "rounded-5"], [1, "calendar-header"], [1, "header-left"], [1, "page-title"], [1, "page-subtitle"], [1, "header-actions"], [1, "reminder-actions"], [1, "btn", "btn-primary", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "12", "y1", "8", "x2", "12", "y2", "16"], ["x1", "8", "y1", "12", "x2", "16", "y2", "12"], [1, "btn", "btn-secondary", 3, "click"], ["d", "M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"], ["x1", "12", "y1", "17", "x2", "12.01", "y2", "17"], [1, "reminder-indicator"], [1, "indicator-dot", "reminder-event"], [1, "view-mode-toggle"], [1, "view-btn", 3, "click"], [1, "calendar-content"], [1, "user-events-widget"], [1, "widget-header"], [1, "event-count"], [1, "user-events-list"], ["class", "user-event-item", 4, "ngFor", "ngForOf"], ["class", "view-all-link", 4, "ngIf"], [1, "calendar-grid-container"], [1, "calendar-navigation"], [1, "nav-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["points", "15,18 9,12 15,6"], [1, "current-month"], ["points", "9,18 15,12 9,6"], [1, "calendar-grid"], ["class", "week-days", 4, "ngIf"], ["class", "day-view-header", 4, "ngIf"], [1, "calendar-days"], ["class", "calendar-day", 3, "day-view-day", "today", "selected", "other-month", "click", 4, "ngFor", "ngForOf"], ["class", "event-details-modal", 3, "click", 4, "ngIf"], ["class", "all-user-events-modal", 3, "click", 4, "ngIf"], ["class", "loading-overlay", 4, "ngIf"], ["class", "error-message", 4, "ngIf"], [3, "reminderCreated", "closeModal", "isOpen"], [3, "reminderUpdated", "closeModal", "isOpen"], ["class", "day-reminders-modal", 3, "click", 4, "ngIf"], [1, "user-event-item"], [1, "event-info"], [1, "event-title"], [1, "event-date"], [1, "event-type-badge"], [1, "view-all-link"], [1, "view-all-btn", 3, "click"], [1, "week-days"], ["class", "week-day", 4, "ngFor", "ngForOf"], [1, "week-day"], [1, "day-view-header"], [1, "day-name"], [1, "day-date"], [1, "calendar-day", 3, "click"], ["class", "day-header", 4, "ngIf"], ["class", "day-header-small", 4, "ngIf"], ["class", "day-view-content", 4, "ngIf"], ["class", "day-event-titles", 4, "ngIf"], ["class", "day-events", 4, "ngIf"], [1, "day-header"], [1, "day-number"], [1, "day-header-small"], [1, "day-view-content"], ["class", "day-events-section", 4, "ngIf"], ["class", "day-reminders-section", 4, "ngIf"], ["class", "no-events", 4, "ngIf"], [1, "day-events-section"], [1, "section-title"], [1, "events-list"], ["class", "event-item", 4, "ngFor", "ngForOf"], [1, "event-item"], [1, "event-dot"], [1, "event-details"], [1, "event-time"], [1, "event-type"], [1, "day-reminders-section"], [1, "reminders-list"], ["class", "reminder-item", 4, "ngFor", "ngForOf"], [1, "reminder-item"], [1, "reminder-dot"], [1, "reminder-details"], [1, "reminder-title"], [1, "reminder-time"], [1, "no-events"], [1, "day-event-titles"], ["class", "event-title user-event-title", 3, "color", "title", 4, "ngFor", "ngForOf"], ["class", "event-title reminder-event-title", 3, "title", 4, "ngFor", "ngForOf"], [1, "event-title", "user-event-title", 3, "title"], [1, "event-title", "reminder-event-title", 3, "title"], [1, "day-events"], ["class", "event-dot reminder-event", 3, "title", 4, "ngFor", "ngForOf"], ["class", "additional-events-dot-indicator", 3, "title", "background-color", 4, "ngIf"], [1, "event-dot", "reminder-event", 3, "title"], [1, "additional-events-dot-indicator", 3, "title"], [1, "event-details-modal", 3, "click"], [1, "modal-content", 3, "click"], [1, "modal-header"], [1, "close-btn", 3, "click"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "modal-body"], [1, "event-content"], ["class", "event-description", 4, "ngIf"], [1, "event-meta"], [1, "event-status"], [1, "event-description"], [1, "all-user-events-modal", 3, "click"], [1, "loading-overlay"], [1, "loading-spinner"], [1, "spinner"], [1, "error-message"], [1, "error-content"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "15", "y1", "9", "x2", "9", "y2", "15"], ["x1", "9", "y1", "9", "x2", "15", "y2", "15"], [1, "retry-btn", 3, "click"], [1, "day-reminders-modal", 3, "click"], ["class", "no-reminders", 4, "ngIf"], [1, "reminder-content"], ["class", "reminder-description", 4, "ngIf"], [1, "reminder-dates"], [1, "date-item"], [1, "date-label"], [1, "date-value"], [1, "reminder-description"], [1, "no-reminders"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1"]], template: function CalendarComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275template(40, CalendarComponent_div_40_Template, 9, 8, "div", 25);
      \u0275\u0275pipe(41, "slice");
      ...
      \u0275\u0275template(55, CalendarComponent_div_55_Template, 2, 1, "div", 35)(56, CalendarComponent_div_56_Template, 6, 5, "div", 36);
      \u0275\u0275elementStart(57, "div", 37);
      \u0275\u0275template(58, CalendarComponent_div_58_Template, 6, 13, "div", 38);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(59, CalendarComponent_div_59_Template, 14, 6, "div", 39)(60, CalendarComponent_div_60_Template, 13, 5, "div", 40)(61, CalendarComponent_div_61_Template, 5, 1, "div", 41)(62, CalendarComponent_div_62_Template, 10, 2, "div", 42);
      \u0275\u0275elementStart(63, "app-add-reminder-modal", 43);
      \u0275\u0275listener("reminderCreated", function CalendarComponent_Template_app_add_reminder_modal_reminderCreated_63_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onReminderCreated());
      })("closeModal", function CalendarComponent_Template_app_add_reminder_modal_closeModal_63_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.closeAddReminderModal());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(64, "app-all-reminders-modal", 44, 0);
      \u0275\u0275listener("reminderUpdated", function CalendarComponent_Template_app_all_reminders_modal_reminderUpdated_64_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onReminderUpdated());
      })("closeModal", function CalendarComponent_Template_app_all_reminders_modal_closeModal_64_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.closeAllRemindersModal());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(66, CalendarComponent_div_66_Template, 14, 6, "div", 45);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", \u0275\u0275pipeBind3(41, 36, ctx.userEvents(), 0, 5));
      \u0275\u0275advance(2);
...
\r
        <!-- Day View Header - Only shown in day view on large screens -->\r
...
\r
        ...
        <div class="calendar-days" [class.day-view-days]="viewMode() === 'day'">\r
          ...
          >\r
            ...
            <div *ngIf="viewMode() !== 'day'" class="day-header">\r
              <div \r
                class="day-number"\r
...
\r
            ...
            <div *ngIf="viewMode() === 'day'" class="day-header-small">\r
              <div class="day-name">{{ getDayName(day) }}</div>\r
              <div \r
                class="day-number"\r
                [class.has-events]="getUserEventsForDate(day).length > 0"\r
                [class.has-reminders]="getRemindersForDate(day).length > 0"\r
...
\r
            ...
            <div *ngIf="viewMode() === 'day'" class="day-view-content">\r
              <!-- Events Section -->\r
              <div class="day-events-section" *ngIf="getUserEventsForDate(day).length > 0">\r
...
\r
              <!-- Reminders Section -->\r
              <div class="day-reminders-section" *ngIf="getRemindersForDate(day).length > 0">\r
                <h3 class="section-title">{{translate('reminders.all_reminders')}}</h3>\r
                <div class="reminders-list">\r
                  ...
                  >\r
                    ...
                    <div class="reminder-details">\r
                      ...
                      <div class="reminder-time">{{ reminder.reminderTime | date:'shortTime' }}</div>\r
                    </div>\r
                  </div>\r
                </div>\r
              </div>\r
\r
              <!-- No events message -->\r
              <div class="no-events" *ngIf="getUserEventsForDate(day).length === 0 && getRemindersForDate(day).length === 0">\r
                <p>{{translate('calendar.no_events_today')}}</p>\r
              </div>\r
            </div>\r
            \r
            <!-- Event titles for this day (month/week view only) -->\r
            <div class="day-event-titles" *ngIf="viewMode() !== 'day'">\r
              <!-- User Events (max 3 on large screens, all on small/medium) -->\r
              <div \r
                class="event-title user-event-title"\r
                *ngFor="let event of getUserEventsForDate(day) | slice:0:(isLargeScreen() ? 3 : getUserEventsForDate(day).length)"\r
                [style.color]="event.color"\r
                [title]="event.title"\r
              >{{ event.title }}</div>\r
\r
              <!-- Reminders (max 4 on large screens, all on small/medium) -->\r
              <div \r
                class="event-title reminder-event-title"\r
                *ngFor="let reminder of getRemindersForDate(day) | slice:0:(isLargeScreen() ? 3 : getRemindersForDate(day).length)"\r
                [title]="reminder.title"\r
              >{{ reminder.title }}</div>\r
\r
              <!-- Additional events indicator (only on large screens) -->\r
              <!-- <div \r
                class="additional-events-indicator"\r
                *ngIf="isLargeScreen() && (getUserEventsForDate(day).length + getRemindersForDate(day).length) > 3"\r
                [title]="'+' + ((getUserEventsForDate(day).length + getRemindersForDate(day).length) - 3) + ' more events'"\r
              >\r
                +{{ (getUserEventsForDate(day).length + getRemindersForDate(day).length) - 3 }}\r
              </div> -->\r
            </div>\r
            \r
             <!-- Events for this day (month/week view only) -->\r
             <div class="day-events" *ngIf="viewMode() !== 'day'">\r
               ...
               ></div> -->\r
\r
               <!-- Reminders (max 3 on large screens, all on small/medium) -->\r
               <div \r
               ...
               ></div>\r
\r
               <!-- Additional events indicator for bullets (only on large screens) -->\r
               <div \r
                 class="additional-events-dot-indicator"\r
                 *ngIf="isLargeScreen() && (getUserEventsForDate(day).length + getRemindersForDate(day).length) > 3"\r
                 [title]="'+' + ((getUserEventsForDate(day).length + getRemindersForDate(day).length) - 3) + ' more events'"\r
                 [style.background-color]="getAdditionalEventsColor(day)"\r
               >\r
                 +{{ (getUserEventsForDate(day).length + getRemindersForDate(day).length) - 3 }}\r
               </div>\r
             </div>\r
...
//# sourceMappingURL=chunk-CPYV75XV.js.map

...
function AddReminderModalComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, AddReminderModalComponent_div_0_div_15_Template, 2, 1, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 10)(17, "label", 14);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "textarea", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 10)(21, "label", 16);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275element(23, "input", 17);
    \u0275\u0275template(24, AddReminderModalComponent_div_0_div_24_Template, 2, 1, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 10)(26, "label", 18);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275element(28, "input", 19);
    \u0275\u0275template(29, AddReminderModalComponent_div_0_div_29_Template, 2, 1, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275template(30, AddReminderModalComponent_div_0_div_30_Template, 2, 1, "div", 13);
    ...
    \u0275\u0275template(35, AddReminderModalComponent_div_0_span_35_Template, 1, 0, "span", 23);
    \u0275\u0275text(36);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
...
(() => {
  ...
  <div class="modal-content" (click)="$event.stopPropagation()">\r
    <div class="modal-header">\r
      <h3>{{ translate('reminders.add_reminder') }}</h3>\r
...
function EditReminderModalComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(14, "input", 12);
    \u0275\u0275template(15, EditReminderModalComponent_div_0_div_15_Template, 2, 1, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 10)(17, "label", 14);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(23, "input", 17);
    \u0275\u0275template(24, EditReminderModalComponent_div_0_div_24_Template, 2, 1, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 10)(26, "label", 18);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd();
    \u0275\u0275element(28, "input", 19);
    \u0275\u0275template(29, EditReminderModalComponent_div_0_div_29_Template, 2, 1, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275template(30, EditReminderModalComponent_div_0_div_30_Template, 2, 1, "div", 13);
    \u0275\u0275elementStart(31, "div", 20)(32, "button", 21);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "button", 22);
    \u0275\u0275template(35, EditReminderModalComponent_div_0_span_35_Template, 1, 0, "span", 23);
    \u0275\u0275text(36);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
...
var EditReminderModalComponent = class _EditReminderModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditReminderModalComponent, selectors: [["app-edit-reminder-modal"]], inputs: { isOpen: "isOpen", reminder: "reminder" }, outputs: { reminderUpdated: "reminderUpdated", closeModal: "closeModal" }, standalone: false, features: [\u0275\u0275NgOnChangesFeature], decls: 1, vars: 1, consts: [["class", "edit-reminder-modal", 3, "click", 4, "ngIf"], [1, "edit-reminder-modal", 3, "click"], [1, "modal-content", 3, "click"], [1, "modal-header"], [1, "close-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "modal-body"], [3, "ngSubmit", "formGroup"], [1, "form-group"], ["for", "title"], ["type", "text", "id", "title", "formControlName", "title", 1, "form-control", 3, "placeholder"], ["class", "error-message", 4, "ngIf"], ["for", "description"], ["id", "description", "formControlName", "description", "rows", "3", 1, "form-control", 3, "placeholder"], ["for", "eventTime"], ["type", "datetime-local", "id", "eventTime", "formControlName", "eventTime", 1, "form-control"], ["for", "reminderTime"], ["type", "datetime-local", "id", "reminderTime", "formControlName", "reminderTime", 1, "form-control"], [1, "form-actions"], ["type", "button", 1, "btn", "btn-secondary", 3, "click", "disabled"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner", 4, "ngIf"], [1, "error-message"], [1, "spinner"]], template: function EditReminderModalComponent_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [NgIf, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName], styles: ["\n\n.edit-reminder-modal[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 1000;\n}\n.modal-content[_ngcontent-%COMP%] {\n  background: white;\n  border-radius: 12px;\n  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);\n  width: 90%;\n  max-width: 500px;\n  max-height: 90vh;\n  overflow-y: auto;\n}\n.modal-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 20px 24px;\n  border-bottom: 1px solid #e5e7eb;\n}\n.modal-header[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 1.25rem;\n  font-weight: 600;\n  color: #111827;\n}\n.close-btn[_ngcontent-%COMP%] {\n  background: none;\n  border: none;\n  cursor: pointer;\n  padding: 4px;\n  border-radius: 4px;\n  color: #6b7280;\n  transition: all 0.2s;\n}\n.close-btn[_ngcontent-%COMP%]:hover {\n  background-color: #f3f4f6;\n  color: #374151;\n}\n.modal-body[_ngcontent-%COMP%] {\n  padding: 24px;\n}\n.form-group[_ngcontent-%COMP%] {\n  margin-bottom: 20px;\n}\n.form-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  display: block;\n  margin-bottom: 6px;\n  font-weight: 500;\n  color: #374151;\n  font-size: 0.875rem;\n}\n.form-control[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 10px 12px;\n  border: 1px solid #d1d5db;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  transition: border-color 0.2s, box-shadow 0.2s;\n  box-sizing: border-box;\n}\n.form-control[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: #3b82f6;\n  box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.1);\n}\n.form-control.error[_ngcontent-%COMP%] {\n  border-color: #ef4444;\n}\n.form-control.error[_ngcontent-%COMP%]:focus {\n  border-color: #ef4444;\n  box-shadow: 0 0 0 3px rgba(239, 68, 68, 0.1);\n}\ntextarea.form-control[_ngcontent-%COMP%] {\n  resize: vertical;\n  min-height: 80px;\n}\n.error-message[_ngcontent-%COMP%] {\n  color: #ef4444;\n  font-size: 0.75rem;\n  margin-top: 4px;\n}\n.form-actions[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  gap: 12px;\n  margin-top: 24px;\n  padding-top: 20px;\n  border-top: 1px solid #e5e7eb;\n}\n.btn[_ngcontent-%COMP%] {\n  padding: 10px 20px;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s;\n  border: none;\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.btn[_ngcontent-%COMP%]:disabled {\n  opacity: 0.6;\n  cursor: not-allowed;\n}\n.btn-secondary[_ngcontent-%COMP%] {\n  background-color: #f3f4f6;\n  color: #374151;\n}\n.btn-secondary[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: #e5e7eb;\n}\n.btn-primary[_ngcontent-%COMP%] {\n  background-color: #3b82f6;\n  color: white;\n}\n.btn-primary[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: #2563eb;\n}\n.spinner[_ngcontent-%COMP%] {\n  width: 16px;\n  height: 16px;\n  border: 2px solid transparent;\n  border-top: 2px solid currentColor;\n  border-radius: 50%;\n  animation: _ngcontent-%COMP%_spin 1s linear infinite;\n}\n@keyframes _ngcontent-%COMP%_spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.rtl[_ngcontent-%COMP%]   .modal-header[_ngcontent-%COMP%] {\n  direction: rtl;\n}\n.rtl[_ngcontent-%COMP%]   .form-actions[_ngcontent-%COMP%] {\n  flex-direction: row-reverse;\n}\n@media (max-width: 640px) {\n  .modal-content[_ngcontent-%COMP%] {\n    width: 95%;\n    margin: 20px;\n  }\n  .modal-header[_ngcontent-%COMP%], \n   .modal-body[_ngcontent-%COMP%] {\n    padding: 16px;\n  }\n  .form-actions[_ngcontent-%COMP%] {\n    flex-direction: column;\n  }\n  .btn[_ngcontent-%COMP%] {\n    width: 100%;\n    justify-content: center;\n  }\n}\n/*# sourceMappingURL=edit-reminder-modal.component-BEMCWZGV.css.map */"] });
};
(() => {
  ...
  <div class="modal-content" (click)="$event.stopPropagation()">\r
    <div class="modal-header">\r
      <h3>{{ translate('reminders.edit_reminder') }}</h3>\r
      <button class="close-btn" (click)="onCancel()">\r
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
          <line x1="18" y1="6" x2="6" y2="18"></line>\r
          <line x1="6" y1="6" x2="18" y2="18"></line>\r
...
function AllRemindersModalComponent_div_0_div_12_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, AllRemindersModalComponent_div_0_div_12_div_1_p_4_Template, 2, 1, "p", 28);
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(16, "div", 33)(17, "button", 34);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(18, "svg", 35);
    \u0275\u0275element(19, "path", 36)(20, "path", 37);
    \u0275\u0275elementEnd();
    \u0275\u0275text(21);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275element(24, "polyline", 39)(25, "path", 40)(26, "line", 41)(27, "line", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275text(28);
    \u0275\u0275elementEnd()()();
  }
...
function AllRemindersModalComponent_div_0_div_12_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "circle", 18)(3, "path", 46)(4, "line", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(5, "h4");
    \u0275\u0275text(6);
...
function AllRemindersModalComponent_div_0_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, AllRemindersModalComponent_div_0_div_12_div_1_Template, 29, 8, "div", 23)(2, AllRemindersModalComponent_div_0_div_12_div_2_Template, 9, 2, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function AllRemindersModalComponent_div_0_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(16, AllRemindersModalComponent_div_0_div_14_span_16_Template, 1, 0, "span", 52);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function AllRemindersModalComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(10, AllRemindersModalComponent_div_0_div_10_Template, 4, 1, "div", 9)(11, AllRemindersModalComponent_div_0_div_11_Template, 9, 2, "div", 10)(12, AllRemindersModalComponent_div_0_div_12_Template, 3, 2, "div", 11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "app-edit-reminder-modal", 12);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, AllRemindersModalComponent_div_0_div_14_Template, 18, 7, "div", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var AllRemindersModalComponent = class _AllRemindersModalComponent {
  ...
  constructor(reminderService, translationService) {
    this.reminderService = reminderService;
    this.translationService = translationService;
  }
  ngOnInit() {
...
(() => {
  ...
  <div class="modal-content" (click)="$event.stopPropagation()">\r
    <div class="modal-header">\r
      <h3>{{ translate('reminders.all_reminders') }}</h3>\r
...
`, styles: ["/* src/app/components/calendar/all-reminders-modal/all-reminders-modal.component.css */\n.all-reminders-modal {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 1000;\n}\n.modal-content {\n  background: white;\n  border-radius: 12px;\n  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);\n  width: 90%;\n  max-width: 800px;\n  max-height: 90vh;\n  overflow-y: auto;\n}\n.modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 20px 24px;\n  border-bottom: 1px solid #e5e7eb;\n}\n.modal-header h3 {\n  margin: 0;\n  font-size: 1.25rem;\n  font-weight: 600;\n  color: #111827;\n}\n.close-btn {\n  background: none;\n  border: none;\n  cursor: pointer;\n  padding: 4px;\n  border-radius: 4px;\n  color: #6b7280;\n  transition: all 0.2s;\n}\n.close-btn:hover {\n  background-color: #f3f4f6;\n  color: #374151;\n}\n.modal-body {\n  padding: 24px;\n}\n.loading-state {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 40px 20px;\n  text-align: center;\n}\n.spinner {\n  width: 32px;\n  height: 32px;\n  border: 3px solid #f3f4f6;\n  border-top: 3px solid #3b82f6;\n  border-radius: 50%;\n  animation: spin 1s linear infinite;\n  margin-bottom: 16px;\n}\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.error-state {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 40px 20px;\n  text-align: center;\n  color: #ef4444;\n}\n.error-state svg {\n  margin-bottom: 16px;\n}\n.retry-btn {\n  margin-top: 16px;\n  padding: 8px 16px;\n  background-color: #3b82f6;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  cursor: pointer;\n  font-size: 0.875rem;\n}\n.retry-btn:hover {\n  background-color: #2563eb;\n}\n.reminders-list {\n  max-height: 60vh;\n  overflow-y: auto;\n}\n.reminder-item {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  padding: 16px;\n  border: 1px solid #e5e7eb;\n  border-radius: 8px;\n  margin-bottom: 12px;\n  transition: all 0.2s;\n}\n.reminder-item:hover {\n  border-color: #d1d5db;\n  box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1);\n}\n.reminder-content {\n  flex: 1;\n  margin-right: 16px;\n}\n.reminder-title {\n  margin: 0 0 8px 0;\n  font-size: 1rem;\n  font-weight: 600;\n  color: #111827;\n}\n.reminder-description {\n  margin: 0 0 12px 0;\n  color: #6b7280;\n  font-size: 0.875rem;\n  line-height: 1.4;\n}\n.reminder-dates {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.date-item {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  font-size: 0.875rem;\n}\n.date-label {\n  font-weight: 500;\n  color: #374151;\n  min-width: 120px;\n}\n.date-value {\n  color: #6b7280;\n}\n.reminder-actions {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  min-width: 100px;\n}\n.action-btn {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  padding: 6px 12px;\n  border: none;\n  border-radius: 6px;\n  font-size: 0.75rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.edit-btn {\n  background-color: #f3f4f6;\n  color: #374151;\n}\n.edit-btn:hover {\n  background-color: #e5e7eb;\n}\n.delete-btn {\n  background-color: #fef2f2;\n  color: #dc2626;\n}\n.delete-btn:hover {\n  background-color: #fee2e2;\n}\n.empty-state {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 60px 20px;\n  text-align: center;\n  color: #6b7280;\n}\n.empty-state svg {\n  margin-bottom: 16px;\n  color: #d1d5db;\n}\n.empty-state h4 {\n  margin: 0 0 8px 0;\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #374151;\n}\n.empty-state p {\n  margin: 0;\n  font-size: 0.875rem;\n  line-height: 1.4;\n}\n.delete-confirm-modal {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  z-index: 1001;\n}\n.delete-confirm-modal .modal-content {\n  width: 90%;\n  max-width: 400px;\n}\n.modal-actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 12px;\n  margin-top: 20px;\n}\n.btn {\n  padding: 10px 20px;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s;\n  border: none;\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.btn:disabled {\n  opacity: 0.6;\n  cursor: not-allowed;\n}\n.btn-secondary {\n  background-color: #f3f4f6;\n  color: #374151;\n}\n.btn-secondary:hover:not(:disabled) {\n  background-color: #e5e7eb;\n}\n.btn-danger {\n  background-color: #dc2626;\n  color: white;\n}\n.btn-danger:hover:not(:disabled) {\n  background-color: #b91c1c;\n}\n.rtl .modal-header {\n  direction: rtl;\n}\n.rtl .reminder-item {\n  flex-direction: row-reverse;\n}\n.rtl .reminder-content {\n  margin-right: 0;\n  margin-left: 16px;\n}\n.rtl .reminder-actions {\n  flex-direction: column;\n}\n.rtl .modal-actions {\n  flex-direction: row-reverse;\n}\n@media (max-width: 768px) {\n  .modal-content {\n    width: 95%;\n    margin: 20px;\n  }\n  .modal-header,\n  .modal-body {\n    padding: 16px;\n  }\n  .reminder-item {\n    flex-direction: column;\n    align-items: stretch;\n  }\n  .reminder-content {\n    margin-right: 0;\n    margin-bottom: 12px;\n  }\n  .reminder-actions {\n    flex-direction: row;\n    justify-content: space-between;\n  }\n  .action-btn {\n    flex: 1;\n    justify-content: center;\n  }\n}\n/*# sourceMappingURL=all-reminders-modal.component-MPXQLZEO.css.map */\n"] }]
  }], () => [{ type: ReminderService }, { type: TranslationService }], { isOpen: [{
    type: Input
  }], closeModal: [{
    type: Output
  }], reminderUpdated: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AllRemindersModalComponent, { className: "AllRemindersModalComponent", filePath: "src/app/components/calendar/all-reminders-modal/all-reminders-modal.component.ts", lineNumber: 12 });
})();
...
function CalendarComponent_div_60_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 60);
  }
  if (rf & 2) {
...
function CalendarComponent_div_60_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, CalendarComponent_div_60_div_4_Template, 1, 3, "div", 58)(5, CalendarComponent_div_60_div_5_Template, 1, 1, "div", 59);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CalendarComponent_div_61_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "div", 73);
    \u0275\u0275elementStart(2, "div", 74)(3, "h4", 49);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, CalendarComponent_div_61_div_12_p_5_Template, 2, 1, "p", 75);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275styleProp("background-color", event_r11.color);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(event_r11.title);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", event_r11.description);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind2(9, 12, event_r11.startDate, "short"), " - ", \u0275\u0275pipeBind2(10, 15, event_r11.endDate, "short"), " ");
    \u0275\u0275advance(3);
...
function CalendarComponent_div_61_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(8, "line", 66)(9, "line", 67);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(10, "div", 68)(11, "div", 69);
    \u0275\u0275template(12, CalendarComponent_div_61_div_12_Template, 15, 18, "div", 70)(13, CalendarComponent_div_61_div_13_Template, 3, 1, "div", 71);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function CalendarComponent_div_62_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, CalendarComponent_div_62_div_11_p_5_Template, 2, 1, "p", 75);
    \u0275\u0275elementStart(6, "div", 76)(7, "span", 77);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "date");
    \u0275\u0275pipe(10, "date");
...
function CalendarComponent_div_62_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(7, "line", 66)(8, "line", 67);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "div", 68)(10, "div", 69);
    \u0275\u0275template(11, CalendarComponent_div_62_div_11_Template, 15, 18, "div", 70)(12, CalendarComponent_div_62_div_12_Template, 3, 1, "div", 71);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function CalendarComponent_div_64_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "circle", 10)(4, "line", 89)(5, "line", 90);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7);
...
function CalendarComponent_div_68_div_12_p_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const reminder_r16 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(reminder_r16.description);
  }
}
function CalendarComponent_div_68_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "div", 97);
    \u0275\u0275elementStart(2, "div", 98)(3, "h4", 99);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, CalendarComponent_div_68_div_12_p_5_Template, 2, 1, "p", 100);
    \u0275\u0275elementStart(6, "div", 101)(7, "div", 102)(8, "span", 103);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275styleProp("background-color", ctx_r2.getReminderColor(reminder_r16, 0));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(reminder_r16.title);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", reminder_r16.description);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r2.translate("reminders.event_time"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatDateTime(reminder_r16.eventTime));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r2.translate("reminders.reminder_time"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatDateTime(reminder_r16.reminderTime));
  }
}
...
function CalendarComponent_div_68_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(10, "div", 68)(11, "div", 93);
    \u0275\u0275template(12, CalendarComponent_div_68_div_12_Template, 17, 8, "div", 94)(13, CalendarComponent_div_68_div_13_Template, 9, 2, "div", 95);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
var CalendarComponent = class _CalendarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CalendarComponent, selectors: [["app-calendar"]], viewQuery: function CalendarComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275template(60, CalendarComponent_div_60_Template, 6, 9, "div", 39);
      \u0275\u0275elementEnd()()()();
...
//# sourceMappingURL=chunk-5P7NS4QW.js.map

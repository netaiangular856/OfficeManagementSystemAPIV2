...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-C3ABB4EV.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-P3AGTQF2.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-EPBGEIBO.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-233KR3MC.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-5GTNRFLA.js.map

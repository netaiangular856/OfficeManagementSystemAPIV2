...
var DocumentsService = class _DocumentsService {
  ...
  createDocument(document2) {
    ...
    if (document2.CreatedAt) {
      formData.append("CreatedAt", document2.CreatedAt);
    }
...
function AddDocument_div_0_div_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AddDocument_div_0_div_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AddDocument_div_0_div_57_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function AddDocument_div_0_span_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 50);
  }
}
function AddDocument_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "div", 21)(42, "label", 29);
    \u0275\u0275text(43);
    ...
    \u0275\u0275text(48);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(49, "div", 16)(50, "label", 33);
    \u0275\u0275text(51);
    \u0275\u0275elementStart(52, "span", 18);
    \u0275\u0275text(53, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(54, "input", 34, 1);
    \u0275\u0275listener("change", function AddDocument_div_0_Template_input_change_54_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFileSelected($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(56, AddDocument_div_0_div_56_Template, 2, 1, "div", 20)(57, AddDocument_div_0_div_57_Template, 10, 2, "div", 35);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(58, "div", 36)(59, "button", 37);
    \u0275\u0275template(60, AddDocument_div_0_span_60_Template, 1, 0, "span", 38);
    \u0275\u0275text(61);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "button", 39);
    \u0275\u0275listener("click", function AddDocument_div_0_Template_button_click_62_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.close());
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.translate("documents.date"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", ctx_r1.translate("common.optional"), ")");
    \u0275\u0275advance();
    \u0275\u0275property("placeholder", ctx_r1.translate("documents.date_placeholder"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.translate("documents.date_help_text"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.translate("documents.file"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("is-invalid", ((tmp_27_0 = ctx_r1.documentForm.get("file")) == null ? null : tmp_27_0.invalid) && ((tmp_27_0 = ctx_r1.documentForm.get("file")) == null ? null : tmp_27_0.touched));
    \u0275\u0275advance(2);
...
var AddDocument = class _AddDocument {
  ...
  onSubmit() {
    if (this.documentForm.valid && this.selectedFile) {
      ...
      const formData = {
        ...
        CreatedAt: this.documentForm.value.CreatedAt || void 0
      };
  ...
  constructor(fb, documentsService, translationService) {
    ...
    this.documentForm = this.fb.group({
      ...
      CreatedAt: [""]
      // Optional CreatedAt field - no validators needed
    });
  ...
  }, outputs: { documentAdded: "documentAdded" }, standalone: false, decls: 3, vars: 1, consts: [["confirmationModal", ""], ["fileInput", ""], ["class", "modal-overlay", 3, "click", 4, "ngIf"], [1, "modal-overlay", 3, "click"], [1, "modal-container", 3, "click"], [1, "modal-header", 3, "dir"], [1, "modal-title"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "me-2"], ["d", "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"], ["points", "14,2 14,8 20,8"], ["x1", "16", "y1", "13", "x2", "8", "y2", "13"], ["x1", "16", "y1", "17", "x2", "8", "y2", "17"], ["points", "10,9 9,9 8,9"], [3, "ngSubmit", "formGroup"], [1, "modal-body"], [1, "row", "g-2"], [1, "col-12"], ["for", "title", 1, "form-label"], [1, "text-danger"], ["type", "text", "id", "title", "formControlName", "title", 1, "form-control", 3, "placeholder"], ["class", "invalid-feedback", 4, "ngIf"], [1, "col-md-6"], ["for", "type", 1, "form-label"], ["id", "type", "formControlName", "type", 1, "form-select"], [3, "value", 4, "ngFor", "ngForOf"], ["for", "documentSource", 1, "form-label"], ["id", "documentSource", "formControlName", "documentSource", 1, "form-select"], ["for", "description", 1, "form-label"], ["id", "description", "formControlName", "description", "rows", "2", 1, "form-control", 3, "placeholder"], ["for", "CreatedAt", 1, "form-label"], [1, "text-muted"], ["type", "date", "id", "CreatedAt", "formControlName", "CreatedAt", 1, "form-control", 3, "placeholder"], [1, "form-text", "text-muted"], ["for", "file", 1, "form-label"], ["type", "file", "id", "file", "accept", ".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.jpg,.jpeg,.png,.gif", 1, "form-control", 3, "change"], ["class", "mt-1", 4, "ngIf"], [1, "modal-footer"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm me-2", "role", "status", "aria-hidden", "true", 4, "ngIf"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], [1, "invalid-feedback"], [3, "value"], [1, "mt-1"], [1, "alert", "alert-info", "d-flex", "justify-content-between", "align-items-center", "mb-0"], [1, "d-flex", "align-items-center"], [1, "fas", "fa-file", "me-2", 2, "font-size", "0.7rem"], [2, "font-size", "0.7rem"], [1, "text-muted", "ms-2", 2, "font-size", "0.65rem"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-danger", 3, "click"], [1, "fas", "fa-times", 2, "font-size", "0.65rem"], ["role", "status", "aria-hidden", "true", 1, "spinner-border", "spinner-border-sm", "me-2"]], template: function AddDocument_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275template(0, AddDocument_div_0_Template, 64, 37, "div", 2);
      \u0275\u0275element(1, "app-confirmation-modal", null, 0);
    }
    if (rf & 2) {
      \u0275\u0275property("ngIf", ctx.isVisible);
    }
  }, dependencies: [NgForOf, NgIf, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, ConfirmationModalComponent], styles: ["\n\n.modal-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  -webkit-backdrop-filter: blur(1.8px);\n  backdrop-filter: blur(1.8px);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 99999;\n  padding: 0.45rem;\n}\n.modal-container[_ngcontent-%COMP%] {\n  background: white;\n  border-radius: 5.4px;\n  max-width: 370px;\n  width: 100%;\n  position: relative;\n  box-shadow: 0 9px 11.2px -2.2px rgba(0, 0, 0, 0.1), 0 4.5px 4.5px -2.2px rgba(0, 0, 0, 0.04);\n  animation: _ngcontent-%COMP%_modalSlideIn 0.3s ease-out;\n  max-height: 90vh;\n  overflow-y: auto;\n}\n@keyframes _ngcontent-%COMP%_modalSlideIn {\n  from {\n    opacity: 0;\n    transform: scale(0.95) translateY(-10px);\n  }\n  to {\n    opacity: 1;\n    transform: scale(1) translateY(0);\n  }\n}\n.modal-header[_ngcontent-%COMP%] {\n  background: #D4AF5F;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0.67rem 0.67rem 0.67rem 0.67rem;\n  border-bottom: 0.45px solid #e5e7eb;\n  margin-bottom: 0.67rem;\n}\n.modal-title[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n  font-weight: 700;\n  color: #111827;\n  margin: 0;\n  display: flex;\n  align-items: center;\n}\n.modal-header[dir=rtl][_ngcontent-%COMP%] {\n  justify-content: flex-end;\n}\n.modal-header[dir=ltr][_ngcontent-%COMP%] {\n  justify-content: flex-start;\n}\n.modal-title[class*=text-end][_ngcontent-%COMP%] {\n  text-align: right !important;\n  margin-left: 0 !important;\n  margin-right: 0 !important;\n  order: 1;\n}\n.modal-title[class*=text-start][_ngcontent-%COMP%] {\n  text-align: left !important;\n  margin-left: 0 !important;\n  margin-right: 0 !important;\n  order: 1;\n}\n.modal-header[dir=rtl][_ngcontent-%COMP%]   .modal-title[_ngcontent-%COMP%] {\n  margin-right: 0 !important;\n  margin-left: 0 !important;\n  text-align: right !important;\n}\n.modal-header[dir=ltr][_ngcontent-%COMP%]   .modal-title[_ngcontent-%COMP%] {\n  margin-left: 0 !important;\n  margin-right: 0 !important;\n  text-align: left !important;\n}\n.btn-close[_ngcontent-%COMP%] {\n  background: none;\n  border: none;\n  color: #6b7280;\n  cursor: pointer;\n  padding: 0.23rem;\n  border-radius: 2.7px;\n  transition: all 0.2s;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.btn-close[_ngcontent-%COMP%]:hover {\n  background: #f3f4f6;\n  color: #374151;\n}\n.modal-body[_ngcontent-%COMP%] {\n  padding: 0 0.67rem;\n}\n.btn-primary[_ngcontent-%COMP%] {\n  background-color: #D4AF5F;\n  color: #FFFFFF;\n  font-size: 0.7rem;\n  padding: 0.35rem 0.6rem;\n  border-radius: 3.6px;\n}\n.btn-primary[_ngcontent-%COMP%]:hover {\n  background-color: #C7994B;\n  border-color: #C7994B;\n  color: #FFFFFF;\n}\n.btn-secondary[_ngcontent-%COMP%] {\n  font-size: 0.7rem;\n  padding: 0.35rem 0.6rem;\n  border-radius: 3.6px;\n}\n.modal-footer[_ngcontent-%COMP%] {\n  padding: 0.67rem;\n  border-top: 0.45px solid #e5e7eb;\n  display: flex;\n  gap: 0.45rem;\n  justify-content: flex-end;\n}\n.form-label[_ngcontent-%COMP%] {\n  font-weight: 500;\n  color: #495057;\n  font-size: 0.7rem;\n  margin-bottom: 0.25rem;\n}\n.text-danger[_ngcontent-%COMP%] {\n  color: #dc3545 !important;\n  font-size: 0.7rem;\n}\n.invalid-feedback[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.65rem;\n}\n.form-control[_ngcontent-%COMP%], \n.form-select[_ngcontent-%COMP%] {\n  font-size: 0.7rem;\n  padding: 0.3rem 0.5rem;\n  border-radius: 3.6px;\n  border-width: 0.9px;\n}\n.form-control.is-invalid[_ngcontent-%COMP%], \n.form-select.is-invalid[_ngcontent-%COMP%] {\n  border-color: #dc3545;\n}\ntextarea.form-control[_ngcontent-%COMP%] {\n  font-size: 0.7rem;\n  padding: 0.3rem 0.5rem;\n}\n.alert-info[_ngcontent-%COMP%] {\n  background-color: #d1ecf1;\n  border-color: #bee5eb;\n  color: #0c5460;\n  font-size: 0.7rem;\n  padding: 0.5rem;\n  border-radius: 3.6px;\n}\n.btn-outline-danger[_ngcontent-%COMP%] {\n  color: #dc3545;\n  border-color: #dc3545;\n  font-size: 0.65rem;\n  padding: 0.25rem 0.4rem;\n}\n.btn-outline-danger[_ngcontent-%COMP%]:hover {\n  color: #fff;\n  background-color: #dc3545;\n  border-color: #dc3545;\n}\n.spinner-border-sm[_ngcontent-%COMP%] {\n  width: 0.45rem;\n  height: 0.45rem;\n}\n.form-control[type=file][_ngcontent-%COMP%] {\n  padding: 0.17rem 0.34rem;\n  font-size: 0.7rem;\n}\n.form-text[_ngcontent-%COMP%] {\n  font-size: 0.65rem;\n}\n.row.g-3[_ngcontent-%COMP%] {\n  --bs-gutter-x: 0.67rem;\n  --bs-gutter-y: 0.67rem;\n}\n@media (max-width: 768px) {\n  .modal-dialog[_ngcontent-%COMP%] {\n    margin: 0.23rem;\n    max-width: calc(100% - 0.45rem);\n  }\n  .modal-body[_ngcontent-%COMP%] {\n    padding: 0.45rem;\n  }\n  .modal-footer[_ngcontent-%COMP%] {\n    padding: 0.34rem 0.45rem;\n  }\n}\n[dir=rtl][_ngcontent-%COMP%]   .me-2[_ngcontent-%COMP%] {\n  margin-left: 0.23rem !important;\n  margin-right: 0 !important;\n}\n[dir=rtl][_ngcontent-%COMP%]   .ms-2[_ngcontent-%COMP%] {\n  margin-right: 0.23rem !important;\n  margin-left: 0 !important;\n}\n/*# sourceMappingURL=add-document-G7N3HN5U.css.map */"] });
};
(() => {
  ...
  <div class="modal-container" (click)="$event.stopPropagation()">\r
    <div class="modal-header" [dir]="isRTL() ? 'rtl' : 'ltr'">\r
      <h5 class="modal-title" [class.text-end]="isRTL()" [class.text-start]="!isRTL()">\r
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="me-2">\r
...
\r
            <!-- CreatedAt (Optional) -->\r
            <div class="col-md-6">\r
              <label for="CreatedAt" class="form-label">\r
                {{ translate('documents.date') }} <small class="text-muted">({{ translate('common.optional') }})</small>\r
              </label>\r
              <input \r
                type="date" \r
                class="form-control" \r
                id="CreatedAt"\r
                formControlName="CreatedAt"\r
                [placeholder]="translate('documents.date_placeholder')">\r
              <small class="form-text text-muted">\r
                {{ translate('documents.date_help_text') }}\r
              </small>\r
            </div>\r
\r
            <!-- File Upload -->\r
            <div class="col-12">\r
              ...
              <div class="mt-1" *ngIf="selectedFile">\r
                <div class="alert alert-info d-flex justify-content-between align-items-center mb-0">\r
                  <div class="d-flex align-items-center">\r
                    <i class="fas fa-file me-2" style="font-size: 0.7rem;"></i>\r
                    <span style="font-size: 0.7rem;">{{ selectedFile.name }}</span>\r
                    <small class="text-muted ms-2" style="font-size: 0.65rem;">({{ formatFileSize(selectedFile.size) }})</small>\r
                  </div>\r
                  <button type="button" class="btn btn-sm btn-outline-danger" (click)="removeFile()">\r
                    <i class="fas fa-times" style="font-size: 0.65rem;"></i>\r
                  </button>\r
                </div>\r
              </div>\r
            </div>\r
...
var EditDocument = class _EditDocument {
  ...
  }, outputs: { documentUpdated: "documentUpdated" }, standalone: false, decls: 3, vars: 1, consts: [["confirmationModal", ""], ["class", "modal-overlay", 3, "click", 4, "ngIf"], [1, "modal-overlay", 3, "click"], [1, "modal-container", 3, "click"], [1, "modal-header", 3, "dir"], [1, "modal-title"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "me-2"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], [3, "ngSubmit", "formGroup"], [1, "modal-body"], [1, "row", "g-2"], [1, "col-12"], ["for", "editTitle", 1, "form-label"], [1, "text-danger"], ["type", "text", "id", "editTitle", "formControlName", "title", 1, "form-control", 3, "placeholder"], ["class", "invalid-feedback", 4, "ngIf"], [1, "col-md-6"], ["for", "editType", 1, "form-label"], ["id", "editType", "formControlName", "type", 1, "form-select"], [3, "value", 4, "ngFor", "ngForOf"], ["for", "editDocumentSource", 1, "form-label"], ["id", "editDocumentSource", "formControlName", "documentSource", 1, "form-select"], ["for", "editDescription", 1, "form-label"], ["id", "editDescription", "formControlName", "description", "rows", "2", 1, "form-control", 3, "placeholder"], ["class", "col-12", 4, "ngIf"], [1, "modal-footer"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm me-2", "role", "status", "aria-hidden", "true", 4, "ngIf"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], [1, "invalid-feedback"], [3, "value"], [1, "form-label"], [1, "alert", "alert-info", "d-flex", "justify-content-between", "align-items-center", "mb-0"], [1, "d-flex", "align-items-center"], [1, "fas", "fa-file", "me-2", 2, "font-size", "0.7rem"], [2, "font-size", "0.7rem"], [1, "text-muted", "ms-2", 2, "font-size", "0.65rem"], [1, "text-muted", 2, "font-size", "0.65rem"], ["role", "status", "aria-hidden", "true", 1, "spinner-border", "spinner-border-sm", "me-2"]], template: function EditDocument_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [NgForOf, NgIf, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, ConfirmationModalComponent], styles: ["\n\n.modal-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  -webkit-backdrop-filter: blur(1.8px);\n  backdrop-filter: blur(1.8px);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 99999;\n  padding: 0.45rem;\n}\n.modal-container[_ngcontent-%COMP%] {\n  background: white;\n  border-radius: 5.4px;\n  max-width: 350px;\n  width: 100%;\n  position: relative;\n  box-shadow: 0 9px 11.2px -2.2px rgba(0, 0, 0, 0.1), 0 4.5px 4.5px -2.2px rgba(0, 0, 0, 0.04);\n  animation: _ngcontent-%COMP%_modalSlideIn 0.3s ease-out;\n  max-height: 90vh;\n  overflow-y: auto;\n}\n@keyframes _ngcontent-%COMP%_modalSlideIn {\n  from {\n    opacity: 0;\n    transform: scale(0.95) translateY(-10px);\n  }\n  to {\n    opacity: 1;\n    transform: scale(1) translateY(0);\n  }\n}\n.modal-header[_ngcontent-%COMP%] {\n  background: #D4AF5F;\n  display: flex;\n  align-items: center;\n  padding: 0.67rem;\n  border-bottom: 0.45px solid #e5e7eb;\n  margin-bottom: 0.67rem;\n  flex-direction: row;\n}\n.modal-title[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n  font-weight: 700;\n  color: #111827;\n  margin: 0;\n  display: flex;\n  align-items: center;\n}\n.modal-header[dir=rtl][_ngcontent-%COMP%] {\n  justify-content: flex-end;\n}\n.modal-header[dir=ltr][_ngcontent-%COMP%] {\n  justify-content: flex-start;\n}\n.modal-title[class*=text-end][_ngcontent-%COMP%] {\n  text-align: right !important;\n  margin-left: 0 !important;\n  margin-right: 0 !important;\n  order: 1;\n}\n.modal-title[class*=text-start][_ngcontent-%COMP%] {\n  text-align: left !important;\n  margin-left: 0 !important;\n  margin-right: 0 !important;\n  order: 1;\n}\n.modal-header[dir=rtl][_ngcontent-%COMP%]   .modal-title[_ngcontent-%COMP%] {\n  margin-right: 0 !important;\n  margin-left: 0 !important;\n  text-align: right !important;\n}\n.modal-header[dir=ltr][_ngcontent-%COMP%]   .modal-title[_ngcontent-%COMP%] {\n  margin-left: 0 !important;\n  margin-right: 0 !important;\n  text-align: left !important;\n}\n.btn-close[_ngcontent-%COMP%] {\n  background: none;\n  border: none;\n  color: #6b7280;\n  cursor: pointer;\n  padding: 0.23rem;\n  border-radius: 2.7px;\n  transition: all 0.2s;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.btn-close[_ngcontent-%COMP%]:hover {\n  background: #f3f4f6;\n  color: #374151;\n}\n.modal-body[_ngcontent-%COMP%] {\n  padding: 0 0.67rem;\n}\n.btn-primary[_ngcontent-%COMP%] {\n  background-color: #D4AF5F;\n  color: #FFFFFF;\n  font-size: 0.7rem;\n  padding: 0.35rem 0.6rem;\n  border-radius: 3.6px;\n}\n.btn-primary[_ngcontent-%COMP%]:hover {\n  background-color: #C7994B;\n  border-color: #C7994B;\n  color: #FFFFFF;\n}\n.btn-secondary[_ngcontent-%COMP%] {\n  font-size: 0.7rem;\n  padding: 0.35rem 0.6rem;\n  border-radius: 3.6px;\n}\n.modal-footer[_ngcontent-%COMP%] {\n  padding: 0.67rem;\n  border-top: 0.45px solid #e5e7eb;\n  display: flex;\n  gap: 0.45rem;\n  justify-content: flex-end;\n}\n.form-label[_ngcontent-%COMP%] {\n  font-weight: 500;\n  color: #495057;\n  font-size: 0.7rem;\n  margin-bottom: 0.25rem;\n}\n.text-danger[_ngcontent-%COMP%] {\n  color: #dc3545 !important;\n  font-size: 0.7rem;\n}\n.invalid-feedback[_ngcontent-%COMP%] {\n  display: block;\n  font-size: 0.65rem;\n}\n.form-control[_ngcontent-%COMP%], \n.form-select[_ngcontent-%COMP%] {\n  font-size: 0.7rem;\n  padding: 0.3rem 0.5rem;\n  border-radius: 3.6px;\n  border-width: 0.9px;\n}\n.form-control.is-invalid[_ngcontent-%COMP%], \n.form-select.is-invalid[_ngcontent-%COMP%] {\n  border-color: #dc3545;\n}\ntextarea.form-control[_ngcontent-%COMP%] {\n  font-size: 0.7rem;\n  padding: 0.3rem 0.5rem;\n}\n.alert-info[_ngcontent-%COMP%] {\n  background-color: #d1ecf1;\n  border-color: #bee5eb;\n  color: #0c5460;\n  font-size: 0.7rem;\n  padding: 0.5rem;\n  border-radius: 3.6px;\n}\n.spinner-border-sm[_ngcontent-%COMP%] {\n  width: 0.45rem;\n  height: 0.45rem;\n}\n.form-text[_ngcontent-%COMP%] {\n  font-size: 0.65rem;\n}\n.row.g-3[_ngcontent-%COMP%] {\n  --bs-gutter-x: 0.67rem;\n  --bs-gutter-y: 0.67rem;\n}\n@media (max-width: 768px) {\n  .modal-dialog[_ngcontent-%COMP%] {\n    margin: 0.23rem;\n    max-width: calc(100% - 0.45rem);\n  }\n  .modal-body[_ngcontent-%COMP%] {\n    padding: 0.45rem;\n  }\n  .modal-footer[_ngcontent-%COMP%] {\n    padding: 0.34rem 0.45rem;\n  }\n}\n[dir=rtl][_ngcontent-%COMP%]   .me-2[_ngcontent-%COMP%] {\n  margin-left: 0.23rem !important;\n  margin-right: 0 !important;\n}\n[dir=rtl][_ngcontent-%COMP%]   .ms-2[_ngcontent-%COMP%] {\n  margin-right: 0.23rem !important;\n  margin-left: 0 !important;\n}\n/*# sourceMappingURL=edit-document-QS4GZ3KQ.css.map */"] });
};
(() => {
...
\r
            ...
            <div class="col-12" *ngIf="currentDocument">\r
              ...
              <div class="alert alert-info d-flex justify-content-between align-items-center mb-0">\r
                <div class="d-flex align-items-center">\r
                  <i class="fas fa-file me-2" style="font-size: 0.7rem;"></i>\r
                  <span style="font-size: 0.7rem;">{{ currentDocument.fileName }}{{ currentDocument.fileExtension }}</span>\r
                  <small class="text-muted ms-2" style="font-size: 0.65rem;">({{ formatFileSize(currentDocument.fileSize) }})</small>\r
                </div>\r
                <small class="text-muted" style="font-size: 0.65rem;">{{ translate('documents.file_cannot_be_changed') }}</small>\r
              </div>\r
            </div>\r
          </div>\r
        </div>\r
...
function DocumentsList_small_20_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.translate("documents.to_date_before_from_date_error"), " ");
  }
}
function DocumentsList_div_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35)(1, "div", 36)(2, "div", 37)(3, "div", 38)(4, "span", 39);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
...
function DocumentsList_div_68_div_23_tr_23_div_5_Template(rf, ctx) {
  if (rf & 1) {
...
function DocumentsList_div_68_div_23_tr_23_div_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const document_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", document_r5 == null ? null : document_r5.referenceNumber, " ");
  }
}
function DocumentsList_div_68_div_23_tr_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div")(3, "strong");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, DocumentsList_div_68_div_23_tr_23_div_5_Template, 2, 1, "div", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td")(7, "div");
    \u0275\u0275template(8, DocumentsList_div_68_div_23_tr_23_div_8_Template, 2, 1, "div", 54);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "td")(10, "span", 55);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "td")(13, "span", 55);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "td")(16, "div", 56);
    \u0275\u0275element(17, "i", 57);
    ...
    \u0275\u0275text(25);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "td")(27, "div", 58)(28, "button", 59);
    \u0275\u0275listener("click", function DocumentsList_div_68_div_23_tr_23_Template_button_click_28_listener() {
      const document_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.downloadDocument(document_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(29, "svg", 60);
    \u0275\u0275element(30, "path", 61)(31, "polyline", 62)(32, "line", 63);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(33, "button", 64);
    \u0275\u0275listener("click", function DocumentsList_div_68_div_23_tr_23_Template_button_click_33_listener() {
      const document_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.editDocument(document_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(34, "svg", 65);
    \u0275\u0275element(35, "path", 66)(36, "path", 67);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(37, "button", 68);
    \u0275\u0275listener("click", function DocumentsList_div_68_div_23_tr_23_Template_button_click_37_listener() {
      const document_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.deleteDocument(document_r5.id, document_r5.title));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(38, "svg", 69);
    \u0275\u0275element(39, "polyline", 70)(40, "path", 71)(41, "path", 72)(42, "path", 73)(43, "path", 74);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", document_r5.referenceNumber);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r1.formatDate(document_r5.createdAt), " ");
    \u0275\u0275advance(3);
...
function DocumentsList_div_68_div_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(23, DocumentsList_div_68_div_23_tr_23_Template, 44, 15, "tr", 52);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.translate("documents.document"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.translate("documents.reference_number"));
    \u0275\u0275advance(2);
...
function DocumentsList_div_68_div_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 37)(1, "div", 77);
    \u0275\u0275element(2, "i", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h5", 79);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function DocumentsList_div_68_div_24_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function DocumentsList_div_68_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 35)(1, "div", 36)(2, "div", 41)(3, "div", 42)(4, "div", 43)(5, "div")(6, "span", 44);
    \u0275\u0275text(7);
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "select", 47);
    \u0275\u0275twoWayListener("ngModelChange", function DocumentsList_div_68_Template_select_ngModelChange_14_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.pageSize, $event) || (ctx_r1.pageSize = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function DocumentsList_div_68_Template_select_change_14_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(18, "10");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "option", 20);
    \u0275\u0275text(20, "25");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "option", 20);
    \u0275\u0275text(22, "50");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(23, DocumentsList_div_68_div_23_Template, 24, 10, "div", 48)(24, DocumentsList_div_68_div_24_Template, 9, 3, "div", 49);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function DocumentsList_div_69_li_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 86)(1, "button", 99);
    \u0275\u0275listener("click", function DocumentsList_div_69_li_28_Template_button_click_1_listener() {
...
function DocumentsList_div_69_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 35)(1, "div", 36)(2, "div", 81)(3, "div", 82)(4, "span", 83);
    \u0275\u0275text(5);
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "nav", 84)(16, "ul", 85)(17, "li", 86)(18, "button", 87);
    \u0275\u0275listener("click", function DocumentsList_div_69_Template_button_click_18_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(20, "polyline", 88)(21, "polyline", 89);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(22, "li", 86)(23, "button", 90);
    \u0275\u0275listener("click", function DocumentsList_div_69_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(25, "polyline", 91);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(26, "span", 92);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(28, DocumentsList_div_69_li_28_Template, 3, 4, "li", 93);
    \u0275\u0275elementStart(29, "li", 86)(30, "button", 94);
    \u0275\u0275listener("click", function DocumentsList_div_69_Template_button_click_30_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage + 1));
    });
    \u0275\u0275elementStart(31, "span", 92);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(33, "svg", 9);
    \u0275\u0275element(34, "polyline", 95);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(35, "li", 86)(36, "button", 96);
    \u0275\u0275listener("click", function DocumentsList_div_69_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(38, "polyline", 97)(39, "polyline", 98);
    \u0275\u0275elementEnd()()()()()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var DocumentsList = class _DocumentsList {
  ...
  isValidSearchTerm(searchTerm) {
    ...
    if (trimmed.length === 1 && !/^[a-zA-Zابتثجحخدذرزسشصضطظعغفقكلمنهويأءآإئؤ0-9]$/.test(trimmed)) {
      return false;
    }
    return true;
  }
  ...
  onSearchInput(event) {
    ...
    if (!this.isValidSearchTerm(value)) {
      ...
      if (cleanedValue.length === 1 && !/^[a-zA-Zابتثجحخدذرزسشصضطظعغفقكلمنهويأءآإئؤ0-9]$/.test(cleanedValue)) {
        cleanedValue = "";
      }
      setTimeout(() => {
  ...
  downloadDocument(documentItem) {
    this.documentsService.downloadDocument(documentItem.id).subscribe({
      ...
      error: (error) => {
        ...
        const errorText = (error.error?.message || error.error?.error || "").toLowerCase();
        if (statusCode === 400 || statusCode === 404 || errorMessage.includes("400") || errorMessage.includes("404") || errorMessage.includes("not found") || errorMessage.includes("notfound") || errorText.includes("not found") || errorText.includes("notfound") || errorText.includes("file not found") || errorText.includes("document not found")) {
          userFriendlyMessage = this.translationService.translate("documents.file_not_found");
        } else if (statusCode === 500 || errorMessage.includes("500")) {
          userFriendlyMessage = this.translationService.translate("documents.download_server_error");
        } else if (statusCode === 403 || errorMessage.includes("403") || errorMessage.includes("forbidden")) {
          userFriendlyMessage = this.translationService.translate("documents.download_permission_denied");
        } else {
          userFriendlyMessage = this.translationService.translate("documents.download_error");
        }
        this.showErrorMessage(userFriendlyMessage);
      }
    });
  }
  showSuccessMessage(message) {
  ...
  }, standalone: false, decls: 76, vars: 49, consts: [["addDocumentModal", ""], ["editDocumentModal", ""], ["confirmationModal", ""], [1, "documents-container", "rounded-5", 3, "dir"], [1, "documents-header", "mb-3"], [1, "header-results", "d-flex", "justify-content-between", "align-items-center"], [1, "documents-title"], [1, "d-flex", "gap-1"], [1, "btn", "btn-primary", 3, "click"], ["width", "11", "height", "11", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "search-section", "mb-3"], [1, "row", "g-2", "mb-2"], [1, "col-md-2"], [1, "form-label"], ["type", "date", 1, "form-control", 3, "ngModelChange", "change", "ngModel"], ["type", "date", 1, "form-control", 3, "ngModelChange", "change", "ngModel", "min"], ["class", "error-message text-danger", 4, "ngIf"], [1, "form-select", 3, "ngModelChange", "change", "ngModel"], [3, "value"], [1, "col-md-2", "h-100"], [1, "form-select", "h-100", 3, "ngModelChange", "change", "ngModel"], [1, "row", "g-2"], [1, "search-input-wrapper", "col-md-6"], ["type", "text", 1, "form-control", "search-input", 3, "ngModelChange", "input", "keyup.enter", "placeholder", "ngModel"], [1, "col-md-3", "d-flex", "align-items-end"], ["type", "button", 1, "btn", "btn-primary", "search-button", 2, "font-size", "0.7rem", 3, "click", "disabled"], [1, "bi", "bi-search", "me-1", 2, "font-size", "0.7rem"], [1, "btn", "btn-outline-secondary", 2, "font-size", "0.7rem", 3, "click"], ["class", "row", 4, "ngIf"], ["class", "row ", 4, "ngIf"], [3, "documentAdded"], [3, "documentUpdated"], [1, "error-message", "text-danger"], [1, "row"], [1, "col-12"], [1, "text-center", "py-3"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "mt-2", "text-muted", 2, "font-size", "0.7rem"], [1, "card"], [1, "card-body"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-2"], [1, "text-muted", 2, "font-size", "0.7rem"], [1, "d-flex", "align-items-center", "gap-1"], [1, "form-label", "mb-0", 2, "font-size", "0.7rem"], [1, "form-select", "form-select-sm", 2, "width", "auto", "font-size", "0.7rem", "padding", "0.2rem 0.4rem", 3, "ngModelChange", "change", "ngModel"], ["class", "table-responsive", 4, "ngIf"], ["class", "text-center py-3", 4, "ngIf"], [1, "table-responsive"], [1, "table", "table-hover"], [4, "ngFor", "ngForOf"], ["class", "text-muted small", 4, "ngIf"], ["class", "text-muted ", 4, "ngIf"], [1, "badge", 3, "ngClass"], [1, "d-flex", "align-items-center"], [1, "fas", "fa-file", "me-2"], ["role", "group", 1, "btn-group"], [1, "btn", "btn-sm", "btn-outline-primary", "rounded-3", 3, "click", "title"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-label", "Download", 1, "nav-icon"], ["d", "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"], ["points", "7 10 12 15 17 10"], ["x1", "12", "y1", "15", "x2", "12", "y2", "3"], [1, "btn", "btn-sm", "btn-outline-warning", "rounded-3", 3, "click", "title"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-label", "Edit", 1, "nav-icon"], ["d", "M12 20h9"], ["d", "M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"], [1, "btn", "btn-sm", "btn-outline-danger", "rounded-3", 3, "click", "title"], ["width", "13", "height", "13", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-label", "Delete", 1, "nav-icon"], ["points", "3 6 5 6 21 6"], ["d", "M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"], ["d", "M10 11v6"], ["d", "M14 11v6"], ["d", "M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"], [1, "text-muted", "small"], [1, "text-muted"], [1, "mb-2"], [1, "fas", "fa-file-alt", "fa-2x", "text-muted"], [1, "text-muted", 2, "font-size", "0.8rem"], [1, "btn", "btn-primary", 2, "font-size", "0.7rem", "padding", "0.3rem 0.6rem", 3, "click"], [1, "pagination-container", "ltr"], [1, "pagination-info"], [1, "pagination-text"], ["aria-label", "Documents pagination", 1, "pagination-nav"], [1, "pagination"], [1, "page-item"], [1, "page-link", "page-link-first", 3, "click", "disabled", "title"], ["points", "11 17 6 12 11 7"], ["points", "18 17 13 12 18 7"], [1, "page-link", "page-link-prev", 3, "click", "disabled", "title"], ["points", "15 18 9 12 15 6"], [1, "page-text"], ["class", "page-item", 3, "active", 4, "ngFor", "ngForOf"], [1, "page-link", "page-link-next", 3, "click", "disabled", "title"], ["points", "9 18 15 12 9 6"], [1, "page-link", "page-link-last", 3, "click", "disabled", "title"], ["points", "13 17 18 12 13 7"], ["points", "6 17 11 12 6 7"], [1, "page-link", "page-link-number", 3, "click", "title"]], template: function DocumentsList_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(10, "div", 12)(11, "div", 13)(12, "div", 14)(13, "label", 15);
      \u0275\u0275text(14);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "input", 16);
      \u0275\u0275twoWayListener("ngModelChange", function DocumentsList_Template_input_ngModelChange_15_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.fromDate, $event) || (ctx.fromDate = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("change", function DocumentsList_Template_input_change_15_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onFromDateChange($event));
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275twoWayListener("ngModelChange", function DocumentsList_Template_input_ngModelChange_19_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.toDate, $event) || (ctx.toDate = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("change", function DocumentsList_Template_input_change_19_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onToDateChange($event));
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(20, DocumentsList_small_20_Template, 2, 1, "small", 18);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "div", 14)(22, "label", 15);
      \u0275\u0275text(23);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "select", 19);
      \u0275\u0275twoWayListener("ngModelChange", function DocumentsList_Template_select_ngModelChange_24_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.selectedType, $event) || (ctx.selectedType = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("change", function DocumentsList_Template_select_change_24_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(44);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(45, "div", 21)(46, "label", 15);
      \u0275\u0275text(47);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(48, "select", 22);
      \u0275\u0275twoWayListener("ngModelChange", function DocumentsList_Template_select_ngModelChange_48_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.selectedDocumentSource, $event) || (ctx.selectedDocumentSource = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("change", function DocumentsList_Template_select_change_48_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onFilterChange());
      });
      \u0275\u0275elementStart(49, "option", 20);
      \u0275\u0275text(50);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(54);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(55, "div", 23)(56, "div", 24)(57, "label", 15);
      \u0275\u0275text(58);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(59, "input", 25);
      \u0275\u0275listener("ngModelChange", function DocumentsList_Template_input_ngModelChange_59_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.searchTerm = $event);
      })("input", function DocumentsList_Template_input_input_59_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSearchInput($event));
      })("keyup.enter", function DocumentsList_Template_input_keyup_enter_59_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSearchChange());
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(60, "div", 26)(61, "button", 27);
      \u0275\u0275listener("click", function DocumentsList_Template_button_click_61_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSearchChange());
      });
      \u0275\u0275element(62, "i", 28);
      \u0275\u0275text(63);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(64, "div", 26)(65, "button", 29);
      \u0275\u0275listener("click", function DocumentsList_Template_button_click_65_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.clearFilters());
      });
      \u0275\u0275text(66);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(67, DocumentsList_div_67_Template, 8, 2, "div", 30)(68, DocumentsList_div_68_Template, 25, 11, "div", 30)(69, DocumentsList_div_69_Template, 40, 26, "div", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(70, "app-add-document", 32, 0);
      \u0275\u0275listener("documentAdded", function DocumentsList_Template_app_add_document_documentAdded_70_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.loadDocuments());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(72, "app-edit-document", 33, 1);
      \u0275\u0275listener("documentUpdated", function DocumentsList_Template_app_edit_document_documentUpdated_72_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.loadDocuments());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275element(74, "app-confirmation-modal", null, 2);
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("placeholder", ctx.translate("documents.search_documents"))("ngModel", ctx.searchTerm);
      \u0275\u0275advance(2);
...
(() => {
  ...
  <!-- Header Section -->\r
  <div class="documents-header mb-3">\r
    <div class="header-results d-flex justify-content-between align-items-center">\r
...
\r
          <!-- <span class="px-1">{{ translate('documents.add_document') }}</span> -->\r
...
\r
            <div class="col-md-2">\r
              ...
              <small *ngIf="fromDate && toDate && toDate < fromDate" class="error-message text-danger">\r
                {{ translate("documents.to_date_before_from_date_error") }}\r
              </small>\r
            </div>\r
\r
            <!-- Type Filter -->\r
...
\r
            ...
            <div class="col-md-3 d-flex align-items-end">\r
              <button\r
                ...
                style="font-size: 0.7rem;">\r
                <i class="bi bi-search me-1" style="font-size: 0.7rem;"></i>\r
...
\r
             <!-- Clear Filters -->\r
             <div class="col-md-3 d-flex align-items-end">\r
              <button class="btn btn-outline-secondary" (click)="clearFilters()" style="font-size: 0.7rem;">\r
  ...
  <div class="row" *ngIf="isLoading">\r
    <div class="col-12">\r
      <div class="text-center py-3">\r
        ...
        <p class="mt-2 text-muted" style="font-size: 0.7rem;">{{ translate('documents.loading_documents') }}</p>\r
      </div>\r
    </div>\r
  </div>\r
\r
        ...
        <div class="card-body">\r
          ...
          <div class=" d-flex justify-content-between align-items-center mb-2 ">\r
            ...
            <div class="d-flex align-items-center gap-1">\r
              <label class="form-label mb-0" style="font-size: 0.7rem;">{{ translate('documents.items_per_page') }}:</label>\r
              <select\r
                class="form-select form-select-sm"\r
                style="width: auto; font-size: 0.7rem; padding: 0.2rem 0.4rem;"\r
                [(ngModel)]="pageSize"\r
...
\r
          ...
          <div class="table-responsive" *ngIf="filteredDocuments.length > 0">\r
            <table class="table table-hover">\r
              <thead>\r
                <tr>\r
                  <th>{{ translate('documents.document') }}</th>\r
                  <th>{{ translate('documents.reference_number') }}</th>\r
              ...
              <tbody>\r
                <tr *ngFor="let document of filteredDocuments">\r
                  ...
                  <td>\r
                    <div>\r
                      <div class="text-muted " *ngIf="document.referenceNumber">\r
                        {{ document?.referenceNumber }}\r
                      </div>\r
                    </div>\r
                  </td>\r
                  <td>\r
                  ...
                  <td>\r
                    <div class="btn-group" role="group">\r
                      <button\r
                        class="btn btn-sm btn-outline-primary rounded-3"\r
                        (click)="downloadDocument(document)"\r
                        [title]="translate('documents.download')">\r
                        <svg class="nav-icon" width="13" height="13" viewBox="0 0 24 24"\r
                      ...
                      <button\r
                        class="btn btn-sm btn-outline-warning rounded-3 "\r
                      ...
                      <button\r
                        class="btn btn-sm btn-outline-danger rounded-3"\r
...
\r
          <!-- No Results -->\r
          <div class="text-center py-3" *ngIf="filteredDocuments.length === 0 && !isLoading">\r
            <div class="mb-2">\r
              <i class="fas fa-file-alt fa-2x text-muted"></i>\r
            </div>\r
            <h5 class="text-muted" style="font-size: 0.8rem;">{{ translate('documents.no_documents_found') }}</h5>\r
            <p class="text-muted" style="font-size: 0.7rem;">{{ translate('documents.no_documents_message') }}</p>\r
            <button class="btn btn-primary" (click)="openAddModal()" style="font-size: 0.7rem; padding: 0.3rem 0.6rem;">\r
...
\r
  ...
  <div class="row " *ngIf="!isLoading && totalPages > 1">\r
    <div class="col-12">\r
      <div class="pagination-container ltr">\r
...
//# sourceMappingURL=chunk-4F7IEMWQ.js.map

...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-UZ3YQVVO.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-VQG65OWC.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-LK4B3QCL.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-SHX3WGNY.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-7CHFOCY2.js.map

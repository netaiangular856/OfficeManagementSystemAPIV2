...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-UE5IPKOI.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-UD5IPFLL.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-QMAAFCT4.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-45R3QELZ.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-5NE3XPAJ.js.map

...
function PermissionsAssignmentModalComponent_div_0_div_11_div_1_div_10_span_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.translate("roles.mandatory"), " ");
  }
}
function PermissionsAssignmentModalComponent_div_0_div_11_div_1_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("change", function PermissionsAssignmentModalComponent_div_0_div_11_div_1_div_10_Template_input_change_2_listener($event) {
      ...
      return \u0275\u0275resetView(ctx_r1.onPermissionToggle(permission_r6.id, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "span", 31);
    \u0275\u0275elementStart(4, "div", 32)(5, "div", 33);
    \u0275\u0275text(6);
    \u0275\u0275template(7, PermissionsAssignmentModalComponent_div_0_div_11_div_1_div_10_span_7_Template, 2, 1, "span", 34);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("assigned", ctx_r1.selectedPermissions().includes(permission_r6.id))("mandatory", ctx_r1.isMandatoryPermission(permission_r6))("disabled", ctx_r1.isMandatoryPermission(permission_r6));
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", ctx_r1.selectedPermissions().includes(permission_r6.id))("disabled", ctx_r1.isMandatoryPermission(permission_r6));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", permission_r6.displayName, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isMandatoryPermission(permission_r6));
    \u0275\u0275advance(2);
...
function PermissionsAssignmentModalComponent_div_0_div_11_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(10, PermissionsAssignmentModalComponent_div_0_div_11_div_1_div_10_Template, 15, 13, "div", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", group_r4.value)("ngForTrackBy", ctx_r1.trackByPermission);
  }
}
function PermissionsAssignmentModalComponent_div_0_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275template(1, PermissionsAssignmentModalComponent_div_0_div_11_div_1_Template, 11, 5, "div", 19);
    \u0275\u0275pipe(2, "keyvalue");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind1(2, 2, ctx_r1.getAllPermissionGroups()))("ngForTrackBy", ctx_r1.trackByGroup);
  }
}
...
function PermissionsAssignmentModalComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(10, PermissionsAssignmentModalComponent_div_0_div_10_Template, 4, 1, "div", 9)(11, PermissionsAssignmentModalComponent_div_0_div_11_Template, 3, 4, "div", 10);
    \u0275\u0275elementEnd();
...
var PermissionsAssignmentModalComponent = class _PermissionsAssignmentModalComponent {
    ...
    this.rolesService.getRolePermissions(roleId).subscribe({
      next: (response) => {
        if (response.success && response.data) {
          ...
          const mandatoryPermissionIds = this.getMandatoryPermissionIds();
          const allPermissions = [.../* @__PURE__ */ new Set([...mandatoryPermissionIds, ...permissionIds])];
          this.selectedPermissions.set(allPermissions);
        } else {
          const mandatoryPermissionIds = this.getMandatoryPermissionIds();
          this.selectedPermissions.set(mandatoryPermissionIds);
        }
      },
      error: (error) => {
  ...
  // Get mandatory permission IDs (Dashboard and My Calendar)
  getMandatoryPermissionIds() {
    const allPerms = this.allPermissions();
    return allPerms.filter((p) => this.isMandatoryPermission(p)).map((p) => p.id);
  }
  // Check if a permission is mandatory
  isMandatoryPermission(permission) {
    const isMyCalendar = permission.controller === "calendar" && permission.action === "index" || permission.displayName?.toLowerCase().includes("my calendar");
    const isCalendarEvents = permission.controller === "calendar" && permission.action === "events.get" || (permission.displayName?.toLowerCase().includes("get calendar events") || permission.displayName?.toLowerCase().includes("view calendar events for user"));
    return isMyCalendar || isCalendarEvents;
  }
  onPermissionToggle(permissionId, event) {
    const target = event.target;
    const isChecked = target.checked;
    const permission = this.allPermissions().find((p) => p.id === permissionId);
    if (permission && this.isMandatoryPermission(permission)) {
  ...
  onAssign() {
    ...
    const mandatoryPermissionIds = this.getMandatoryPermissionIds();
    const finalPermissions = [.../* @__PURE__ */ new Set([...mandatoryPermissionIds, ...this.selectedPermissions()])];
    this.assign.emit(finalPermissions);
  }
  onCancel() {
    this.saving.set(false);
    this.cancel.emit();
  ...
  deselectAllInGroup(permissions) {
    ...
    const mandatoryPermissionIds = this.getMandatoryPermissionIds();
    const updated = current.filter((id) => !groupIds.includes(id) || mandatoryPermissionIds.includes(id));
    this.selectedPermissions.set(updated);
  }
  translate(key) {
  ...
  // TrackBy functions to prevent unnecessary re-renders and maintain scroll position
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PermissionsAssignmentModalComponent, selectors: [["app-permissions-assignment-modal"]], inputs: { isVisible: "isVisible", roleId: "roleId" }, outputs: { assign: "assign", cancel: "cancel" }, features: [\u0275\u0275NgOnChangesFeature], decls: 1, vars: 1, consts: [["class", "permissions-modal-overlay", 3, "click", 4, "ngIf"], [1, "permissions-modal-overlay", 3, "click"], [1, "permissions-modal", 3, "click"], [1, "modal-header"], [1, "close-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "modal-content"], ["class", "loading-container", 4, "ngIf"], ["class", "permissions-container", 4, "ngIf"], [1, "modal-actions"], ["type", "button", 1, "btn", "btn-secondary", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"], ["class", "btn-loading", 4, "ngIf"], [4, "ngIf"], [1, "loading-container"], [1, "loading-spinner"], [1, "permissions-container"], ["class", "permission-group", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "permission-group"], [1, "group-header"], [1, "group-title"], [1, "group-actions"], ["type", "button", 1, "btn-select-all", 3, "click"], ["type", "button", 1, "btn-deselect-all", 3, "click"], [1, "permissions-grid"], ["class", "permission-item", 3, "assigned", "mandatory", "disabled", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "permission-item"], [1, "permission-checkbox"], ["type", "checkbox", 1, "permission-input", 3, "change", "checked", "disabled"], [1, "permission-custom"], [1, "permission-content"], [1, "permission-name"], ["class", "mandatory-badge", 4, "ngIf"], [1, "permission-description"], [1, "permission-meta"], [1, "permission-controller"], [1, "permission-action"], [1, "mandatory-badge"], [1, "btn-loading"], [1, "loading-spinner-small"]], template: function PermissionsAssignmentModalComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
      ...
      <div class="permissions-modal" (click)="$event.stopPropagation()">
        ...
        <div class="modal-content">
          ...
          <div *ngIf="allPermissions().length > 0" class="permissions-container">
            <div *ngFor="let group of getAllPermissionGroups() | keyvalue; trackBy: trackByGroup" class="permission-group">
              ...
              <div class="permissions-grid">
                <div *ngFor="let permission of group.value; trackBy: trackByPermission" 
                     class="permission-item" 
                     [class.assigned]="selectedPermissions().includes(permission.id)"
                     [class.mandatory]="isMandatoryPermission(permission)"
                     [class.disabled]="isMandatoryPermission(permission)">
                  <label class="permission-checkbox">
                    <input
                      type="checkbox"
                      [checked]="selectedPermissions().includes(permission.id)"
                      [disabled]="isMandatoryPermission(permission)"
                    ...
                    <div class="permission-content">
                      <div class="permission-name">
                        ...
                        <span *ngIf="isMandatoryPermission(permission)" class="mandatory-badge">
                          {{ translate('roles.mandatory') }}
                        </span>
                      </div>
  ...
  `, styles: ["/* angular:styles/component:css;08d5843984971667a52b6b86469efa0a38279acbdf5de95d27c9a1bb6e61190c;D:/web/EXSUS/\u062B\u0624\u062E\u0629/v2/echo-office-new/src/app/components/shared/permissions-assignment-modal/permissions-assignment-modal.component.ts */\n.permissions-modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 1000;\n  padding: 1rem;\n}\n.permissions-modal {\n  background: white;\n  border-radius: 12px;\n  width: 100%;\n  max-width: 800px;\n  max-height: 90vh;\n  display: flex;\n  flex-direction: column;\n  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);\n}\n.modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 1.5rem 2rem;\n  border-bottom: 1px solid #e5e7eb;\n  background: #B68A35;\n  color: white;\n  border-radius: 12px 12px 0 0;\n}\n.modal-header.rtl {\n  flex-direction: row-reverse;\n}\n.modal-header.ltr {\n  flex-direction: row;\n}\n.modal-header.rtl h3 {\n  order: 2;\n}\n.modal-header.rtl .close-btn {\n  order: 1;\n}\n.modal-header.ltr h3 {\n  order: 1;\n}\n.modal-header.ltr .close-btn {\n  order: 2;\n}\n.modal-header h3 {\n  font-size: 1.5rem;\n  font-weight: 600;\n  margin: 0;\n}\n.close-btn {\n  background: none;\n  border: none;\n  color: white;\n  cursor: pointer;\n  padding: 0.5rem;\n  border-radius: 6px;\n  transition: all 0.2s ease;\n}\n.close-btn:hover {\n  background: rgba(255, 255, 255, 0.1);\n}\n.modal-content {\n  flex: 1;\n  overflow-y: auto;\n  padding: 2rem;\n}\n.modal-actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 1rem;\n  padding: 1.5rem 2rem;\n  border-top: 1px solid #e5e7eb;\n  background: #f9fafb;\n  border-radius: 0 0 12px 12px;\n}\n.permission-group {\n  background: #f8fafc;\n  border: 1px solid #e2e8f0;\n  border-radius: 8px;\n  padding: 1.5rem;\n  margin-bottom: 1rem;\n}\n.group-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 1rem;\n}\n.group-title {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #1e293b;\n  margin: 0;\n}\n.group-actions {\n  display: flex;\n  gap: 0.5rem;\n}\n.btn-select-all,\n.btn-deselect-all {\n  background: #f1f5f9;\n  border: 1px solid #cbd5e1;\n  color: #475569;\n  padding: 0.375rem 0.75rem;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s ease;\n}\n.btn-select-all:hover {\n  background: #e2e8f0;\n  color: #334155;\n}\n.btn-deselect-all:hover {\n  background: #fef2f2;\n  color: #dc2626;\n  border-color: #fecaca;\n}\n.permissions-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));\n  gap: 1rem;\n}\n.permission-item {\n  background: white;\n  border: 1px solid #e2e8f0;\n  border-radius: 8px;\n  padding: 1rem;\n  transition: all 0.2s ease;\n  cursor: pointer;\n  width: 80% !important;\n  box-sizing: border-box;\n}\n.permission-item:hover {\n  border-color: #cbd5e1;\n  box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1);\n}\n.permission-item.assigned {\n  border-color: #158638;\n  background: #f0fdf4;\n}\n.permission-item.mandatory {\n  border-color: #B68A35;\n  background: #E8F3FF;\n}\n.permission-item.disabled {\n  cursor: not-allowed;\n  opacity: 0.8;\n}\n.mandatory-badge {\n  display: inline-block;\n  background: #B68A35;\n  color: white;\n  font-size: 0.7rem;\n  padding: 0.15rem 0.4rem;\n  border-radius: 4px;\n  margin-left: 0.5rem;\n  font-weight: 600;\n}\n.permission-input:disabled {\n  cursor: not-allowed;\n  opacity: 0.7;\n}\n.permission-checkbox {\n  display: flex;\n  align-items: flex-start;\n  gap: 0.75rem;\n  cursor: pointer;\n  width: 100%;\n}\n.permission-input {\n  margin: 0;\n  width: 18px;\n  height: 18px;\n  accent-color: #158638;\n  flex-shrink: 0;\n  margin-top: 2px;\n}\n.permission-custom {\n  display: none;\n}\n.permission-content {\n  flex: 1;\n}\n.permission-name {\n  font-weight: 500;\n  color: #1e293b;\n  margin-bottom: 0.25rem;\n  font-size: 0.95rem;\n}\n.permission-description {\n  color: #64748b;\n  font-size: 0.875rem;\n  margin-bottom: 0.5rem;\n  line-height: 1.4;\n}\n.permission-meta {\n  display: flex;\n  gap: 0.5rem;\n  flex-wrap: wrap;\n}\n.permission-controller,\n.permission-action {\n  background: #f1f5f9;\n  color: #475569;\n  padding: 0.25rem 0.5rem;\n  border-radius: 4px;\n  font-size: 0.75rem;\n  font-weight: 500;\n}\n.btn-loading {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.loading-spinner-small {\n  width: 16px;\n  height: 16px;\n  border: 2px solid #f3f4f6;\n  border-top: 2px solid #158638;\n  border-radius: 50%;\n  animation: spin 1s linear infinite;\n}\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.loading-container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 3rem;\n  text-align: center;\n}\n.loading-spinner {\n  width: 40px;\n  height: 40px;\n  border: 4px solid #f3f4f6;\n  border-top: 4px solid #158638;\n  border-radius: 50%;\n  animation: spin 1s linear infinite;\n  margin-bottom: 1rem;\n}\n@media (max-width: 360px) {\n  .permissions-grid {\n    display: flex;\n    flex-direction: column;\n    gap: 8px;\n  }\n  .permission-item {\n    width: 80% !important;\n    box-sizing: border-box;\n  }\n  .permission-item.assigned {\n    justify-content: center !important;\n  }\n}\n/*# sourceMappingURL=permissions-assignment-modal.component-X2EMVBXH.css.map */\n"] }]
  }], null, { isVisible: [{
    type: Input
  }], roleId: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PermissionsAssignmentModalComponent, { className: "PermissionsAssignmentModalComponent", filePath: "src/app/components/shared/permissions-assignment-modal/permissions-assignment-modal.component.ts", lineNumber: 432 });
})();

// src/app/components/roles/roles-list/roles-list.component.ts
function RolesListComponent_button_30_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function RolesListComponent_button_30_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RolesListComponent_div_39_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "path", 45)(4, "circle", 46)(5, "path", 47)(6, "path", 48);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(7, "h3");
    \u0275\u0275text(8);
    ...
    \u0275\u0275listener("click", function RolesListComponent_div_39_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
function RolesListComponent_div_40_tr_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 53)(1, "td", 54)(2, "div", 55)(3, "h4");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(5, "td", 56)(6, "p");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "td", 57)(9, "span", 17);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "td", 58)(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td", 59)(15, "div", 60)(16, "button", 61);
    \u0275\u0275listener("click", function RolesListComponent_div_40_tr_15_Template_button_click_16_listener() {
      const role_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.viewRoleDetails(role_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 28);
    \u0275\u0275element(18, "path", 62)(19, "circle", 63);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(20, "button", 64);
    \u0275\u0275listener("click", function RolesListComponent_div_40_tr_15_Template_button_click_20_listener() {
      const role_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.editRole(role_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(21, "svg", 28);
    \u0275\u0275element(22, "path", 65)(23, "path", 66);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(24, "button", 67);
    \u0275\u0275listener("click", function RolesListComponent_div_40_tr_15_Template_button_click_24_listener() {
      const role_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(26, "path", 9)(27, "path", 69)(28, "path", 70);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(29, "button", 71);
    \u0275\u0275listener("click", function RolesListComponent_div_40_tr_15_Template_button_click_29_listener() {
      const role_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openDeleteModal(role_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(30, "svg", 28);
    \u0275\u0275element(31, "polyline", 72)(32, "path", 73)(33, "line", 74)(34, "line", 75);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.getRoleDisplayName(role_r5));
    \u0275\u0275advance(3);
...
function RolesListComponent_div_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, RolesListComponent_div_40_tr_15_Template, 35, 8, "tr", 52);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function RolesListComponent_div_41_button_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 88);
    \u0275\u0275listener("click", function RolesListComponent_div_41_button_20_Template_button_click_0_listener() {
...
function RolesListComponent_div_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 78)(5, "label");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "select", 79);
    \u0275\u0275listener("change", function RolesListComponent_div_41_Template_select_change_7_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(9, "5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "option", 81);
    \u0275\u0275text(11, "10");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "option", 82);
    \u0275\u0275text(13, "20");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function RolesListComponent_div_41_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275template(20, RolesListComponent_div_41_button_20_Template, 2, 3, "button", 87);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "button", 85);
    \u0275\u0275listener("click", function RolesListComponent_div_41_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage() - 1));
    });
...
function RolesListComponent_div_43_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 89)(1, "div", 90)(2, "div", 91);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 92);
    \u0275\u0275element(4, "path", 93)(5, "polyline", 94);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7);
    ...
    \u0275\u0275listener("click", function RolesListComponent_div_43_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeSuccessModal());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(9, "svg", 28);
    \u0275\u0275element(10, "line", 29)(11, "line", 30);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var RolesListComponent = class _RolesListComponent {
    ...
    this.rolesService.getRoles(params).subscribe({
      next: (response) => {
        if (response.success && response.data) {
          ...
          this.pageSize.set(response.data.pageSize || 9);
  ...
  onSearchInput(event) {
    ...
    if (input.value !== value) {
      setTimeout(() => {
        ...
        if (!value || this.isValidSearchTerm(value)) {
  ...
  onSearchChange(searchTerm) {
    const trimmed = searchTerm.trim();
    if (trimmed && !this.isValidSearchTerm(trimmed)) {
      return;
    }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RolesListComponent, selectors: [["app-roles-list"]], standalone: false, decls: 45, vars: 42, consts: [[1, "roles-container", "rounded-5"], [1, "page-header"], [1, "header-content"], [1, "title-section"], [1, "page-title"], [1, "page-subtitle"], [1, "header-actions"], [1, "btn-secondary", "btn-icon-with-tooltip", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"], [1, "btn-icon-with-tooltip", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "table-container"], [1, "table-header", "compact"], [1, "table-title"], [1, "count-badge"], [1, "table-tools"], [1, "search-container", "inline"], [1, "search-input-group"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "search-icon"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.35-4.35"], ["type", "text", 1, "search-input", "compact", 3, "input", "keyup.enter", "placeholder", "value"], ["class", "clear-search-btn", 3, "click", 4, "ngIf"], [1, "btn", "btn-outline", "compact", 3, "click"], [1, "btn", "btn-secondary", "compact", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], ["class", "loading-container", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "table-wrapper", 4, "ngIf"], ["class", "pagination-container", 4, "ngIf"], [3, "confirm", "cancel", "data", "isVisible", "isRTL"], ["class", "success-modal", 4, "ngIf"], [3, "assign", "cancel", "isVisible", "roleId"], [1, "clear-search-btn", 3, "click"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], [1, "loading-container"], [1, "loading-spinner"], [1, "empty-state"], [1, "empty-icon"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 0 0-3-3.87"], ["d", "M16 3.13a4 4 0 0 1 0 7.75"], [1, "btn", "btn-primary", 3, "click"], [1, "table-wrapper"], [1, "roles-table"], ["class", "role-row", 4, "ngFor", "ngForOf"], [1, "role-row"], [1, "role-name"], [1, "role-info"], [1, "role-description"], [1, "permissions-count"], [1, "created-date"], [1, "actions"], [1, "action-buttons"], [1, "btn-icon", "btn-view", 3, "click"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"], ["cx", "12", "cy", "12", "r", "3"], [1, "btn-icon", "btn-edit", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], [1, "btn-icon", "btn-permissions", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M12 8v4"], ["d", "M12 16h.01"], [1, "btn-icon", "btn-delete", 3, "click"], ["points", "3,6 5,6 21,6"], ["d", "M19,6v14a2,2,0,0,1-2,2H7a2,2,0,0,1-2-2V6m3,0V4a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2v6"], ["x1", "10", "y1", "11", "x2", "10", "y2", "17"], ["x1", "14", "y1", "11", "x2", "14", "y2", "17"], [1, "pagination-container"], [1, "pagination-info"], [1, "page-size-selector"], [3, "change", "value"], ["value", "5"], ["value", "10"], ["value", "20"], ["value", "50"], [1, "pagination-controls"], [1, "btn-pagination", 3, "click", "disabled"], [1, "page-numbers"], ["class", "btn-page", 3, "active", "click", 4, "ngFor", "ngForOf"], [1, "btn-page", 3, "click"], [1, "success-modal"], [1, "success-content"], [1, "success-icon"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], [1, "close-success", 3, "click"]], template: function RolesListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function RolesListComponent_Template_button_click_12_listener() {
        return ctx.addNewRole();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(13, "svg", 11);
      \u0275\u0275element(14, "line", 12)(15, "line", 13);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(16, "div", 14)(17, "div", 15)(18, "div", 16)(19, "h3");
      \u0275\u0275text(20);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(27, "circle", 22)(28, "path", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(29, "input", 24);
      \u0275\u0275listener("input", function RolesListComponent_Template_input_input_29_listener($event) {
        return ctx.onSearchInput($event);
      })("keyup.enter", function RolesListComponent_Template_input_keyup_enter_29_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(30, RolesListComponent_button_30_Template, 4, 1, "button", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "button", 26);
      \u0275\u0275listener("click", function RolesListComponent_Template_button_click_31_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275text(32);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "button", 27);
      \u0275\u0275listener("click", function RolesListComponent_Template_button_click_33_listener() {
        return ctx.clearSearch();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(34, "svg", 28);
      \u0275\u0275element(35, "line", 29)(36, "line", 30);
      \u0275\u0275elementEnd();
      \u0275\u0275text(37);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(38, RolesListComponent_div_38_Template, 4, 1, "div", 31)(39, RolesListComponent_div_39_Template, 16, 3, "div", 32)(40, RolesListComponent_div_40_Template, 16, 6, "div", 33)(41, RolesListComponent_div_41_Template, 23, 14, "div", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(42, "app-confirmation-modal", 35);
      \u0275\u0275listener("confirm", function RolesListComponent_Template_app_confirmation_modal_confirm_42_listener() {
        return ctx.onDeleteConfirm();
      })("cancel", function RolesListComponent_Template_app_confirmation_modal_cancel_42_listener() {
        return ctx.onDeleteCancel();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(43, RolesListComponent_div_43_Template, 12, 1, "div", 36);
      \u0275\u0275elementStart(44, "app-permissions-assignment-modal", 37);
      \u0275\u0275listener("assign", function RolesListComponent_Template_app_permissions_assignment_modal_assign_44_listener($event) {
        return ctx.onPermissionsAssign($event);
      })("cancel", function RolesListComponent_Template_app_permissions_assignment_modal_cancel_44_listener() {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275attribute("data-tooltip", ctx.translate("roles.manage_permissions"))("aria-label", ctx.translate("roles.manage_permissions"));
      \u0275\u0275advance(3);
      \u0275\u0275attribute("data-tooltip", ctx.translate("roles.add_new_role"))("aria-label", ctx.translate("roles.add_new_role"));
      \u0275\u0275advance(5);
      \u0275\u0275classProp("rtl", ctx.isRTL())("ltr", !ctx.isRTL());
      \u0275\u0275advance(3);
...
(() => {
    ...
    <div class="header-content" [class.rtl]="isRTL()" [class.ltr]="!isRTL()">\r
      ...
      <div class="header-actions">\r
        <button \r
          ...
          (click)="manageAllPermissions()"\r
          [attr.data-tooltip]="translate('roles.manage_permissions')"\r
        ...
        <button \r
          ...
          (click)="addNewRole()"\r
          [attr.data-tooltip]="translate('roles.add_new_role')"\r
          [attr.aria-label]="translate('roles.add_new_role')">\r
  ...
  <div class="table-container">\r
    <div class="table-header compact" [class.rtl]="isRTL()" [class.ltr]="!isRTL()">\r
      <div class="table-title">\r
        <h3>{{ translate('roles.roles_list') }}</h3>\r
        <span class="count-badge">{{ totalCount() }} {{ translate('roles.roles') }}</span>\r
      </div>\r
      <div class="table-tools">\r
        <div class="search-container inline" [class.rtl]="isRTL()" [class.ltr]="!isRTL()">\r
          <div class="search-input-group" [class.rtl]="isRTL()" [class.ltr]="!isRTL()">\r
            <svg class="search-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
              <circle cx="11" cy="11" r="8"></circle>\r
              <path d="m21 21-4.35-4.35"></path>\r
            </svg>\r
            <input \r
              type="text" \r
              class="search-input compact" \r
          ...
          <button class="btn btn-outline compact" (click)="onSearchClick()">\r
            {{ translate('roles.search') }}\r
          </button>\r
          <button class="btn btn-secondary compact" (click)="clearSearch()">\r
          ...
          <tr *ngFor="let role of roles()" class="role-row">\r
            <td class="role-name">\r
              <div class="role-info">\r
                <h4>{{ getRoleDisplayName(role) }}</h4>\r
                <!-- <span class="role-id">{{ role.arabicName }}</span> -->\r
              </div>\r
            </td>\r
...
function RoleFormComponent_div_14_div_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 38);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function RoleFormComponent_div_14_div_33_Template(rf, ctx) {
  if (rf & 1) {
...
function RoleFormComponent_div_14_div_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function RoleFormComponent_div_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 21)(17, "label", 26);
    \u0275\u0275text(18);
    ...
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 30)(25, "label", 31);
    \u0275\u0275text(26);
    \u0275\u0275elementStart(27, "span", 23);
    \u0275\u0275text(28, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(29, "textarea", 32);
    \u0275\u0275template(30, RoleFormComponent_div_14_div_30_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(31, "div", 33)(32, "button", 34);
    \u0275\u0275template(33, RoleFormComponent_div_14_div_33_Template, 3, 1, "div", 35)(34, RoleFormComponent_div_14_div_34_Template, 2, 1, "div", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "button", 37);
    \u0275\u0275listener("click", function RoleFormComponent_div_14_Template_button_click_35_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("roles.role_form.arabic_name"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", ctx_r0.translate("roles.optional"), ")");
    \u0275\u0275advance();
    \u0275\u0275property("placeholder", ctx_r0.translate("roles.role_form.arabic_name_placeholder"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("roles.role_form.arabic_name_help"), " ");
    \u0275\u0275advance(3);
...
function RoleFormComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 44);
    \u0275\u0275element(4, "path", 45)(5, "polyline", 46);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7);
    ...
    \u0275\u0275element(10, "line", 49)(11, "line", 50);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var RoleFormComponent = class _RoleFormComponent {
  ...
  loadRole() {
    ...
    this.rolesService.getRoleById(roleId).subscribe({
      next: (role) => {
        ...
        this.ensureMandatoryPermissions();
  ...
  onPermissionToggle(permissionId, isChecked) {
    ...
    if (!isChecked && this.isMandatoryPermission(permission)) {
      const permissionsArray = this.roleForm.get("permissions");
      const index = this.permissions().findIndex((p) => p.id === permissionId);
      const control = permissionsArray.at(index);
  ...
  onSubmit() {
    if (this.roleForm.valid) {
      ...
      const roleData = {
        ...
        arabicName: formValue.arabicName || void 0
      };
      if (this.isEditMode()) {
  ...
  ensureMandatoryPermissions() {
    const mandatoryIds = this.getMandatoryPermissionIds();
    if (mandatoryIds.length === 0) {
      return;
    }
    const current = this.selectedPermissions();
    const updated = [.../* @__PURE__ */ new Set([...mandatoryIds, ...current])];
    if (updated.length !== current.length) {
      this.selectedPermissions.set(updated);
    }
  }
  getMandatoryPermissionIds() {
    return this.permissions().filter((permission) => this.isMandatoryPermission(permission)).map((permission) => permission.id);
  }
  isMandatoryPermission(permission) {
    const displayName = permission.displayName?.toLowerCase() || "";
    const controller = permission.controller?.toLowerCase();
    const action = permission.action?.toLowerCase();
    const isMyCalendar = controller === "calendar" && action === "index" || displayName.includes("my calendar");
    const isCalendarEvents = controller === "calendar" && action === "events.get" || displayName.includes("get calendar events") || displayName.includes("view calendar events for user");
    return isMyCalendar || isCalendarEvents;
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoleFormComponent, selectors: [["app-role-form"]], standalone: false, decls: 17, vars: 15, consts: [[1, "role-form-container", "rounded-4"], [1, "page-header"], [1, "header-content"], [1, "title-section"], [1, "back-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["points", "15,18 9,12 15,6"], [1, "title-content"], [1, "page-title"], [1, "page-subtitle"], ["class", "loading-container", 4, "ngIf"], ["class", "form-content", 4, "ngIf"], [3, "confirm", "cancel", "data", "isVisible", "isRTL"], ["class", "success-modal", 4, "ngIf"], [1, "loading-container"], [1, "loading-spinner"], [1, "form-content"], [1, "role-form", 3, "ngSubmit", "formGroup"], [1, "form-card"], [1, "card-header"], [1, "form-grid"], [1, "form-group"], ["for", "name", 1, "form-label"], [1, "required"], ["type", "text", "id", "name", "formControlName", "name", 1, "form-input", 3, "placeholder"], ["class", "error-message", 4, "ngIf"], ["for", "arabicName", 1, "form-label"], [1, "optional"], ["type", "text", "id", "arabicName", "formControlName", "arabicName", 1, "form-input", 3, "placeholder"], [1, "field-help"], [1, "form-group", "full-width"], ["for", "description", 1, "form-label"], ["id", "description", "formControlName", "description", "rows", "3", 1, "form-textarea", 3, "placeholder"], [1, "form-actions"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "btn-loading", 4, "ngIf"], [4, "ngIf"], ["type", "button", 1, "btn", "btn-secondary", 3, "click", "disabled"], [1, "error-message"], [1, "btn-loading"], [1, "loading-spinner-small"], [1, "success-modal"], [1, "success-content"], [1, "success-icon"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], [1, "close-success", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"]], template: function RoleFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(12);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(13, RoleFormComponent_div_13_Template, 4, 1, "div", 10)(14, RoleFormComponent_div_14_Template, 37, 22, "div", 11);
...
\r
          <div class="form-group">\r
            <label for="arabicName" class="form-label">\r
              {{ translate('roles.role_form.arabic_name') }}\r
              <span class="optional">({{ translate('roles.optional') }})</span>\r
            </label>\r
            <input\r
              type="text"\r
              id="arabicName"\r
              formControlName="arabicName"\r
              class="form-input"\r
              [placeholder]="translate('roles.role_form.arabic_name_placeholder')"\r
            />\r
            <div class="field-help">\r
              {{ translate('roles.role_form.arabic_name_help') }}\r
            </div>\r
          </div>\r
\r
...
function RoleDetailsComponent_div_20_div_34_div_1_div_7_span_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("roles.mandatory"), " ");
  }
}
function RoleDetailsComponent_div_20_div_34_div_1_div_7_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 59)(1, "button", 60);
    \u0275\u0275listener("click", function RoleDetailsComponent_div_20_div_34_div_1_div_7_div_12_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r3);
...
function RoleDetailsComponent_div_20_div_34_div_1_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275template(4, RoleDetailsComponent_div_20_div_34_div_1_div_7_span_4_Template, 2, 1, "span", 52);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(12, RoleDetailsComponent_div_20_div_34_div_1_div_7_div_12_Template, 5, 1, "div", 57);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const permission_r4 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275classProp("mandatory", ctx_r0.isMandatoryPermission(permission_r4));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", permission_r4.displayName, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.isMandatoryPermission(permission_r4));
    \u0275\u0275advance(2);
...
function RoleDetailsComponent_div_20_div_34_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, RoleDetailsComponent_div_20_div_34_div_1_div_7_Template, 13, 8, "div", 48);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function RoleDetailsComponent_div_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.getRoleDisplayName(ctx_r0.role()));
    \u0275\u0275advance(3);
...
function RoleDetailsComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "path", 67)(5, "polyline", 68);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7);
    ...
    \u0275\u0275element(10, "line", 61)(11, "line", 62);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var RoleDetailsComponent = class _RoleDetailsComponent {
  ...
  openRemoveModal(permission) {
    if (this.isMandatoryPermission(permission)) {
      return;
    }
    ...
    <div class="info-card">\r
      ...
      <div class="info-grid">\r
        <div class="info-item">\r
          ...
          <div class="info-value">{{ getRoleDisplayName(role()!) }}</div>\r
        </div>\r
        <div class="info-item">\r
      ...
      <div *ngIf="permissions().length > 0" class="permissions-container">\r
        <div *ngFor="let group of getPermissionGroups() | keyvalue" class="permission-group">\r
          ...
          <div class="permissions-list">\r
            <div *ngFor="let permission of group.value" class="permission-item" [class.mandatory]="isMandatoryPermission(permission)">\r
              <div class="permission-info">\r
                <div class="permission-name">\r
                  {{ permission.displayName }}\r
                  <span *ngIf="isMandatoryPermission(permission)" class="mandatory-badge">\r
                    {{ translate('roles.mandatory') }}\r
                  </span>\r
                </div>\r
              ...
              <div class="permission-actions" *ngIf="!isMandatoryPermission(permission)">\r
                <button \r
...
function PermissionsManagementComponent_button_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 31);
    \u0275\u0275listener("click", function PermissionsManagementComponent_button_21_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.clearSearch());
    });
...
function PermissionsManagementComponent_div_31_Template(rf, ctx) {
  if (rf & 1) {
...
function PermissionsManagementComponent_div_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 37)(1, "div", 38);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 39);
    \u0275\u0275element(3, "circle", 40)(4, "line", 41)(5, "line", 42);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "h3");
    \u0275\u0275text(7);
    ...
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_32_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(12, "line", 44)(13, "line", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
  }
...
function PermissionsManagementComponent_div_33_tr_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 49)(1, "td", 50)(2, "div", 51)(3, "h4");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(5, "td", 52)(6, "span");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "td", 53)(9, "span", 54);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "td", 55)(12, "span", 56);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "td", 57)(15, "span", 58);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "td", 59)(18, "span");
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "td", 60)(21, "div", 61)(22, "button", 62);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_33_tr_19_Template_button_click_22_listener() {
    ...
    \u0275\u0275element(24, "path", 63)(25, "path", 64);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(26, "button", 65);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_33_tr_19_Template_button_click_26_listener() {
      const permission_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275element(28, "polyline", 66)(29, "path", 67)(30, "line", 68)(31, "line", 69);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function PermissionsManagementComponent_div_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(19, PermissionsManagementComponent_div_33_tr_19_Template, 32, 12, "tr", 48);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PermissionsManagementComponent_div_34_button_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 83);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_34_button_22_Template_button_click_0_listener() {
      const page_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onPageChange(page_r8));
    });
...
function PermissionsManagementComponent_div_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 70)(1, "div", 71)(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 72)(5, "label");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "select", 73);
    \u0275\u0275listener("change", function PermissionsManagementComponent_div_34_Template_select_change_7_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageSizeChange($event.target.value));
    });
    ...
    \u0275\u0275text(15, "50");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(16, "div", 78)(17, "button", 79);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_34_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage() - 1));
    });
    ...
    \u0275\u0275template(22, PermissionsManagementComponent_div_34_button_22_Template, 2, 3, "button", 81);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "button", 79);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_34_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPageChange(ctx_r1.currentPage() + 1));
    });
...
function PermissionsManagementComponent_div_35_div_17_Template(rf, ctx) {
  if (rf & 1) {
...
function PermissionsManagementComponent_div_35_div_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 113);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PermissionsManagementComponent_div_35_div_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 113);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PermissionsManagementComponent_div_35_div_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 113);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PermissionsManagementComponent_div_35_div_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 113);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PermissionsManagementComponent_div_35_div_54_Template(rf, ctx) {
  if (rf & 1) {
...
function PermissionsManagementComponent_div_35_div_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PermissionsManagementComponent_div_35_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 84);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_35_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeForm());
    });
    \u0275\u0275elementStart(1, "div", 85);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_35_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r9);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(2, "div", 86)(3, "h3");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 87);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_35_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeForm());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(6, "svg", 5);
    \u0275\u0275element(7, "line", 33)(8, "line", 34);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "form", 88);
    \u0275\u0275listener("ngSubmit", function PermissionsManagementComponent_div_35_Template_form_ngSubmit_9_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSubmit());
    });
    \u0275\u0275elementStart(10, "div", 89)(11, "div", 90)(12, "label", 91);
    \u0275\u0275text(13);
    \u0275\u0275elementStart(14, "span", 92);
    \u0275\u0275text(15, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(16, "input", 93);
    \u0275\u0275template(17, PermissionsManagementComponent_div_35_div_17_Template, 2, 1, "div", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 90)(19, "label", 95);
    \u0275\u0275text(20);
    \u0275\u0275elementStart(21, "span", 92);
    \u0275\u0275text(22, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(23, "input", 96);
    \u0275\u0275template(24, PermissionsManagementComponent_div_35_div_24_Template, 2, 1, "div", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 90)(26, "label", 97);
    \u0275\u0275text(27);
    \u0275\u0275elementStart(28, "span", 92);
    \u0275\u0275text(29, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(30, "input", 98);
    \u0275\u0275template(31, PermissionsManagementComponent_div_35_div_31_Template, 2, 1, "div", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "div", 90)(33, "label", 99);
    \u0275\u0275text(34);
    \u0275\u0275elementStart(35, "span", 92);
    \u0275\u0275text(36, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(37, "input", 100);
    \u0275\u0275template(38, PermissionsManagementComponent_div_35_div_38_Template, 2, 1, "div", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 101)(40, "label", 102);
    \u0275\u0275text(41);
    \u0275\u0275elementStart(42, "span", 92);
    \u0275\u0275text(43, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(44, "textarea", 103);
    \u0275\u0275template(45, PermissionsManagementComponent_div_35_div_45_Template, 2, 1, "div", 94);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div", 90)(47, "label", 104);
    \u0275\u0275element(48, "input", 105)(49, "span", 106);
    \u0275\u0275elementStart(50, "span", 107);
    \u0275\u0275text(51);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(52, "div", 108)(53, "button", 109);
    \u0275\u0275template(54, PermissionsManagementComponent_div_35_div_54_Template, 3, 1, "div", 110)(55, PermissionsManagementComponent_div_35_div_55_Template, 2, 1, "div", 111);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "button", 112);
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_35_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeForm());
    });
...
function PermissionsManagementComponent_div_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "path", 120)(5, "polyline", 121);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "p");
    \u0275\u0275text(7);
    ...
    \u0275\u0275listener("click", function PermissionsManagementComponent_div_37_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeSuccessModal());
    });
    ...
    \u0275\u0275element(10, "line", 33)(11, "line", 34);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var PermissionsManagementComponent = class _PermissionsManagementComponent {
  ...
  loadPermissions() {
    ...
    this.permissionsService.getPermissions(params).subscribe({
      next: (response) => {
        if (response.success && response.data) {
          const filteredItems = (response.data.items || []).filter((p) => p.name !== "user.index");
          this.permissions.set(filteredItems);
          this.totalCount.set(response.data.totalCount || 0);
          this.currentPage.set(response.data.page || 1);
          this.pageSize.set(response.data.pageSize || 9);
        } else {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PermissionsManagementComponent, selectors: [["app-permissions-management"]], standalone: false, decls: 38, vars: 33, consts: [[1, "permissions-container"], [1, "page-header"], [1, "header-content"], [1, "title-section"], [1, "back-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["points", "15,18 9,12 15,6"], [1, "title-content"], [1, "page-title"], [1, "page-subtitle"], [1, "header-actions"], [1, "search-section"], [1, "search-container"], [1, "search-input-group"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "search-icon"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.35-4.35"], ["type", "text", 1, "search-input", 3, "input", "keyup.enter", "placeholder", "value"], ["class", "clear-search-btn", 3, "click", 4, "ngIf"], [1, "btn", "btn-outline", 3, "click"], [1, "table-container"], [1, "table-header"], [1, "table-title"], [1, "count-badge"], ["class", "loading-container", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "table-wrapper", 4, "ngIf"], ["class", "pagination-container", 4, "ngIf"], ["class", "form-modal-overlay", 3, "click", 4, "ngIf"], [3, "confirm", "cancel", "data", "isVisible", "isRTL"], ["class", "success-modal", 4, "ngIf"], [1, "clear-search-btn", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "loading-container"], [1, "loading-spinner"], [1, "empty-state"], [1, "empty-icon"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "12", "y1", "8", "x2", "12", "y2", "12"], ["x1", "12", "y1", "16", "x2", "12.01", "y2", "16"], [1, "btn", "btn-primary", 3, "click"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "table-wrapper"], [1, "permissions-table"], ["class", "permission-row", 4, "ngFor", "ngForOf"], [1, "permission-row"], [1, "permission-name"], [1, "permission-info"], [1, "display-name"], [1, "controller"], [1, "controller-badge"], [1, "action"], [1, "action-badge"], [1, "status"], [1, "status-badge"], [1, "created-date"], [1, "actions"], [1, "action-buttons"], [1, "btn-icon", "btn-edit", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], [1, "btn-icon", "btn-delete", 3, "click"], ["points", "3,6 5,6 21,6"], ["d", "M19,6v14a2,2,0,0,1-2,2H7a2,2,0,0,1-2-2V6m3,0V4a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2v6"], ["x1", "10", "y1", "11", "x2", "10", "y2", "17"], ["x1", "14", "y1", "11", "x2", "14", "y2", "17"], [1, "pagination-container"], [1, "pagination-info"], [1, "page-size-selector"], [3, "change", "value"], ["value", "5"], ["value", "10"], ["value", "20"], ["value", "50"], [1, "pagination-controls"], [1, "btn-pagination", 3, "click", "disabled"], [1, "page-numbers"], ["class", "btn-page", 3, "active", "click", 4, "ngFor", "ngForOf"], ["points", "9,18 15,12 9,6"], [1, "btn-page", 3, "click"], [1, "form-modal-overlay", 3, "click"], [1, "form-modal", 3, "click"], [1, "form-modal-header"], [1, "close-btn", 3, "click"], [1, "permission-form", 3, "ngSubmit", "formGroup"], [1, "form-grid"], [1, "form-group"], ["for", "name", 1, "form-label"], [1, "required"], ["type", "text", "id", "name", "formControlName", "name", 1, "form-input", 3, "placeholder"], ["class", "error-message", 4, "ngIf"], ["for", "displayName", 1, "form-label"], ["type", "text", "id", "displayName", "formControlName", "displayName", 1, "form-input", 3, "placeholder"], ["for", "controller", 1, "form-label"], ["type", "text", "id", "controller", "formControlName", "controller", 1, "form-input", 3, "placeholder"], ["for", "action", 1, "form-label"], ["type", "text", "id", "action", "formControlName", "action", 1, "form-input", 3, "placeholder"], [1, "form-group", "full-width"], ["for", "description", 1, "form-label"], ["id", "description", "formControlName", "description", "rows", "3", 1, "form-textarea", 3, "placeholder"], [1, "checkbox-label"], ["type", "checkbox", "formControlName", "isActive", 1, "checkbox-input"], [1, "checkbox-custom"], [1, "checkbox-text"], [1, "form-actions"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "btn-loading", 4, "ngIf"], [4, "ngIf"], ["type", "button", 1, "btn", "btn-secondary", 3, "click", "disabled"], [1, "error-message"], [1, "btn-loading"], [1, "loading-spinner-small"], [1, "success-modal"], [1, "success-content"], [1, "success-icon"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], [1, "close-success", 3, "click"]], template: function PermissionsManagementComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(18, "circle", 15)(19, "path", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(20, "input", 17);
      \u0275\u0275listener("input", function PermissionsManagementComponent_Template_input_input_20_listener($event) {
        return ctx.onSearchInput($event);
      })("keyup.enter", function PermissionsManagementComponent_Template_input_keyup_enter_20_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(21, PermissionsManagementComponent_button_21_Template, 4, 1, "button", 18);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "button", 19);
      \u0275\u0275listener("click", function PermissionsManagementComponent_Template_button_click_22_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275text(23);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(24, "div", 20)(25, "div", 21)(26, "div", 22)(27, "h3");
      \u0275\u0275text(28);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "span", 23);
      \u0275\u0275text(30);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(31, PermissionsManagementComponent_div_31_Template, 4, 1, "div", 24)(32, PermissionsManagementComponent_div_32_Template, 15, 3, "div", 25)(33, PermissionsManagementComponent_div_33_Template, 20, 8, "div", 26)(34, PermissionsManagementComponent_div_34_Template, 27, 14, "div", 27);
      \u0275\u0275elementEnd();
      \u0275\u0275template(35, PermissionsManagementComponent_div_35_Template, 58, 37, "div", 28);
      \u0275\u0275elementStart(36, "app-confirmation-modal", 29);
      \u0275\u0275listener("confirm", function PermissionsManagementComponent_Template_app_confirmation_modal_confirm_36_listener() {
        return ctx.onDeleteConfirm();
      })("cancel", function PermissionsManagementComponent_Template_app_confirmation_modal_cancel_36_listener() {
        return ctx.onDeleteCancel();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(37, PermissionsManagementComponent_div_37_Template, 12, 1, "div", 30);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275classProp("rtl", ctx.isRTL());
...
//# sourceMappingURL=chunk-R4U5NPAN.js.map

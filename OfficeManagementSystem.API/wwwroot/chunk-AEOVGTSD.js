...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadChildren: () => import("./chunk-UN46W3WP.js").then((m) => m.DashboardModule),
        canActivate: [PermissionGuard],
        data: { permission: "dashboard.index" }
      },
      {
        path: "users",
        loadChildren: () => import("./chunk-USE5EDSM.js").then((m) => m.UsersModule),
        canActivate: [PermissionGuard],
        data: { permission: "user.index" }
      },
      {
        path: "roles",
        loadChildren: () => import("./chunk-URI4RJVK.js").then((m) => m.RolesModule),
        canActivate: [PermissionGuard],
        data: { permission: "admin.index" }
      },
      {
        path: "employees",
        loadChildren: () => import("./chunk-KUT7JPGX.js").then((m) => m.EmployeesModule),
        canActivate: [PermissionGuard],
        data: { permission: "employee.index" }
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-NNENC4KF.js").then((m) => m.ProfileComponent)
      },
      {
        path: "departments",
        loadChildren: () => import("./chunk-4GLMD2BP.js").then((m) => m.DepartmentsModule),
        canActivate: [PermissionGuard],
        data: { permission: "department.index" }
      },
      {
        path: "tasks",
        loadChildren: () => import("./chunk-D7CHAFSU.js").then((m) => m.TasksModule)
      },
      {
        path: "partners",
        loadChildren: () => import("./chunk-6CKMQXHW.js").then((m) => m.PartnersModule),
        canActivate: [PermissionGuard],
        data: { permission: "partners.index" }
      },
      {
        path: "visits",
        loadChildren: () => import("./chunk-R43DVIJD.js").then((m) => m.VisitsModule),
        canActivate: [PermissionGuard],
        data: { permission: "visits.index" }
      },
      {
        path: "travel",
        loadChildren: () => import("./chunk-GTODFGTO.js").then((m) => m.TravelModule),
        canActivate: [PermissionGuard],
        data: { permission: "travel.index" }
      },
      {
        path: "meetings",
        loadChildren: () => import("./chunk-IXC2BRFC.js").then((m) => m.MeetingsModule),
        canActivate: [PermissionGuard],
        data: { permission: "meeting.index" }
      },
      {
        path: "my-calendar",
        loadChildren: () => import("./chunk-H3JSTYCW.js").then((m) => m.CalendarModule),
        canActivate: [PermissionGuard],
        data: { permission: "calendar.index" }
      },
      {
        path: "calendar",
        loadChildren: () => import("./chunk-XOGI3JOP.js").then((m) => m.SystemCalendarModule),
        canActivate: [PermissionGuard],
        data: { permission: "calendar.events.get" }
      },
      {
        path: "letters",
        loadChildren: () => import("./chunk-FGLC56EI.js").then((m) => m.LettersModule)
      },
      {
        path: "documents",
        loadChildren: () => import("./chunk-EK75DK6Z.js").then((m) => m.DocumentsModule),
        canActivate: [PermissionGuard],
        data: { permission: "documents.index" }
      },
      {
        path: "workflow",
        loadChildren: () => import("./chunk-ICMUUEK7.js").then((m) => m.WorkflowModule),
        canActivate: [PermissionGuard],
...
//# sourceMappingURL=chunk-AEOVGTSD.js.map

...
function AddTravelModalComponent_button_51_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function AddTravelModalComponent_button_51_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.showPartnerForm());
    });
    \u0275\u0275namespaceSVG();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("travel.add_partner"), " ");
  }
}
function AddTravelModalComponent_div_52_div_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getPartnerFieldError("name"), " ");
  }
}
function AddTravelModalComponent_div_52_div_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getPartnerFieldError("email"), " ");
  }
}
function AddTravelModalComponent_div_52_div_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 54);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getPartnerFieldError("jobTitle"), " ");
  }
}
function AddTravelModalComponent_div_52_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 45)(5, "div", 46)(6, "label", 47);
    \u0275\u0275text(7);
    \u0275\u0275elementStart(8, "span", 48);
    \u0275\u0275text(9, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(10, "input", 49);
    \u0275\u0275template(11, AddTravelModalComponent_div_52_div_11_Template, 2, 1, "div", 50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 46)(13, "label", 47);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "input", 49);
    \u0275\u0275template(16, AddTravelModalComponent_div_52_div_16_Template, 2, 1, "div", 50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 46)(18, "label", 47);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275element(20, "input", 49);
    \u0275\u0275template(21, AddTravelModalComponent_div_52_div_21_Template, 2, 1, "div", 50);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 51)(23, "button", 52);
    \u0275\u0275listener("click", function AddTravelModalComponent_div_52_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.addPartner());
    });
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "button", 53);
    \u0275\u0275listener("click", function AddTravelModalComponent_div_52_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.hidePartnerForm());
    });
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.editingPartnerIndex() !== null ? ctx_r0.translate("travel.edit_partner") : ctx_r0.translate("travel.add_partner"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.translate("travel.partner_name"), " ");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("error", ((tmp_3_0 = ctx_r0.partnerForm.get("name")) == null ? null : tmp_3_0.invalid) && ((tmp_3_0 = ctx_r0.partnerForm.get("name")) == null ? null : tmp_3_0.touched));
    \u0275\u0275property("placeholder", \u0275\u0275interpolate(ctx_r0.translate("travel.partner_name_placeholder")))("formControl", ctx_r0.partnerForm.get("name"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getPartnerFieldError("name"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.translate("travel.partner_email"), " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("error", ((tmp_8_0 = ctx_r0.partnerForm.get("email")) == null ? null : tmp_8_0.invalid) && ((tmp_8_0 = ctx_r0.partnerForm.get("email")) == null ? null : tmp_8_0.touched));
    \u0275\u0275property("placeholder", \u0275\u0275interpolate(ctx_r0.translate("travel.partner_email_placeholder")))("formControl", ctx_r0.partnerForm.get("email"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getPartnerFieldError("email"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.translate("travel.partner_job_title"), " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("error", ((tmp_13_0 = ctx_r0.partnerForm.get("jobTitle")) == null ? null : tmp_13_0.invalid) && ((tmp_13_0 = ctx_r0.partnerForm.get("jobTitle")) == null ? null : tmp_13_0.touched));
    \u0275\u0275property("placeholder", \u0275\u0275interpolate(ctx_r0.translate("travel.partner_job_title_placeholder")))("formControl", ctx_r0.partnerForm.get("jobTitle"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.getPartnerFieldError("jobTitle"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r0.editingPartnerIndex() !== null ? ctx_r0.translate("common.save") : ctx_r0.translate("common.add"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("common.cancel"), " ");
  }
}
function AddTravelModalComponent_div_53_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AddTravelModalComponent_div_53_div_1_Template_button_click_12_listener() {
      const i_r6 = \u0275\u0275restoreView(_r5).index;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.editPartner(i_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 40);
    \u0275\u0275element(14, "path", 66)(15, "path", 67);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(16, "button", 68);
    \u0275\u0275listener("click", function AddTravelModalComponent_div_53_div_1_Template_button_click_16_listener() {
      const i_r6 = \u0275\u0275restoreView(_r5).index;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.removePartner(i_r6));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 40);
    \u0275\u0275element(18, "line", 6)(19, "line", 7);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(partner_r7.name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(partner_r7.email);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(partner_r7.jobTitle);
    \u0275\u0275advance(2);
    \u0275\u0275attribute("aria-label", ctx_r0.translate("common.edit"));
    \u0275\u0275advance(4);
    \u0275\u0275attribute("aria-label", ctx_r0.translate("common.delete"));
  }
}
function AddTravelModalComponent_div_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 55);
    \u0275\u0275template(1, AddTravelModalComponent_div_53_div_1_Template, 20, 5, "div", 56);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.partners());
  }
}
function AddTravelModalComponent_div_54_Template(rf, ctx) {
  if (rf & 1) {
...
function AddTravelModalComponent_div_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 74);
  }
}
var AddTravelModalComponent = class _AddTravelModalComponent {
  ...
  showAddPartnerForm = signal(false, ...ngDevMode ? [{ debugName: "showAddPartnerForm" }] : []);
  partnerForm;
  editingPartnerIndex = signal(null, ...ngDevMode ? [{ debugName: "editingPartnerIndex" }] : []);
  transportModes = [
    { value: "Air", icon: "\u2708\uFE0F" },
  ...
  constructor(fb, travelService, translationService) {
    ...
    this.travelForm = this.fb.group({
      ...
      purpose: ["", [Validators.minLength(5), Validators.maxLength(400)]],
      startDate: ["", [Validators.required]],
      endDate: ["", [Validators.required]],
      transportMode: ["Air"],
      accommodation: ["", [Validators.minLength(2)]]
    });
  ...
  onSubmit() {
    ...
    if (this.travelForm.valid) {
      ...
      const cleanedPartners = this.partners().map((partner) => __spreadProps(__spreadValues({}, partner), {
        email: partner.email && partner.email.trim() ? partner.email.trim() : null,
        jobTitle: partner.jobTitle && partner.jobTitle.trim() ? partner.jobTitle.trim() : null
      }));
      const travelData = {
      ...
      this.travelService.createTravel(travelData).subscribe({
        ...
        error: (error) => {
          ...
          if (error.error?.errors) {
            ...
            this.errorMessage.set(errorMessages.join(", ") || this.translate("travel.create_error"));
      ...
      this.errorMessage.set(this.translate("travel.form_validation_error") || "Please fill in all required fields correctly.");
    }
  }
  ...
  showPartnerForm() {
    this.showAddPartnerForm.set(true);
    this.editingPartnerIndex.set(null);
    this.partnerForm.reset();
  }
  hidePartnerForm() {
    this.showAddPartnerForm.set(false);
    this.editingPartnerIndex.set(null);
    this.partnerForm.reset();
  }
  addPartner() {
    const partnerName = (this.partnerForm.value.name || "").trim();
    if (!partnerName) {
      this.partnerForm.get("name")?.markAsTouched();
      this.partnerForm.get("name")?.setErrors({ required: true });
      return;
    }
    const partnerEmail = (this.partnerForm.value.email || "").trim();
    if (partnerEmail && !this.isValidEmail(partnerEmail)) {
      this.partnerForm.get("email")?.markAsTouched();
      this.partnerForm.get("email")?.setErrors({ email: true });
      return;
    }
    const editIndex = this.editingPartnerIndex();
    const partnerJobTitle = (this.partnerForm.value.jobTitle || "").trim();
    const partnerData = {
      id: 0,
      // New partner
      name: partnerName,
      email: partnerEmail || "",
      // Will be cleaned to null in onSubmit if empty
    ...
    if (editIndex !== null) {
      ...
      this.partners.update((partners) => [...partners, partnerData]);
    }
    this.hidePartnerForm();
  }
  isValidEmail(email) {
  ...
  editPartner(index) {
    ...
    this.editingPartnerIndex.set(index);
    this.showAddPartnerForm.set(true);
  }
  removePartner(index) {
    this.partners.update((partners) => partners.filter((_, i) => i !== index));
  }
  markPartnerFormTouched() {
    Object.keys(this.partnerForm.controls).forEach((key) => {
      const control = this.partnerForm.get(key);
      control?.markAsTouched();
    });
  }
  getPartnerFieldError(fieldName) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddTravelModalComponent, selectors: [["app-add-travel-modal"]], inputs: { isRTL: "isRTL" }, outputs: { close: "close", travelAdded: "travelAdded" }, standalone: false, decls: 61, vars: 51, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click", "dir"], [1, "modal-header"], [1, "modal-title"], [1, "close-btn", 3, "click"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "travel-form", 3, "ngSubmit", "formGroup"], [1, "form-group"], ["for", "title", 1, "form-label"], ["type", "text", "id", "title", "formControlName", "title", 1, "form-input", 3, "placeholder"], ["class", "error-message", 4, "ngIf"], ["for", "destination", 1, "form-label"], ["type", "text", "id", "destination", "formControlName", "destination", 1, "form-input", 3, "placeholder"], ["for", "purpose", 1, "form-label"], ["id", "purpose", "formControlName", "purpose", "rows", "3", 1, "form-textarea", 3, "placeholder"], [1, "form-row"], ["for", "endDate", 1, "form-label"], ["type", "datetime-local", "id", "endDate", "formControlName", "endDate", 1, "form-input"], ["for", "startDate", 1, "form-label"], ["type", "datetime-local", "id", "startDate", "formControlName", "startDate", 1, "form-input"], ["for", "transportMode", 1, "form-label"], ["id", "transportMode", "formControlName", "transportMode", 1, "form-select"], [3, "value", 4, "ngFor", "ngForOf"], ["for", "accommodation", 1, "form-label"], ["id", "accommodation", "formControlName", "accommodation", "rows", "2", 1, "form-textarea", 3, "placeholder"], [1, "partners-header"], [1, "form-label"], ["type", "button", "class", "btn-add-partner", 3, "click", 4, "ngIf"], ["class", "partner-form-container", 4, "ngIf"], ["class", "partners-list-container", 4, "ngIf"], ["class", "error-alert", 4, "ngIf"], [1, "form-actions"], ["type", "button", 1, "btn-secondary", 3, "click"], ["type", "submit", 1, "btn-primary", 3, "disabled"], ["class", "spinner", 4, "ngIf"], [1, "error-message"], [3, "value"], ["type", "button", 1, "btn-add-partner", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "partner-form-container"], [1, "partner-form-header"], [1, "partner-form-fields"], [1, "form-group-inline"], [1, "form-label-small"], [1, "text-danger"], ["type", "text", 1, "form-input-small", 3, "formControl", "placeholder"], ["class", "error-message-small", 4, "ngIf"], [1, "partner-form-actions"], ["type", "button", 1, "btn-save-partner", 3, "click"], ["type", "button", 1, "btn-cancel-partner", 3, "click"], [1, "error-message-small"], [1, "partners-list-container"], ["class", "partner-item", 4, "ngFor", "ngForOf"], [1, "partner-item"], [1, "partner-item-content"], [1, "partner-item-name"], [1, "partner-item-details"], [1, "partner-item-email"], [1, "partner-item-divider"], [1, "partner-item-job"], [1, "partner-item-actions"], ["type", "button", 1, "btn-edit-partner", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], ["type", "button", 1, "btn-delete-partner", 3, "click"], [1, "error-alert"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "15", "y1", "9", "x2", "9", "y2", "15"], ["x1", "9", "y1", "9", "x2", "15", "y2", "15"], [1, "spinner"]], template: function AddTravelModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "div", 9)(48, "div", 27)(49, "label", 28);
      \u0275\u0275text(50);
      \u0275\u0275elementEnd();
      \u0275\u0275template(51, AddTravelModalComponent_button_51_Template, 5, 1, "button", 29);
      \u0275\u0275elementEnd();
      \u0275\u0275template(52, AddTravelModalComponent_div_52_Template, 27, 24, "div", 30)(53, AddTravelModalComponent_div_53_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275template(54, AddTravelModalComponent_div_54_Template, 6, 1, "div", 32);
      \u0275\u0275elementStart(55, "div", 33)(56, "button", 34);
      \u0275\u0275listener("click", function AddTravelModalComponent_Template_button_click_56_listener() {
        return ctx.closeModal();
      });
      \u0275\u0275text(57);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "button", 35);
      \u0275\u0275template(59, AddTravelModalComponent_div_59_Template, 1, 0, "div", 36);
      \u0275\u0275text(60);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1("", ctx.translate("travel.travel_title"), " *");
      \u0275\u0275advance();
      ...
      \u0275\u0275advance();
      \u0275\u0275classProp("error", ((tmp_17_0 = ctx.travelForm.get("endDate")) == null ? null : tmp_17_0.invalid) && ((tmp_17_0 = ctx.travelForm.get("endDate")) == null ? null : tmp_17_0.touched));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.getFieldError("endDate"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1("", ctx.translate("travel.start_date"), " *");
      \u0275\u0275advance();
      \u0275\u0275classProp("error", ((tmp_20_0 = ctx.travelForm.get("startDate")) == null ? null : tmp_20_0.invalid) && ((tmp_20_0 = ctx.travelForm.get("startDate")) == null ? null : tmp_20_0.touched));
      \u0275\u0275advance();
      ...
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.translate("travel.travel_partners"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.showAddPartnerForm());
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.showAddPartnerForm());
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.partners().length > 0);
      \u0275\u0275advance();
    ...
    <form [formGroup]="travelForm" (ngSubmit)="onSubmit()" class="travel-form">\r
      <div class="form-group">\r
        <label for="title" class="form-label"\r
          >{{ translate("travel.travel_title") }} *</label\r
        >\r
        <input\r
          type="text"\r
          id="title"\r
...
\r
      <!-- Travel Partners Section -->\r
      <div class="form-group">\r
        <div class="partners-header">\r
          <label class="form-label">{{ translate("travel.travel_partners") }}</label>\r
          <button \r
            type="button" \r
            class="btn-add-partner"\r
            (click)="showPartnerForm()"\r
            *ngIf="!showAddPartnerForm()"\r
          >\r
            ...
            {{ translate('travel.add_partner') }}\r
          </button>\r
        </div>\r
\r
        <!-- Add/Edit Partner Form -->\r
        <div class="partner-form-container" *ngIf="showAddPartnerForm()">\r
          <div class="partner-form-header">\r
            <h4>{{ editingPartnerIndex() !== null ? translate('travel.edit_partner') : translate('travel.add_partner') }}</h4>\r
          </div>\r
          <div class="partner-form-fields">\r
            <div class="form-group-inline">\r
              <label class="form-label-small">{{ translate('travel.partner_name') }} <span class="text-danger">*</span></label>\r
              <input\r
                type="text"\r
                class="form-input-small"\r
                [formControl]="$any(partnerForm.get('name'))"\r
                [class.error]="partnerForm.get('name')?.invalid && partnerForm.get('name')?.touched"\r
                placeholder="{{ translate('travel.partner_name_placeholder') }}"\r
              />\r
              <div class="error-message-small" *ngIf="getPartnerFieldError('name')">\r
                {{ getPartnerFieldError('name') }}\r
              </div>\r
            </div>\r
\r
            <div class="form-group-inline">\r
              <label class="form-label-small">{{ translate('travel.partner_email') }} </label>\r
              <input\r
                type="text"\r
                class="form-input-small"\r
                [formControl]="$any(partnerForm.get('email'))"\r
                [class.error]="partnerForm.get('email')?.invalid && partnerForm.get('email')?.touched"\r
                placeholder="{{ translate('travel.partner_email_placeholder') }}"\r
              />\r
              <div class="error-message-small" *ngIf="getPartnerFieldError('email')">\r
                {{ getPartnerFieldError('email') }}\r
              </div>\r
            </div>\r
\r
            <div class="form-group-inline">\r
              <label class="form-label-small">{{ translate('travel.partner_job_title') }} </label>\r
              <input\r
                type="text"\r
                class="form-input-small"\r
                [formControl]="$any(partnerForm.get('jobTitle'))"\r
                [class.error]="partnerForm.get('jobTitle')?.invalid && partnerForm.get('jobTitle')?.touched"\r
                placeholder="{{ translate('travel.partner_job_title_placeholder') }}"\r
              />\r
              <div class="error-message-small" *ngIf="getPartnerFieldError('jobTitle')">\r
                {{ getPartnerFieldError('jobTitle') }}\r
              </div>\r
            </div>\r
          </div>\r
          <div class="partner-form-actions">\r
            <button type="button" class="btn-save-partner" (click)="addPartner()">\r
              {{ editingPartnerIndex() !== null ? translate('common.save') : translate('common.add') }}\r
            </button>\r
            <button type="button" class="btn-cancel-partner" (click)="hidePartnerForm()">\r
...
\r
        <!-- Partners List -->\r
        <div class="partners-list-container" *ngIf="partners().length > 0">\r
          <div class="partner-item" *ngFor="let partner of partners(); let i = index">\r
            <div class="partner-item-content">\r
              <div class="partner-item-name">{{ partner.name }}</div>\r
              <div class="partner-item-details">\r
                <span class="partner-item-email">{{ partner.email }}</span>\r
                <span class="partner-item-divider">\u2022</span>\r
                <span class="partner-item-job">{{ partner.jobTitle }}</span>\r
              </div>\r
            </div>\r
            <div class="partner-item-actions">\r
              <button \r
                type="button" \r
                class="btn-edit-partner" \r
                (click)="editPartner(i)"\r
                [attr.aria-label]="translate('common.edit')"\r
              >\r
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
              ...
              <button \r
                type="button" \r
                class="btn-delete-partner" \r
                (click)="removePartner(i)"\r
                [attr.aria-label]="translate('common.delete')"\r
              >\r
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
                  <line x1="18" y1="6" x2="6" y2="18"></line>\r
                  <line x1="6" y1="6" x2="18" y2="18"></line>\r
...
function EditTravelModalComponent_button_51_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 41);
    \u0275\u0275listener("click", function EditTravelModalComponent_button_51_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.showPartnerForm());
    });
...
function EditTravelModalComponent_div_52_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function EditTravelModalComponent_div_52_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EditTravelModalComponent_div_52_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EditTravelModalComponent_div_52_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 45)(1, "div", 46)(2, "h4");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 47)(5, "div", 48)(6, "label", 49);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "input", 50);
    \u0275\u0275template(9, EditTravelModalComponent_div_52_div_9_Template, 2, 1, "div", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 48)(11, "label", 49);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275element(13, "input", 52);
    \u0275\u0275template(14, EditTravelModalComponent_div_52_div_14_Template, 2, 1, "div", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 48)(16, "label", 49);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "input", 50);
    \u0275\u0275template(19, EditTravelModalComponent_div_52_div_19_Template, 2, 1, "div", 51);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div", 53)(21, "button", 54);
    \u0275\u0275listener("click", function EditTravelModalComponent_div_52_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.addPartner());
    });
    ...
    \u0275\u0275listener("click", function EditTravelModalComponent_div_52_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.hidePartnerForm());
    });
...
function EditTravelModalComponent_div_53_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "div", 66)(12, "button", 67);
    \u0275\u0275listener("click", function EditTravelModalComponent_div_53_div_1_Template_button_click_12_listener() {
      const i_r6 = \u0275\u0275restoreView(_r5).index;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.editPartner(i_r6));
    });
    ...
    \u0275\u0275element(14, "path", 68)(15, "path", 69);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(16, "button", 70);
    \u0275\u0275listener("click", function EditTravelModalComponent_div_53_div_1_Template_button_click_16_listener() {
      const i_r6 = \u0275\u0275restoreView(_r5).index;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.removePartner(i_r6));
    });
...
function EditTravelModalComponent_div_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 57);
    \u0275\u0275template(1, EditTravelModalComponent_div_53_div_1_Template, 20, 5, "div", 58);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function EditTravelModalComponent_div_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function EditTravelModalComponent_div_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 71);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(1, "svg", 72);
    \u0275\u0275element(2, "circle", 73)(3, "line", 74)(4, "line", 75);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  }
...
function EditTravelModalComponent_div_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 76);
  }
}
var EditTravelModalComponent = class _EditTravelModalComponent {
  ...
  constructor(fb, travelService, translationService) {
    ...
    this.travelForm = this.fb.group({
      ...
      endDate: ["", [Validators.required]],
      transportMode: ["Air"],
      accommodation: ["", [Validators.minLength(2), Validators.maxLength(100)]],
      isCompleted: [false]
    });
    this.partnerForm = this.fb.group({
      name: [""],
  ...
  ngOnInit() {
    this.initializeForm();
    if (this.travel.partners && this.travel.partners.length > 0) {
      this.partners.set([...this.travel.partners]);
    }
  }
  initializeForm() {
      ...
      this.travelService.updateTravel(this.travel.id, travelData).subscribe({
        ...
        error: (error) => {
          ...
          if (error.error?.errors) {
            ...
            this.errorMessage.set(errorMessages.join(", ") || this.translate("travel.update_error"));
          } else if (error.error?.message) {
            this.errorMessage.set(error.error.message);
          } else {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditTravelModalComponent, selectors: [["app-edit-travel-modal"]], inputs: { travel: "travel", isRTL: "isRTL" }, outputs: { close: "close", travelUpdated: "travelUpdated" }, standalone: false, decls: 66, vars: 53, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click", "dir"], [1, "modal-header"], [1, "modal-title"], [1, "close-btn", 3, "click"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "travel-form", 3, "ngSubmit", "formGroup"], [1, "form-group"], ["for", "title", 1, "form-label"], ["type", "text", "id", "title", "formControlName", "title", 1, "form-input", 3, "placeholder"], ["class", "error-message", 4, "ngIf"], ["for", "destination", 1, "form-label"], ["type", "text", "id", "destination", "formControlName", "destination", 1, "form-input", 3, "placeholder"], ["for", "purpose", 1, "form-label"], ["id", "purpose", "formControlName", "purpose", "rows", "3", 1, "form-textarea", 3, "placeholder"], [1, "form-row"], ["for", "endDate", 1, "form-label"], ["type", "datetime-local", "id", "endDate", "formControlName", "endDate", 1, "form-input"], ["for", "startDate", 1, "form-label"], ["type", "datetime-local", "id", "startDate", "formControlName", "startDate", 1, "form-input"], ["for", "transportMode", 1, "form-label"], ["id", "transportMode", "formControlName", "transportMode", 1, "form-select"], [3, "value", 4, "ngFor", "ngForOf"], ["for", "accommodation", 1, "form-label"], ["id", "accommodation", "formControlName", "accommodation", "rows", "2", 1, "form-textarea", 3, "placeholder"], [1, "partners-header"], [1, "form-label"], ["type", "button", "class", "btn-add-partner", 3, "click", 4, "ngIf"], ["class", "partner-form-container", 4, "ngIf"], ["class", "partners-list-container", 4, "ngIf"], ["for", "isCompleted", 1, "form-label"], ["type", "checkbox", "id", "isCompleted", "formControlName", "isCompleted", 1, "form-checkbox"], ["class", "error-alert", 4, "ngIf"], [1, "form-actions"], ["type", "button", 1, "btn-secondary", 3, "click"], ["type", "submit", 1, "btn-primary", 3, "disabled"], ["class", "spinner", 4, "ngIf"], [1, "error-message"], [3, "value"], ["type", "button", 1, "btn-add-partner", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "partner-form-container"], [1, "partner-form-header"], [1, "partner-form-fields"], [1, "form-group-inline"], [1, "form-label-small"], ["type", "text", 1, "form-input-small", 3, "formControl", "placeholder"], ["class", "error-message-small", 4, "ngIf"], ["type", "email", 1, "form-input-small", 3, "formControl", "placeholder"], [1, "partner-form-actions"], ["type", "button", 1, "btn-save-partner", 3, "click"], ["type", "button", 1, "btn-cancel-partner", 3, "click"], [1, "error-message-small"], [1, "partners-list-container"], ["class", "partner-item", 4, "ngFor", "ngForOf"], [1, "partner-item"], [1, "partner-item-content"], [1, "partner-item-name"], [1, "partner-item-details"], [1, "partner-item-email"], [1, "partner-item-divider"], [1, "partner-item-job"], [1, "partner-item-actions"], ["type", "button", 1, "btn-edit-partner", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], ["type", "button", 1, "btn-delete-partner", 3, "click"], [1, "error-alert"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "15", "y1", "9", "x2", "9", "y2", "15"], ["x1", "9", "y1", "9", "x2", "15", "y2", "15"], [1, "spinner"]], template: function EditTravelModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      ...
      \u0275\u0275text(50);
      \u0275\u0275elementEnd();
      \u0275\u0275template(51, EditTravelModalComponent_button_51_Template, 5, 1, "button", 29);
      \u0275\u0275elementEnd();
      \u0275\u0275template(52, EditTravelModalComponent_div_52_Template, 25, 24, "div", 30)(53, EditTravelModalComponent_div_53_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(54, "div", 9)(55, "label", 32);
      \u0275\u0275text(56);
      \u0275\u0275elementEnd();
      \u0275\u0275element(57, "input", 33);
      \u0275\u0275template(58, EditTravelModalComponent_div_58_Template, 2, 1, "div", 12);
      \u0275\u0275elementEnd();
      \u0275\u0275template(59, EditTravelModalComponent_div_59_Template, 6, 1, "div", 34);
      \u0275\u0275elementStart(60, "div", 35)(61, "button", 36);
      \u0275\u0275listener("click", function EditTravelModalComponent_Template_button_click_61_listener() {
        return ctx.closeModal();
      });
      \u0275\u0275text(62);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(63, "button", 37);
      \u0275\u0275template(64, EditTravelModalComponent_div_64_Template, 1, 0, "div", 38);
      \u0275\u0275text(65);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
  ...
  }, dependencies: [NgForOf, NgIf, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, CheckboxControlValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, FormControlDirective, FormGroupDirective, FormControlName], styles: ["\n\n.modal-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 1000;\n  padding: 1rem;\n}\n.modal-content[_ngcontent-%COMP%] {\n  background: white;\n  border-radius: 0.5rem;\n  max-width: 600px;\n  width: 100%;\n  max-height: 90vh;\n  overflow-y: auto;\n  box-shadow: 0 10px 25px rgba(0, 0, 0, 0.15);\n  animation: _ngcontent-%COMP%_modalSlideIn 0.3s ease-out;\n}\n@keyframes _ngcontent-%COMP%_modalSlideIn {\n  from {\n    opacity: 0;\n    transform: translateY(-20px);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n.modal-header[_ngcontent-%COMP%] {\n  position: relative;\n  display: flex;\n  align-items: center;\n  padding: 1.5rem 2rem;\n  border-bottom: 1px solid #E6D7A2;\n  background: #D4AF5F;\n  color: #5F646D;\n  min-height: 40px;\n}\n.modal-title[_ngcontent-%COMP%] {\n  font-size: 1.5rem;\n  font-weight: 600;\n  color: #5F646D;\n  margin: 0;\n  flex: 1;\n}\n[dir=ltr][_ngcontent-%COMP%]   .modal-title[_ngcontent-%COMP%] {\n  text-align: left;\n}\n[dir=rtl][_ngcontent-%COMP%]   .modal-title[_ngcontent-%COMP%] {\n  text-align: right;\n}\n.close-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  background: none;\n  border: none;\n  color: #5F646D;\n  cursor: pointer;\n  padding: 0.5rem;\n  border-radius: 0.375rem;\n  transition: background-color 0.2s ease, color 0.2s ease;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  top: 50%;\n  transform: translateY(-50%);\n}\n[dir=ltr][_ngcontent-%COMP%]   .close-btn[_ngcontent-%COMP%] {\n  right: 0;\n}\n[dir=rtl][_ngcontent-%COMP%]   .close-btn[_ngcontent-%COMP%] {\n  left: 0;\n}\n.close-btn[_ngcontent-%COMP%]:hover {\n  background-color: rgba(95, 100, 109, 0.1);\n  color: #5F646D;\n}\n.travel-form[_ngcontent-%COMP%] {\n  padding: 2rem;\n}\n.form-group[_ngcontent-%COMP%] {\n  margin-bottom: 1.5rem;\n}\n.form-checkbox[_ngcontent-%COMP%] {\n  width: 18px;\n  height: 18px;\n  margin-right: 0.5rem;\n  accent-color: #B68A35;\n  cursor: pointer;\n}\n.form-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  font-weight: 500;\n  color: #374151;\n}\n.form-row[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 1rem;\n}\n.form-label[_ngcontent-%COMP%] {\n  display: block;\n  font-weight: 600;\n  color: #5F646D;\n  margin-bottom: 0.5rem;\n  font-size: 0.875rem;\n}\n.form-input[_ngcontent-%COMP%], \n.form-select[_ngcontent-%COMP%], \n.form-textarea[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0.75rem 1rem;\n  border: 2px solid #e5e7eb;\n  border-radius: 8px;\n  font-size: 0.875rem;\n  transition: all 0.3s ease;\n  background: white;\n  color: #1f2937;\n}\n.form-input[_ngcontent-%COMP%]:focus, \n.form-select[_ngcontent-%COMP%]:focus, \n.form-textarea[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: #B68A35;\n  box-shadow: 0 0 0 3px rgba(212, 170, 58, 0.1);\n}\n.form-input.error[_ngcontent-%COMP%], \n.form-select.error[_ngcontent-%COMP%], \n.form-textarea.error[_ngcontent-%COMP%] {\n  border-color: #ef4444;\n  box-shadow: 0 0 0 3px rgba(239, 68, 68, 0.1);\n}\n.form-textarea[_ngcontent-%COMP%] {\n  resize: vertical;\n  min-height: 80px;\n}\n.form-select[_ngcontent-%COMP%] {\n  cursor: pointer;\n}\n.error-message[_ngcontent-%COMP%] {\n  color: #ef4444;\n  font-size: 0.75rem;\n  margin-top: 0.25rem;\n  display: flex;\n  align-items: center;\n  gap: 0.25rem;\n}\n.error-alert[_ngcontent-%COMP%] {\n  background: #fef2f2;\n  border: 1px solid #fecaca;\n  color: #dc2626;\n  padding: 1rem;\n  border-radius: 8px;\n  margin-bottom: 1.5rem;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-size: 0.875rem;\n}\n.form-actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 1rem;\n  margin-top: 2rem;\n  padding-top: 1.5rem;\n  border-top: 1px solid #e5e7eb;\n}\n.btn-primary[_ngcontent-%COMP%], \n.btn-secondary[_ngcontent-%COMP%] {\n  padding: 0.75rem 1.5rem;\n  border-radius: 8px;\n  font-weight: 600;\n  font-size: 0.875rem;\n  cursor: pointer;\n  transition: all 0.3s ease;\n  border: none;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.btn-primary[_ngcontent-%COMP%] {\n  background-color: #B68A35;\n  color: #FFFFFF;\n  box-shadow: 0 4px 12px rgba(212, 170, 58, 0.3);\n}\n.btn-primary[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background-color: #A87D2A;\n  box-shadow: 0 4px 12px rgba(212, 170, 58, 0.3);\n}\n.btn-primary[_ngcontent-%COMP%]:disabled {\n  opacity: 0.7;\n  cursor: not-allowed;\n  transform: none;\n}\n.btn-secondary[_ngcontent-%COMP%] {\n  background-color: transparent;\n  color: #1B1D21 !important;\n  border: 1px solid #1B1D21 !important;\n}\n.btn-secondary[_ngcontent-%COMP%]:hover {\n  background-color: #1B1D21;\n  color: #FFFFFF !important;\n}\n.spinner[_ngcontent-%COMP%] {\n  width: 16px;\n  height: 16px;\n  border: 2px solid transparent;\n  border-top: 2px solid currentColor;\n  border-radius: 50%;\n  animation: _ngcontent-%COMP%_spin 1s linear infinite;\n}\n@keyframes _ngcontent-%COMP%_spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.modal-content.rtl[_ngcontent-%COMP%] {\n  direction: rtl;\n  text-align: right;\n}\n.modal-content.rtl[_ngcontent-%COMP%]   .form-actions[_ngcontent-%COMP%] {\n  justify-content: flex-start;\n}\n.modal-content.rtl[_ngcontent-%COMP%]   .form-row[_ngcontent-%COMP%] {\n  direction: ltr;\n}\n.partners-header[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 1rem;\n}\n.btn-add-partner[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  padding: 0.5rem 1rem;\n  background: #B68A35;\n  color: white;\n  border: none;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  font-weight: 600;\n  cursor: pointer;\n  transition: all 0.2s ease;\n}\n.btn-add-partner[_ngcontent-%COMP%]:hover {\n  background: #A87D2A;\n  transform: translateY(-1px);\n  box-shadow: 0 2px 4px rgba(182, 138, 53, 0.2);\n}\n.partner-form-container[_ngcontent-%COMP%] {\n  background: #f9fafb;\n  border: 1px solid #e5e7eb;\n  border-radius: 8px;\n  padding: 1.25rem;\n  margin-bottom: 1rem;\n}\n.partner-form-header[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%] {\n  margin: 0 0 1rem 0;\n  font-size: 0.9375rem;\n  font-weight: 600;\n  color: #1f2937;\n}\n.partner-form-fields[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n}\n.form-group-inline[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n}\n.form-label-small[_ngcontent-%COMP%] {\n  font-size: 0.8125rem;\n  font-weight: 600;\n  color: #374151;\n}\n.form-input-small[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0.625rem 0.875rem;\n  border: 1px solid #d1d5db;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  transition: all 0.2s ease;\n}\n.form-input-small[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: #B68A35;\n  box-shadow: 0 0 0 3px rgba(182, 138, 53, 0.1);\n}\n.form-input-small.error[_ngcontent-%COMP%] {\n  border-color: #ef4444;\n}\n.error-message-small[_ngcontent-%COMP%] {\n  color: #ef4444;\n  font-size: 0.75rem;\n  margin-top: -0.25rem;\n}\n.partner-form-actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 0.75rem;\n  margin-top: 1rem;\n}\n.btn-save-partner[_ngcontent-%COMP%], \n.btn-cancel-partner[_ngcontent-%COMP%] {\n  padding: 0.625rem 1.25rem;\n  border-radius: 6px;\n  font-size: 0.875rem;\n  font-weight: 600;\n  cursor: pointer;\n  transition: all 0.2s ease;\n  border: none;\n}\n.btn-save-partner[_ngcontent-%COMP%] {\n  background: #B68A35;\n  color: white;\n}\n.btn-save-partner[_ngcontent-%COMP%]:hover {\n  background: #A87D2A;\n}\n.btn-cancel-partner[_ngcontent-%COMP%] {\n  background: transparent;\n  color: #6b7280;\n  border: 1px solid #d1d5db;\n}\n.btn-cancel-partner[_ngcontent-%COMP%]:hover {\n  background: #f3f4f6;\n}\n.partners-list-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n}\n.partner-item[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0.875rem 1rem;\n  background: white;\n  border: 1px solid #e5e7eb;\n  border-radius: 8px;\n  transition: all 0.2s ease;\n}\n.partner-item[_ngcontent-%COMP%]:hover {\n  border-color: #B68A35;\n  box-shadow: 0 2px 4px rgba(182, 138, 53, 0.1);\n}\n.partner-item-content[_ngcontent-%COMP%] {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  gap: 0.25rem;\n}\n.partner-item-name[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: #1f2937;\n  font-size: 0.9375rem;\n}\n.partner-item-details[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-size: 0.8125rem;\n  color: #6b7280;\n}\n.partner-item-email[_ngcontent-%COMP%] {\n  color: #4b5563;\n}\n.partner-item-divider[_ngcontent-%COMP%] {\n  color: #d1d5db;\n}\n.partner-item-job[_ngcontent-%COMP%] {\n  color: #6b7280;\n}\n.partner-item-actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 0.5rem;\n}\n.btn-edit-partner[_ngcontent-%COMP%], \n.btn-delete-partner[_ngcontent-%COMP%] {\n  padding: 0.5rem;\n  background: transparent;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  transition: all 0.2s ease;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.btn-edit-partner[_ngcontent-%COMP%] {\n  color: #3b82f6;\n}\n.btn-edit-partner[_ngcontent-%COMP%]:hover {\n  background: #eff6ff;\n}\n.btn-delete-partner[_ngcontent-%COMP%] {\n  color: #ef4444;\n}\n.btn-delete-partner[_ngcontent-%COMP%]:hover {\n  background: #fef2f2;\n}\n@media (max-width: 768px) {\n  .modal-content[_ngcontent-%COMP%] {\n    max-height: 90vh;\n    width: 100%;\n  }\n  .modal-header[_ngcontent-%COMP%] {\n    padding: 1rem 1.5rem;\n  }\n  .travel-form[_ngcontent-%COMP%] {\n    padding: 1.5rem;\n  }\n  .form-row[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n  }\n  .form-actions[_ngcontent-%COMP%] {\n    flex-direction: column-reverse;\n  }\n  .btn-primary[_ngcontent-%COMP%], \n   .btn-secondary[_ngcontent-%COMP%] {\n    width: 100%;\n    justify-content: center;\n  }\n  .partners-header[_ngcontent-%COMP%] {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 0.75rem;\n  }\n  .btn-add-partner[_ngcontent-%COMP%] {\n    width: 100%;\n    justify-content: center;\n  }\n  .partner-form-container[_ngcontent-%COMP%] {\n    padding: 1rem;\n  }\n  .partner-form-actions[_ngcontent-%COMP%] {\n    flex-direction: column;\n  }\n  .btn-save-partner[_ngcontent-%COMP%], \n   .btn-cancel-partner[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n  .partner-item[_ngcontent-%COMP%] {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 0.75rem;\n  }\n  .partner-item-actions[_ngcontent-%COMP%] {\n    width: 100%;\n    justify-content: flex-end;\n  }\n}\n/*# sourceMappingURL=edit-travel-modal.component-SOIQNUNO.css.map */"] });
};
(() => {
...
\r
        ...
        <div class="partner-form-container" *ngIf="showAddPartnerForm()">\r
          ...
          <div class="partner-form-fields">\r
            <div class="form-group-inline">\r
              <label class="form-label-small">{{ translate('travel.partner_name') }} </label>\r
              <input\r
                type="text"\r
                class="form-input-small"\r
                [formControl]="$any(partnerForm.get('name'))"\r
...
function TravelDetailsModalComponent_div_11_ng_container_105_div_1_div_9_span_5_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const partner_r3 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(partner_r3.jobTitle);
  }
}
function TravelDetailsModalComponent_div_11_ng_container_105_div_1_div_9_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const partner_r3 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" \u2022 ", partner_r3.email);
  }
}
function TravelDetailsModalComponent_div_11_ng_container_105_div_1_div_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 107)(1, "div", 108)(2, "div", 109);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 110);
    \u0275\u0275template(5, TravelDetailsModalComponent_div_11_ng_container_105_div_1_div_9_span_5_Template, 2, 1, "span", 72)(6, TravelDetailsModalComponent_div_11_ng_container_105_div_1_div_9_span_6_Template, 2, 1, "span", 72);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", partner_r3.jobTitle);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", partner_r3.email);
  }
}
function TravelDetailsModalComponent_div_11_ng_container_105_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 100)(1, "div", 57);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 58);
    \u0275\u0275element(3, "path", 101)(4, "circle", 102)(5, "path", 103)(6, "path", 104);
    \u0275\u0275elementEnd();
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(8, "div", 105);
    \u0275\u0275template(9, TravelDetailsModalComponent_div_11_ng_container_105_div_1_div_9_Template, 7, 3, "div", 106);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const travelData_r4 = \u0275\u0275nextContext().ngIf;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("travel.travel_partners"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", travelData_r4.partners);
  }
}
function TravelDetailsModalComponent_div_11_ng_container_105_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, TravelDetailsModalComponent_div_11_ng_container_105_div_1_Template, 10, 2, "div", 99);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const travelData_r4 = ctx.ngIf;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travelData_r4.partners && travelData_r4.partners.length > 0);
  }
}
function TravelDetailsModalComponent_div_11_div_106_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61)(1, "div", 57);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 58);
    \u0275\u0275element(3, "path", 111)(4, "circle", 112);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
...
function TravelDetailsModalComponent_div_11_div_115_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 121);
    \u0275\u0275listener("click", function TravelDetailsModalComponent_div_11_div_115_button_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r5);
...
function TravelDetailsModalComponent_div_11_div_115_div_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 124)(1, "div", 125)(2, "label", 126);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "textarea", 127);
    \u0275\u0275twoWayListener("ngModelChange", function TravelDetailsModalComponent_div_11_div_115_div_9_Template_textarea_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(5, "            ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 128)(7, "button", 129);
    \u0275\u0275listener("click", function TravelDetailsModalComponent_div_11_div_115_div_9_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function TravelDetailsModalComponent_div_11_div_115_div_9_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext(3);
...
function TravelDetailsModalComponent_div_11_div_115_div_10_div_1_span_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const achievement_r8 = \u0275\u0275nextContext().$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", ctx_r0.translate("common.updated_at"), ": ", \u0275\u0275pipeBind2(2, 2, achievement_r8.updatedAt, "medium"), " ");
  }
}
function TravelDetailsModalComponent_div_11_div_115_div_10_div_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 134)(1, "div", 135)(2, "p", 136);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 137)(5, "span", 138);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, TravelDetailsModalComponent_div_11_div_115_div_10_div_1_span_8_Template, 3, 5, "span", 139);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 140)(10, "button", 141);
    \u0275\u0275listener("click", function TravelDetailsModalComponent_div_11_div_115_div_10_div_1_Template_button_click_10_listener() {
      const achievement_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r0.editAchievement(achievement_r8));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(11, "svg", 122);
    \u0275\u0275element(12, "path", 142)(13, "path", 143);
    \u0275\u0275elementEnd();
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(15, "button", 144);
    \u0275\u0275listener("click", function TravelDetailsModalComponent_div_11_div_115_div_10_div_1_Template_button_click_15_listener() {
      const achievement_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r0.deleteAchievement(achievement_r8));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(16, "svg", 122);
    \u0275\u0275element(17, "path", 145);
    \u0275\u0275elementEnd();
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const achievement_r8 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(achievement_r8.achievements);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", ctx_r0.translate("common.created_at"), ":", \u0275\u0275pipeBind2(7, 6, achievement_r8.createdAt, "medium"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", achievement_r8.updatedAt);
    \u0275\u0275advance(6);
...
function TravelDetailsModalComponent_div_11_div_115_div_10_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
function TravelDetailsModalComponent_div_11_div_115_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 131);
    \u0275\u0275template(1, TravelDetailsModalComponent_div_11_div_115_div_10_div_1_Template, 19, 9, "div", 132)(2, TravelDetailsModalComponent_div_11_div_115_div_10_div_2_Template, 5, 1, "div", 133);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function TravelDetailsModalComponent_div_11_div_115_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function TravelDetailsModalComponent_div_11_div_115_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 113)(1, "div", 114)(2, "h3", 115);
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, TravelDetailsModalComponent_div_11_div_115_button_6_Template, 4, 1, "button", 116);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(7, "p", 117);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, TravelDetailsModalComponent_div_11_div_115_div_9_Template, 11, 6, "div", 118)(10, TravelDetailsModalComponent_div_11_div_115_div_10_Template, 3, 2, "div", 119)(11, TravelDetailsModalComponent_div_11_div_115_div_11_Template, 4, 1, "div", 120);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function TravelDetailsModalComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(104);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(105, TravelDetailsModalComponent_div_11_ng_container_105_Template, 2, 1, "ng-container", 72)(106, TravelDetailsModalComponent_div_11_div_106_Template, 8, 2, "div", 73);
    \u0275\u0275elementStart(107, "div", 61)(108, "div", 57);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(109, "svg", 58);
    \u0275\u0275element(110, "circle", 18)(111, "polyline", 74);
    \u0275\u0275elementEnd();
    \u0275\u0275text(112);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275text(114);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(115, TravelDetailsModalComponent_div_11_div_115_Template, 12, 6, "div", 75);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !((tmp_23_0 = ctx_r0.travel()) == null ? null : tmp_23_0.transportMode) || !\u0275\u0275pureFunction0(68, _c0).includes(((tmp_23_0 = ctx_r0.travel()) == null ? null : tmp_23_0.transportMode) || ""));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !((tmp_58_0 = ctx_r0.travel()) == null ? null : tmp_58_0.transportMode) || !\u0275\u0275pureFunction0(69, _c0).includes(((tmp_58_0 = ctx_r0.travel()) == null ? null : tmp_58_0.transportMode) || ""));
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.travel());
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_63_0 = ctx_r0.travel()) == null ? null : tmp_63_0.createdByUserName);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("common.created_at"), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.formatDateTime(((tmp_65_0 = ctx_r0.travel()) == null ? null : tmp_65_0.createdAt) || ""));
    \u0275\u0275advance();
...
function TravelDetailsModalComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 151)(1, "button", 152);
...
var TravelDetailsModalComponent = class _TravelDetailsModalComponent {
  ...
  getTransportModeLabel(mode) {
    if (!mode)
      return "";
    const validModes = ["air", "train", "bus", "car", "ship"];
    const modeLower = mode.toLowerCase();
    if (validModes.includes(modeLower)) {
      return this.translate(`travel.transport_modes.${modeLower}`);
    }
    return mode;
  }
  loadAchievements() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TravelDetailsModalComponent, selectors: [["app-travel-details-modal"]], inputs: { travelId: "travelId", isRTL: "isRTL" }, outputs: { close: "close" }, standalone: false, decls: 14, vars: 11, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "close-btn", 3, "click"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], ["class", "loading-state", 4, "ngIf"], ["class", "error-state", 4, "ngIf"], ["class", "modal-body", 4, "ngIf"], ["class", "modal-footer", 4, "ngIf"], [3, "confirm", "cancel", "data", "isVisible", "isRTL"], [1, "loading-state"], [1, "spinner"], [1, "error-state"], [1, "error-icon"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "15", "y1", "9", "x2", "9", "y2", "15"], ["x1", "9", "y1", "9", "x2", "15", "y2", "15"], [1, "retry-btn", 3, "click"], [1, "modal-body"], [1, "travel-details"], [1, "travel-header"], [1, "travel-icon-large"], ["width", "32", "height", "32", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "transport-icon"], ["d", "M2 22h20", 4, "ngIf"], ["d", "M6.36 17.4 4 17l-2-4 1.1-.55a2 2 0 0 1 1.8 0l.17.1a2 2 0 0 0 1.8 0L8 12 5 6l.9-.45a2 2 0 0 1 2.09.2l4.02 3a2 2 0 0 0 2.1.2l4.19-2.06a2.41 2.41 0 0 1 1.73-.17L21 7a1.4 1.4 0 0 1 .87 1.99l-.38.76c-.23.46-.6.84-1.07 1.08L7.58 17.2a2 2 0 0 1-1.22.18Z", 4, "ngIf"], ["d", "M8 3.1V7a4 4 0 0 0 8 0V3.1", 4, "ngIf"], ["d", "m9 15-1-1", 4, "ngIf"], ["d", "m15 15 1-1", 4, "ngIf"], ["d", "M9 19c-2.8 0-5-2.2-5-5v-4a8 8 0 0 1 16 0v4c0 2.8-2.2 5-5 5Z", 4, "ngIf"], ["d", "m8 19-2 3", 4, "ngIf"], ["d", "m16 19 2 3", 4, "ngIf"], ["d", "M8 6v6", 4, "ngIf"], ["d", "M15 6v6", 4, "ngIf"], ["d", "M2 12h19.6", 4, "ngIf"], ["d", "M18 18h3s.5-1.7.8-2.8c.1-.4.2-.8.2-1.2 0-.4-.1-.8-.2-1.2l-1.4-5C20.1 6.8 19.1 6 18 6H4a2 2 0 0 0-2 2v10h3", 4, "ngIf"], ["cx", "7", "cy", "18", "r", "2", 4, "ngIf"], ["d", "M9 18h5", 4, "ngIf"], ["cx", "16", "cy", "18", "r", "2", 4, "ngIf"], ["d", "M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2", 4, "ngIf"], ["cx", "7", "cy", "17", "r", "2", 4, "ngIf"], ["d", "M9 17h6", 4, "ngIf"], ["cx", "17", "cy", "17", "r", "2", 4, "ngIf"], ["d", "M10 2v15", 4, "ngIf"], ["d", "M7 22a4 4 0 0 1-4-4 1 1 0 0 1 1-1h16a1 1 0 0 1 1 1 4 4 0 0 1-4 4z", 4, "ngIf"], ["d", "M9.159 2.46a1 1 0 0 1 1.521-.193l9.977 8.98A1 1 0 0 1 20 13H4a1 1 0 0 1-.824-1.567z", 4, "ngIf"], ["d", "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z", 4, "ngIf"], [1, "travel-info"], [1, "travel-title"], [1, "travel-destination"], [1, "detail-value"], [1, "status-badge", "mt-2"], [1, "details-grid"], [1, "detail-item", "purpose-item"], [1, "detail-label"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "detail-value", "purpose-text"], [1, "detail-item"], ["x", "3", "y", "4", "width", "18", "height", "18", "rx", "2", "ry", "2"], ["x1", "16", "y1", "2", "x2", "16", "y2", "6"], ["x1", "8", "y1", "2", "x2", "8", "y2", "6"], ["x1", "3", "y1", "10", "x2", "21", "y2", "10"], ["d", "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"], ["cx", "12", "cy", "10", "r", "3"], [1, "transport-badge"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"], ["points", "9,22 9,12 15,12 15,22"], [4, "ngIf"], ["class", "detail-item", 4, "ngIf"], ["points", "12,6 12,12 16,14"], ["class", "achievements-section mt-4 rounded-3", 4, "ngIf"], ["d", "M2 22h20"], ["d", "M6.36 17.4 4 17l-2-4 1.1-.55a2 2 0 0 1 1.8 0l.17.1a2 2 0 0 0 1.8 0L8 12 5 6l.9-.45a2 2 0 0 1 2.09.2l4.02 3a2 2 0 0 0 2.1.2l4.19-2.06a2.41 2.41 0 0 1 1.73-.17L21 7a1.4 1.4 0 0 1 .87 1.99l-.38.76c-.23.46-.6.84-1.07 1.08L7.58 17.2a2 2 0 0 1-1.22.18Z"], ["d", "M8 3.1V7a4 4 0 0 0 8 0V3.1"], ["d", "m9 15-1-1"], ["d", "m15 15 1-1"], ["d", "M9 19c-2.8 0-5-2.2-5-5v-4a8 8 0 0 1 16 0v4c0 2.8-2.2 5-5 5Z"], ["d", "m8 19-2 3"], ["d", "m16 19 2 3"], ["d", "M8 6v6"], ["d", "M15 6v6"], ["d", "M2 12h19.6"], ["d", "M18 18h3s.5-1.7.8-2.8c.1-.4.2-.8.2-1.2 0-.4-.1-.8-.2-1.2l-1.4-5C20.1 6.8 19.1 6 18 6H4a2 2 0 0 0-2 2v10h3"], ["cx", "7", "cy", "18", "r", "2"], ["d", "M9 18h5"], ["cx", "16", "cy", "18", "r", "2"], ["d", "M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"], ["cx", "7", "cy", "17", "r", "2"], ["d", "M9 17h6"], ["cx", "17", "cy", "17", "r", "2"], ["d", "M10 2v15"], ["d", "M7 22a4 4 0 0 1-4-4 1 1 0 0 1 1-1h16a1 1 0 0 1 1 1 4 4 0 0 1-4 4z"], ["d", "M9.159 2.46a1 1 0 0 1 1.521-.193l9.977 8.98A1 1 0 0 1 20 13H4a1 1 0 0 1-.824-1.567z"], ["d", "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"], ["class", "detail-item full-width", 4, "ngIf"], [1, "detail-item", "full-width"], ["d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 0 0-3-3.87"], ["d", "M16 3.13a4 4 0 0 1 0 7.75"], [1, "partners-list"], ["class", "partner-badge", 4, "ngFor", "ngForOf"], [1, "partner-badge"], [1, "partner-badge-content"], [1, "partner-badge-name"], [1, "partner-badge-details"], ["d", "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"], ["cx", "12", "cy", "7", "r", "4"], [1, "achievements-section", "mt-4", "rounded-3"], [1, "achievements-header"], [1, "achievements-title"], ["class", "add-achievement-btn", 3, "click", 4, "ngIf"], [1, "achievements-description"], ["class", "achievement-form", 4, "ngIf"], ["class", "achievements-list", 4, "ngIf"], ["class", "achievements-loading", 4, "ngIf"], [1, "add-achievement-btn", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M12 5v14m-7-7h14"], [1, "achievement-form"], [1, "form-group"], [1, "form-label"], ["rows", "4", 1, "form-textarea", 3, "ngModelChange", "ngModel", "placeholder"], [1, "form-actions"], [1, "save-btn", 3, "click", "disabled"], [1, "cancel-btn", 3, "click"], [1, "achievements-list"], ["class", "achievement-item", 4, "ngFor", "ngForOf"], ["class", "no-achievements", 4, "ngIf"], [1, "achievement-item"], [1, "achievement-content"], [1, "achievement-text"], [1, "achievement-meta"], [1, "achievement-date"], ["class", "achievement-updated", 4, "ngIf"], [1, "achievement-actions"], [1, "edit-achievement-btn", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], [1, "delete-achievement-btn", 3, "click"], ["d", "M3 6h18m-2 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"], [1, "achievement-updated"], [1, "no-achievements"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], [1, "achievements-loading"], [1, "loading-spinner"], [1, "modal-footer"], [1, "close-button", 3, "click"]], template: function TravelDetailsModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(7, "line", 6)(8, "line", 7);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(9, TravelDetailsModalComponent_div_9_Template, 4, 1, "div", 8)(10, TravelDetailsModalComponent_div_10_Template, 12, 3, "div", 9)(11, TravelDetailsModalComponent_div_11_Template, 116, 70, "div", 10)(12, TravelDetailsModalComponent_div_12_Template, 3, 1, "div", 11);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
...
\r
          <!-- Travel Partners -->\r
          <ng-container *ngIf="travel() as travelData">\r
            <div class="detail-item full-width" *ngIf="travelData.partners && travelData.partners.length > 0">\r
              <div class="detail-label">\r
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
                ...
                {{ translate("travel.travel_partners") }}\r
              </div>\r
              <div class="partners-list">\r
                <div class="partner-badge" *ngFor="let partner of travelData.partners">\r
                  <div class="partner-badge-content">\r
                    <div class="partner-badge-name">{{ partner.name }}</div>\r
                    <div class="partner-badge-details">\r
                      <span *ngIf="partner.jobTitle">{{ partner.jobTitle }}</span>\r
                      <span *ngIf="partner.email"> \u2022 {{ partner.email }}</span>\r
                    </div>\r
                  </div>\r
                </div>\r
              </div>\r
...
var _c02 = () => ["Air", "Train", "Bus", "Car", "Ship"];
function TravelListComponent_small_42_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("travel.to_date_before_from_date_error"), " ");
  }
}
function TravelListComponent_button_43_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("title", \u0275\u0275interpolate(ctx_r0.translate("travel.clear_filters_tooltip")));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("common.reset"), " ");
  }
}
...
function TravelListComponent_div_45_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.no_travels_found"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.get_started_message"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("travel.add_travel"), " ");
  }
}
function TravelListComponent_div_46_div_1__svg_path_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 111);
  }
}
function TravelListComponent_div_46_div_1__svg_path_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 112);
  }
}
function TravelListComponent_div_46_div_1__svg_path_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 113);
  }
}
function TravelListComponent_div_46_div_1__svg_path_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 114);
  }
}
function TravelListComponent_div_46_div_1__svg_path_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 115);
  }
}
function TravelListComponent_div_46_div_1__svg_path_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 116);
  }
}
function TravelListComponent_div_46_div_1__svg_path_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 117);
  }
}
function TravelListComponent_div_46_div_1__svg_path_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 118);
  }
}
function TravelListComponent_div_46_div_1__svg_path_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 119);
  }
}
function TravelListComponent_div_46_div_1__svg_path_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 120);
  }
}
function TravelListComponent_div_46_div_1__svg_path_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 121);
  }
}
function TravelListComponent_div_46_div_1__svg_path_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 122);
  }
}
function TravelListComponent_div_46_div_1__svg_circle_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 123);
  }
}
function TravelListComponent_div_46_div_1__svg_path_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 124);
  }
}
function TravelListComponent_div_46_div_1__svg_circle_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 125);
  }
}
function TravelListComponent_div_46_div_1__svg_path_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 126);
  }
}
function TravelListComponent_div_46_div_1__svg_circle_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 127);
  }
}
function TravelListComponent_div_46_div_1__svg_path_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 128);
  }
}
function TravelListComponent_div_46_div_1__svg_circle_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 129);
  }
}
function TravelListComponent_div_46_div_1__svg_path_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 130);
  }
}
function TravelListComponent_div_46_div_1__svg_path_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 131);
  }
}
function TravelListComponent_div_46_div_1__svg_path_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 132);
  }
}
function TravelListComponent_div_46_div_1__svg_path_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function TravelListComponent_div_46_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(4, TravelListComponent_div_46_div_1__svg_path_4_Template, 1, 0, "path", 58)(5, TravelListComponent_div_46_div_1__svg_path_5_Template, 1, 0, "path", 59)(6, TravelListComponent_div_46_div_1__svg_path_6_Template, 1, 0, "path", 60)(7, TravelListComponent_div_46_div_1__svg_path_7_Template, 1, 0, "path", 61)(8, TravelListComponent_div_46_div_1__svg_path_8_Template, 1, 0, "path", 62)(9, TravelListComponent_div_46_div_1__svg_path_9_Template, 1, 0, "path", 63)(10, TravelListComponent_div_46_div_1__svg_path_10_Template, 1, 0, "path", 64)(11, TravelListComponent_div_46_div_1__svg_path_11_Template, 1, 0, "path", 65)(12, TravelListComponent_div_46_div_1__svg_path_12_Template, 1, 0, "path", 66)(13, TravelListComponent_div_46_div_1__svg_path_13_Template, 1, 0, "path", 67)(14, TravelListComponent_div_46_div_1__svg_path_14_Template, 1, 0, "path", 68)(15, TravelListComponent_div_46_div_1__svg_path_15_Template, 1, 0, "path", 69)(16, TravelListComponent_div_46_div_1__svg_circle_16_Template, 1, 0, "circle", 70)(17, TravelListComponent_div_46_div_1__svg_path_17_Template, 1, 0, "path", 71)(18, TravelListComponent_div_46_div_1__svg_circle_18_Template, 1, 0, "circle", 72)(19, TravelListComponent_div_46_div_1__svg_path_19_Template, 1, 0, "path", 73)(20, TravelListComponent_div_46_div_1__svg_circle_20_Template, 1, 0, "circle", 74)(21, TravelListComponent_div_46_div_1__svg_path_21_Template, 1, 0, "path", 75)(22, TravelListComponent_div_46_div_1__svg_circle_22_Template, 1, 0, "circle", 76)(23, TravelListComponent_div_46_div_1__svg_path_23_Template, 1, 0, "path", 77)(24, TravelListComponent_div_46_div_1__svg_path_24_Template, 1, 0, "path", 78)(25, TravelListComponent_div_46_div_1__svg_path_25_Template, 1, 0, "path", 79)(26, TravelListComponent_div_46_div_1__svg_path_26_Template, 1, 0, "path", 80);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(27, "span", 81);
    \u0275\u0275text(28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "h3", 82);
    \u0275\u0275text(30);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "p", 83);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(32, "svg", 84);
    \u0275\u0275element(33, "path", 49)(34, "circle", 50);
    \u0275\u0275elementEnd();
    \u0275\u0275text(35);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(36, "div", 85)(37, "div", 86)(38, "div", 87);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(39, "svg", 25);
    \u0275\u0275element(40, "rect", 88)(41, "line", 89)(42, "line", 90)(43, "line", 91);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(44, "div", 92)(45, "span", 93);
    \u0275\u0275text(46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "span", 94);
    \u0275\u0275text(48);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(49, "div", 86)(50, "div", 87);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(51, "svg", 25);
    \u0275\u0275element(52, "rect", 88)(53, "line", 89)(54, "line", 90)(55, "line", 91);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(56, "div", 92)(57, "span", 93);
    \u0275\u0275text(58);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "span", 94);
    \u0275\u0275text(60);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(61, "div", 95)(62, "div", 87);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(63, "svg", 25);
    \u0275\u0275element(64, "path", 96)(65, "polyline", 97);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(66, "div", 92)(67, "span", 93);
    \u0275\u0275text(68);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "span", 94);
    \u0275\u0275text(70);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(71, "div", 95)(72, "div", 87);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(73, "svg", 25);
    \u0275\u0275element(74, "path", 98)(75, "polyline", 99);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(76, "div", 92)(77, "span", 93);
    \u0275\u0275text(78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "span", 94);
    \u0275\u0275text(80);
    \u0275\u0275pipe(81, "slice");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(82, "div", 100)(83, "button", 101);
    \u0275\u0275listener("click", function TravelListComponent_div_46_div_1_Template_button_click_83_listener() {
      const travel_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openDetailsModal(travel_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(84, "svg", 102);
    \u0275\u0275element(85, "path", 103)(86, "circle", 104);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(87, "button", 105);
    \u0275\u0275listener("click", function TravelListComponent_div_46_div_1_Template_button_click_87_listener() {
      const travel_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openEditModal(travel_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(88, "svg", 102);
    \u0275\u0275element(89, "path", 106)(90, "path", 107);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(91, "button", 108);
    \u0275\u0275listener("click", function TravelListComponent_div_46_div_1_Template_button_click_91_listener() {
      const travel_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openDeleteModal(travel_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(92, "svg", 102);
    \u0275\u0275element(93, "polyline", 109)(94, "path", 110);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Air");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Air");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Train");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Train");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Train");
    ...
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Train");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Bus");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Bus");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Bus");
    ...
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Bus");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Car");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Car");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Car");
    ...
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Car");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Ship");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Ship");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r5.transportMode === "Ship");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !travel_r5.transportMode || !\u0275\u0275pureFunction0(45, _c02).includes(travel_r5.transportMode || ""));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.getTransportModeLabel(travel_r5.transportMode || ""));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(travel_r5.title);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", travel_r5.destination, " ");
    \u0275\u0275advance(11);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.start_date"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.formatDate(travel_r5.startDate));
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.end_date"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.formatDate(travel_r5.endDate));
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.accommodation"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(travel_r5.accommodation || "-");
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.purpose"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind3(81, 41, travel_r5.purpose, 0, 30), "", travel_r5.purpose.length > 30 ? "..." : "");
    \u0275\u0275advance(3);
    \u0275\u0275attribute("data-tooltip", ctx_r0.translate("travel.view_details"))("aria-label", ctx_r0.translate("travel.view_details"));
    \u0275\u0275advance(4);
    \u0275\u0275attribute("data-tooltip", ctx_r0.translate("travel.edit"))("aria-label", ctx_r0.translate("travel.edit"));
    \u0275\u0275advance(4);
    \u0275\u0275attribute("data-tooltip", ctx_r0.translate("travel.delete"))("aria-label", ctx_r0.translate("travel.delete"));
  }
}
function TravelListComponent_div_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 52);
    \u0275\u0275template(1, TravelListComponent_div_46_div_1_Template, 95, 46, "div", 53);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r0.travels());
  }
}
function TravelListComponent_div_47_tr_21__svg_path_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 111);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 112);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 113);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 114);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 115);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 116);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 117);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 118);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 119);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 120);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 121);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 122);
  }
}
function TravelListComponent_div_47_tr_21__svg_circle_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 123);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 124);
  }
}
function TravelListComponent_div_47_tr_21__svg_circle_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 125);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 126);
  }
}
function TravelListComponent_div_47_tr_21__svg_circle_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 127);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 128);
  }
}
function TravelListComponent_div_47_tr_21__svg_circle_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "circle", 129);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 130);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 131);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 132);
  }
}
function TravelListComponent_div_47_tr_21__svg_path_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275element(0, "path", 133);
  }
...
function TravelListComponent_div_47_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td")(12, "span", 138);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 139);
    \u0275\u0275template(14, TravelListComponent_div_47_tr_21__svg_path_14_Template, 1, 0, "path", 58)(15, TravelListComponent_div_47_tr_21__svg_path_15_Template, 1, 0, "path", 59)(16, TravelListComponent_div_47_tr_21__svg_path_16_Template, 1, 0, "path", 60)(17, TravelListComponent_div_47_tr_21__svg_path_17_Template, 1, 0, "path", 61)(18, TravelListComponent_div_47_tr_21__svg_path_18_Template, 1, 0, "path", 62)(19, TravelListComponent_div_47_tr_21__svg_path_19_Template, 1, 0, "path", 63)(20, TravelListComponent_div_47_tr_21__svg_path_20_Template, 1, 0, "path", 64)(21, TravelListComponent_div_47_tr_21__svg_path_21_Template, 1, 0, "path", 65)(22, TravelListComponent_div_47_tr_21__svg_path_22_Template, 1, 0, "path", 66)(23, TravelListComponent_div_47_tr_21__svg_path_23_Template, 1, 0, "path", 67)(24, TravelListComponent_div_47_tr_21__svg_path_24_Template, 1, 0, "path", 68)(25, TravelListComponent_div_47_tr_21__svg_path_25_Template, 1, 0, "path", 69)(26, TravelListComponent_div_47_tr_21__svg_circle_26_Template, 1, 0, "circle", 70)(27, TravelListComponent_div_47_tr_21__svg_path_27_Template, 1, 0, "path", 71)(28, TravelListComponent_div_47_tr_21__svg_circle_28_Template, 1, 0, "circle", 72)(29, TravelListComponent_div_47_tr_21__svg_path_29_Template, 1, 0, "path", 73)(30, TravelListComponent_div_47_tr_21__svg_circle_30_Template, 1, 0, "circle", 74)(31, TravelListComponent_div_47_tr_21__svg_path_31_Template, 1, 0, "path", 75)(32, TravelListComponent_div_47_tr_21__svg_circle_32_Template, 1, 0, "circle", 76)(33, TravelListComponent_div_47_tr_21__svg_path_33_Template, 1, 0, "path", 77)(34, TravelListComponent_div_47_tr_21__svg_path_34_Template, 1, 0, "path", 78)(35, TravelListComponent_div_47_tr_21__svg_path_35_Template, 1, 0, "path", 79)(36, TravelListComponent_div_47_tr_21__svg_path_36_Template, 1, 0, "path", 80);
    \u0275\u0275elementEnd();
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275text(39);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "td")(41, "div", 140)(42, "button", 141);
    \u0275\u0275listener("click", function TravelListComponent_div_47_tr_21_Template_button_click_42_listener() {
      const travel_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openDetailsModal(travel_r7));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(43, "svg", 142);
    \u0275\u0275element(44, "path", 143)(45, "circle", 104);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(46, "button", 144);
    \u0275\u0275listener("click", function TravelListComponent_div_47_tr_21_Template_button_click_46_listener() {
      const travel_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openEditModal(travel_r7));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(47, "svg", 25);
    \u0275\u0275element(48, "path", 106)(49, "path", 107);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(50, "button", 145);
    \u0275\u0275listener("click", function TravelListComponent_div_47_tr_21_Template_button_click_50_listener() {
      const travel_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.openDeleteModal(travel_r7));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(51, "svg", 25);
    \u0275\u0275element(52, "polyline", 109)(53, "path", 110);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.formatDate(travel_r7.startDate));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.formatDate(travel_r7.endDate));
    \u0275\u0275advance(4);
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Air");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Air");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Train");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Train");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Train");
    ...
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Train");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Bus");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Bus");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Bus");
    ...
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Bus");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Car");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Car");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Car");
    ...
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Car");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Ship");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Ship");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", travel_r7.transportMode === "Ship");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !travel_r7.transportMode || !\u0275\u0275pureFunction0(30, _c02).includes(travel_r7.transportMode || ""));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getTransportModeLabel(travel_r7.transportMode || ""), " ");
    \u0275\u0275advance(2);
...
function TravelListComponent_div_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 134)(1, "table", 135)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7);
    ...
    \u0275\u0275template(21, TravelListComponent_div_47_tr_21_Template, 54, 31, "tr", 136);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.title_label"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.destination"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.purpose"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.start_date"));
    ...
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.end_date"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.transport_mode"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.accommodation"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.translate("travel.actions"));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r0.travels());
  }
}
function TravelListComponent_div_48_button_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TravelListComponent_div_48_button_10_Template_button_click_0_listener() {
      ...
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onPageChange(page_r10));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
...
function TravelListComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 146)(1, "div", 147)(2, "span");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 148)(5, "button", 149);
    ...
    \u0275\u0275element(7, "polyline", 150);
    \u0275\u0275elementEnd();
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "div", 151);
    \u0275\u0275template(10, TravelListComponent_div_48_button_10_Template, 2, 3, "button", 152);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "button", 149);
    ...
    \u0275\u0275text(12);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 25);
    \u0275\u0275element(14, "polyline", 153);
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(15, "div", 154)(16, "select", 155);
    ...
    \u0275\u0275elementStart(17, "option", 156);
    \u0275\u0275text(18, "5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "option", 157);
    \u0275\u0275text(20, "10");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "option", 158);
    \u0275\u0275text(22, "20");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "option", 159);
    \u0275\u0275text(24, "50");
    \u0275\u0275elementEnd()();
...
function TravelListComponent_app_confirmation_modal_49_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-confirmation-modal", 161);
...
function TravelListComponent_app_add_travel_modal_51_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("close", function TravelListComponent_app_add_travel_modal_51_Template_app_add_travel_modal_close_0_listener() {
      ...
      \u0275\u0275restoreView(_r13);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onTravelAdded($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("isRTL", ctx_r0.isRTL());
  }
}
function TravelListComponent_app_travel_details_modal_52_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-travel-details-modal", 164);
    \u0275\u0275listener("close", function TravelListComponent_app_travel_details_modal_52_Template_app_travel_details_modal_close_0_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDetailsModalClose());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("travelId", ((tmp_1_0 = ctx_r0.travelToView()) == null ? null : tmp_1_0.id) || null)("isRTL", ctx_r0.isRTL());
  }
}
function TravelListComponent_div_53_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "div", 167);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 168);
    \u0275\u0275element(4, "path", 169)(5, "polyline", 170);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "h3", 171);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 172);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "button", 173);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("common.ok"), " ");
  }
}
var TravelListComponent = class _TravelListComponent {
    ...
    this.travelService.getTravels(this.searchTerm() || void 0, fromDateISO, toDateISO, this.currentPage(), this.pageSize()).subscribe({
      next: (response) => {
        if (response.success) {
          ...
          this.totalPages.set(Math.ceil(response.data.totalCount / this.pageSize()) || 9);
        }
        this.loading.set(false);
      },
      error: (error) => {
  ...
  /**
   * Handle date filter changes (kept for backward compatibility)
   */
  onDateFilter() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TravelListComponent, selectors: [["app-travel-list"]], standalone: false, decls: 54, vars: 37, consts: [[1, "travel-page", "rounded-5"], [1, "page-title"], [1, "top-bar"], [1, "top-bar-right"], [1, "view-toggle"], [1, "toggle-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x", "3", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "14", "width", "7", "height", "7"], ["x", "3", "y", "14", "width", "7", "height", "7"], ["d", "M3 3h18v18H3zM21 9H3M21 15H3M12 9v12"], [1, "top-bar-left"], [1, "btn-icon-with-tooltip", 3, "click"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "search-filters"], [1, "search-box"], [1, "search-input-row"], [1, "search-input-container"], ["type", "text", 1, "search-input", 3, "ngModelChange", "keyup.enter", "placeholder", "ngModel"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "search-icon"], ["cx", "11", "cy", "11", "r", "8"], ["d", "m21 21-4.35-4.35"], [1, "btn", "btn-primary", "search-btn", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], [1, "date-filters"], [1, "date-input-group"], ["type", "date", "title", "From Date: Start of travel period", 1, "date-input", 3, "ngModelChange", "change", "ngModel", "placeholder"], [1, "date-separator"], ["type", "date", "title", "To Date: End of travel period", 1, "date-input", 3, "ngModelChange", "change", "ngModel", "min", "placeholder"], ["class", "error-message text-danger", 4, "ngIf"], ["class", "clear-filters-btn ", 3, "title", "click", 4, "ngIf"], ["class", "loading-state", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "modern-travels-grid", 4, "ngIf"], ["class", "travels-table", 4, "ngIf"], ["class", "pagination-container ltr", 4, "ngIf"], [3, "data", "isRTL", "isVisible", "confirm", "cancel", 4, "ngIf"], [3, "travel", "isRTL", "close", "travelUpdated", 4, "ngIf"], [3, "isRTL", "close", "travelAdded", 4, "ngIf"], [3, "travelId", "isRTL", "close", 4, "ngIf"], ["class", "success-modal-overlay", 3, "click", 4, "ngIf"], [1, "error-message", "text-danger"], [1, "clear-filters-btn", 3, "click", "title"], [1, "loading-state"], [1, "spinner"], [1, "empty-state"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1", 1, "empty-icon"], ["d", "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"], ["cx", "12", "cy", "10", "r", "3"], [1, "add-travel-btn", 3, "click"], [1, "modern-travels-grid"], ["class", "modern-travel-card", 4, "ngFor", "ngForOf"], [1, "modern-travel-card"], [1, "card-header-modern"], [1, "transport-mode-badge"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], ["d", "M2 22h20", 4, "ngIf"], ["d", "M6.36 17.4 4 17l-2-4 1.1-.55a2 2 0 0 1 1.8 0l.17.1a2 2 0 0 0 1.8 0L8 12 5 6l.9-.45a2 2 0 0 1 2.09.2l4.02 3a2 2 0 0 0 2.1.2l4.19-2.06a2.41 2.41 0 0 1 1.73-.17L21 7a1.4 1.4 0 0 1 .87 1.99l-.38.76c-.23.46-.6.84-1.07 1.08L7.58 17.2a2 2 0 0 1-1.22.18Z", 4, "ngIf"], ["d", "M8 3.1V7a4 4 0 0 0 8 0V3.1", 4, "ngIf"], ["d", "m9 15-1-1", 4, "ngIf"], ["d", "m15 15 1-1", 4, "ngIf"], ["d", "M9 19c-2.8 0-5-2.2-5-5v-4a8 8 0 0 1 16 0v4c0 2.8-2.2 5-5 5Z", 4, "ngIf"], ["d", "m8 19-2 3", 4, "ngIf"], ["d", "m16 19 2 3", 4, "ngIf"], ["d", "M8 6v6", 4, "ngIf"], ["d", "M15 6v6", 4, "ngIf"], ["d", "M2 12h19.6", 4, "ngIf"], ["d", "M18 18h3s.5-1.7.8-2.8c.1-.4.2-.8.2-1.2 0-.4-.1-.8-.2-1.2l-1.4-5C20.1 6.8 19.1 6 18 6H4a2 2 0 0 0-2 2v10h3", 4, "ngIf"], ["cx", "7", "cy", "18", "r", "2", 4, "ngIf"], ["d", "M9 18h5", 4, "ngIf"], ["cx", "16", "cy", "18", "r", "2", 4, "ngIf"], ["d", "M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2", 4, "ngIf"], ["cx", "7", "cy", "17", "r", "2", 4, "ngIf"], ["d", "M9 17h6", 4, "ngIf"], ["cx", "17", "cy", "17", "r", "2", 4, "ngIf"], ["d", "M10 2v15", 4, "ngIf"], ["d", "M7 22a4 4 0 0 1-4-4 1 1 0 0 1 1-1h16a1 1 0 0 1 1 1 4 4 0 0 1-4 4z", 4, "ngIf"], ["d", "M9.159 2.46a1 1 0 0 1 1.521-.193l9.977 8.98A1 1 0 0 1 20 13H4a1 1 0 0 1-.824-1.567z", 4, "ngIf"], ["d", "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z", 4, "ngIf"], [1, "transport-label"], [1, "travel-title-modern"], [1, "travel-destination-modern"], ["width", "14", "height", "14", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], [1, "card-details-grid"], [1, "detail-item-modern"], [1, "detail-icon-modern"], ["x", "3", "y", "4", "width", "18", "height", "18", "rx", "2", "ry", "2"], ["x1", "16", "y1", "2", "x2", "16", "y2", "6"], ["x1", "8", "y1", "2", "x2", "8", "y2", "6"], ["x1", "3", "y1", "10", "x2", "21", "y2", "10"], [1, "detail-content-modern"], [1, "detail-label-modern"], [1, "detail-value-modern"], [1, "detail-item-modern", "detail-full-width"], ["d", "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"], ["points", "9,22 9,12 15,12 15,22"], ["d", "M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"], ["points", "14,2 14,8 20,8"], [1, "card-actions-modern"], ["type", "button", 1, "action-icon-btn", "view-btn", 3, "click"], ["width", "18", "height", "18", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"], ["cx", "12", "cy", "12", "r", "3"], ["type", "button", 1, "action-icon-btn", "edit-btn", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], ["type", "button", 1, "action-icon-btn", "delete-btn", 3, "click"], ["points", "3,6 5,6 21,6"], ["d", "M19,6v14a2,2,0,0,1-2,2H7a2,2,0,0,1-2-2V6m3,0V4a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2V6"], ["d", "M2 22h20"], ["d", "M6.36 17.4 4 17l-2-4 1.1-.55a2 2 0 0 1 1.8 0l.17.1a2 2 0 0 0 1.8 0L8 12 5 6l.9-.45a2 2 0 0 1 2.09.2l4.02 3a2 2 0 0 0 2.1.2l4.19-2.06a2.41 2.41 0 0 1 1.73-.17L21 7a1.4 1.4 0 0 1 .87 1.99l-.38.76c-.23.46-.6.84-1.07 1.08L7.58 17.2a2 2 0 0 1-1.22.18Z"], ["d", "M8 3.1V7a4 4 0 0 0 8 0V3.1"], ["d", "m9 15-1-1"], ["d", "m15 15 1-1"], ["d", "M9 19c-2.8 0-5-2.2-5-5v-4a8 8 0 0 1 16 0v4c0 2.8-2.2 5-5 5Z"], ["d", "m8 19-2 3"], ["d", "m16 19 2 3"], ["d", "M8 6v6"], ["d", "M15 6v6"], ["d", "M2 12h19.6"], ["d", "M18 18h3s.5-1.7.8-2.8c.1-.4.2-.8.2-1.2 0-.4-.1-.8-.2-1.2l-1.4-5C20.1 6.8 19.1 6 18 6H4a2 2 0 0 0-2 2v10h3"], ["cx", "7", "cy", "18", "r", "2"], ["d", "M9 18h5"], ["cx", "16", "cy", "18", "r", "2"], ["d", "M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"], ["cx", "7", "cy", "17", "r", "2"], ["d", "M9 17h6"], ["cx", "17", "cy", "17", "r", "2"], ["d", "M10 2v15"], ["d", "M7 22a4 4 0 0 1-4-4 1 1 0 0 1 1-1h16a1 1 0 0 1 1 1 4 4 0 0 1-4 4z"], ["d", "M9.159 2.46a1 1 0 0 1 1.521-.193l9.977 8.98A1 1 0 0 1 20 13H4a1 1 0 0 1-.824-1.567z"], ["d", "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"], [1, "travels-table"], [1, "table"], [4, "ngFor", "ngForOf"], [1, "text-truncate-cell"], [1, "transport-badge"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round"], [1, "table-actions"], ["title", "Details", 1, "details-btn-small", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round", "stroke-linejoin", "round", 1, "lucide", "lucide-eye-icon", "lucide-eye"], ["d", "M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"], ["title", "Edit", 1, "edit-btn-small", 3, "click"], ["title", "Delete", 1, "delete-btn-small", 3, "click"], [1, "pagination-container", "ltr"], [1, "pagination-info"], [1, "pagination-controls"], [1, "pagination-btn", 3, "click", "disabled"], ["points", "15,18 9,12 15,6"], [1, "page-numbers"], ["class", "page-number", 3, "active", "click", 4, "ngFor", "ngForOf"], ["points", "9,18 15,12 9,6"], [1, "page-size-selector"], [1, "page-size-select", 3, "change", "value"], ["value", "5"], ["value", "10"], ["value", "20"], ["value", "50"], [1, "page-number", 3, "click"], [3, "confirm", "cancel", "data", "isRTL", "isVisible"], [3, "close", "travelUpdated", "travel", "isRTL"], [3, "close", "travelAdded", "isRTL"], [3, "close", "travelId", "isRTL"], [1, "success-modal-overlay", 3, "click"], [1, "success-modal", 3, "click"], [1, "success-icon"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], [1, "success-title"], [1, "success-message"], [1, "success-close-btn", 3, "click"]], template: function TravelListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(20, "line", 14)(21, "line", 15);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(22, "div", 16)(23, "div", 17)(24, "div", 18)(25, "div", 19)(26, "input", 20);
      \u0275\u0275listener("ngModelChange", function TravelListComponent_Template_input_ngModelChange_26_listener($event) {
        return ctx.onSearchChange($event);
      })("keyup.enter", function TravelListComponent_Template_input_keyup_enter_26_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(27, "svg", 21);
      \u0275\u0275element(28, "circle", 22)(29, "path", 23);
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(30, "button", 24);
      \u0275\u0275listener("click", function TravelListComponent_Template_button_click_30_listener() {
        return ctx.onSearchClick();
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(31, "svg", 25);
      \u0275\u0275element(32, "circle", 22)(33, "path", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275text(34);
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(35, "div", 26)(36, "div", 27)(37, "input", 28);
      \u0275\u0275listener("ngModelChange", function TravelListComponent_Template_input_ngModelChange_37_listener($event) {
        return ctx.fromDate.set($event);
      })("change", function TravelListComponent_Template_input_change_37_listener($event) {
      ...
      \u0275\u0275text(39, "-");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(40, "div", 27)(41, "input", 30);
      \u0275\u0275listener("ngModelChange", function TravelListComponent_Template_input_ngModelChange_41_listener($event) {
        return ctx.toDate.set($event);
      })("change", function TravelListComponent_Template_input_change_41_listener($event) {
        return ctx.onToDateChange($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(42, TravelListComponent_small_42_Template, 2, 1, "small", 31);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(43, TravelListComponent_button_43_Template, 2, 3, "button", 32);
      \u0275\u0275elementEnd();
      \u0275\u0275template(44, TravelListComponent_div_44_Template, 4, 1, "div", 33)(45, TravelListComponent_div_45_Template, 10, 3, "div", 34)(46, TravelListComponent_div_46_Template, 2, 1, "div", 35)(47, TravelListComponent_div_47_Template, 22, 9, "div", 36)(48, TravelListComponent_div_48_Template, 27, 12, "div", 37)(49, TravelListComponent_app_confirmation_modal_49_Template, 1, 3, "app-confirmation-modal", 38)(50, TravelListComponent_app_edit_travel_modal_50_Template, 1, 2, "app-edit-travel-modal", 39)(51, TravelListComponent_app_add_travel_modal_51_Template, 1, 1, "app-add-travel-modal", 40)(52, TravelListComponent_app_travel_details_modal_52_Template, 1, 2, "app-travel-details-modal", 41)(53, TravelListComponent_div_53_Template, 12, 3, "div", 42);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275classProp("rtl", ctx.isRTL());
      ...
      \u0275\u0275advance();
      \u0275\u0275attribute("data-tooltip", ctx.translate("travel.add_travel"))("aria-label", ctx.translate("travel.add_travel"));
      \u0275\u0275advance(8);
      \u0275\u0275property("placeholder", ctx.translate("common.search"))("ngModel", ctx.searchTerm());
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate1(" ", ctx.translate("common.search"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("ngModel", ctx.fromDate())("placeholder", ctx.translate("travel.start_date"));
      \u0275\u0275advance(4);
      \u0275\u0275classProp("error", ctx.fromDate() && ctx.toDate() && ctx.toDate() < ctx.fromDate());
      \u0275\u0275property("ngModel", ctx.toDate())("min", ctx.getMinToDate())("placeholder", ctx.translate("travel.end_date"));
      \u0275\u0275advance();
...
\r
    ...
    <div class="top-bar-left" [class.ltr-right]="!isRTL()">\r
      <button \r
        ...
        [attr.data-tooltip]="translate('travel.add_travel')"\r
        [attr.aria-label]="translate('travel.add_travel')">\r
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
    ...
    <div class="date-filters ">\r
      ...
      <div class="date-input-group">\r
        ...
        <small *ngIf="fromDate() && toDate() && toDate() < fromDate()" class="error-message text-danger">\r
          {{ translate("travel.to_date_before_from_date_error") }}\r
        </small>\r
      </div>\r
    </div>\r
\r
...
\r
  <!-- Cards View -->\r
  <div\r
    class="modern-travels-grid"\r
    *ngIf="!loading() && travels().length > 0 && viewMode() === 'cards'"\r
  >\r
    <div class="modern-travel-card" *ngFor="let travel of travels()">\r
      \r
      <!-- Card Header -->\r
      <div class="card-header-modern">\r
        <!-- Transport Mode Badge in Corner -->\r
        <div class="transport-mode-badge">\r
          ...
          <span class="transport-label">{{ getTransportModeLabel(travel.transportMode || '') }}</span>\r
        </div>\r
        <h3 class="travel-title-modern">{{ travel.title }}</h3>\r
        <p class="travel-destination-modern">\r
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>\r
            <circle cx="12" cy="10" r="3"></circle>\r
          </svg>\r
          {{ travel.destination }}\r
        </p>\r
      </div>\r
\r
      <!-- Card Details Grid -->\r
      <div class="card-details-grid">\r
        <div class="detail-item-modern">\r
          <div class="detail-icon-modern">\r
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
              <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>\r
              <line x1="16" y1="2" x2="16" y2="6"></line>\r
              <line x1="8" y1="2" x2="8" y2="6"></line>\r
          ...
          <div class="detail-content-modern">\r
            <span class="detail-label-modern">{{ translate("travel.start_date") }}</span>\r
            <span class="detail-value-modern">{{ formatDate(travel.startDate) }}</span>\r
          </div>\r
        </div>\r
\r
        <div class="detail-item-modern">\r
          ...
          <div class="detail-content-modern">\r
            <span class="detail-label-modern">{{ translate("travel.end_date") }}</span>\r
            <span class="detail-value-modern">{{ formatDate(travel.endDate) }}</span>\r
          </div>\r
        </div>\r
\r
        <div class="detail-item-modern detail-full-width">\r
          <div class="detail-icon-modern">\r
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
              <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>\r
              <polyline points="9,22 9,12 15,12 15,22"></polyline>\r
          ...
          <div class="detail-content-modern">\r
            <span class="detail-label-modern">{{ translate("travel.accommodation") }}</span>\r
            <span class="detail-value-modern">{{ travel.accommodation || '-' }}</span>\r
          </div>\r
        </div>\r
\r
        <div class="detail-item-modern detail-full-width">\r
          ...
          <div class="detail-content-modern">\r
            <span class="detail-label-modern">{{ translate("travel.purpose") }}</span>\r
            <span class="detail-value-modern">{{ travel.purpose |slice:0:30 }}{{ travel.purpose.length > 30 ? '...' : '' }}</span>\r
          </div>\r
        </div>\r
      </div>\r
\r
      <!-- Card Actions -->\r
      <div class="card-actions-modern">\r
        <button \r
          type="button"\r
          class="action-icon-btn view-btn"\r
          (click)="openDetailsModal(travel)"\r
          [attr.data-tooltip]="translate('travel.view_details')"\r
          [attr.aria-label]="translate('travel.view_details')">\r
        ...
        <button \r
          type="button"\r
          class="action-icon-btn edit-btn"\r
          (click)="openEditModal(travel)"\r
          [attr.data-tooltip]="translate('travel.edit')"\r
          [attr.aria-label]="translate('travel.edit')">\r
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>\r
            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>\r
          </svg>\r
        ...
        <button \r
          type="button"\r
          class="action-icon-btn delete-btn"\r
          (click)="openDeleteModal(travel)"\r
          [attr.data-tooltip]="translate('travel.delete')"\r
          [attr.aria-label]="translate('travel.delete')">\r
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
...
\r
  ...
  >\r
    <table class="table">\r
      <thead>\r
        <tr>\r
          <th>{{ translate("travel.title_label") }}</th>\r
      ...
      <tbody>\r
        <tr *ngFor="let travel of travels()">\r
          <td class="text-truncate-cell">{{ travel.title }}</td>\r
          <td class="text-truncate-cell">{{ travel.destination }}</td>\r
          <td class="text-truncate-cell">{{ travel.purpose }}</td>\r
...
//# sourceMappingURL=chunk-AYIBND4V.js.map

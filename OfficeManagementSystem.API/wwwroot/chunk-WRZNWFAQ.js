...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;1cf69653f4236fd6a15f91db63ff602e480857660461cc81f01bb1f0d092e336;D:/web/EXSUS/\u062B\u0624\u062E\u0629/v2/echo-office-new/src/app/components/shared/confirmation-modal/confirmation-modal.component.ts */\n.modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  -webkit-backdrop-filter: blur(4px);\n  backdrop-filter: blur(4px);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 99999;\n  padding: 1rem;\n}\n.modal-container {\n  background: white;\n  border-radius: 12px;\n  padding: 2rem;\n  max-width: 400px;\n  width: 100%;\n  position: relative;\n  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);\n  animation: modalSlideIn 0.3s ease-out;\n  justify-content: center !important;\n}\n@keyframes modalSlideIn {\n  from {\n    opacity: 0;\n    transform: scale(0.95) translateY(-10px);\n  }\n  to {\n    opacity: 1;\n    transform: scale(1) translateY(0);\n  }\n}\n.close-btn {\n  position: absolute;\n  top: 1rem;\n  left: 1rem;\n  background: none;\n  border: none;\n  color: #6b7280;\n  cursor: pointer;\n  padding: 0.5rem;\n  border-radius: 6px;\n  transition: all 0.2s;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.close-btn:hover {\n  background: #f3f4f6;\n  color: #374151;\n}\n.modal-icon {\n  text-align: center;\n  margin-bottom: 1.5rem;\n}\n.icon-delete {\n  color: #dc2626;\n}\n.icon-warning {\n  color: #f59e0b;\n}\n.icon-info {\n  color: #3b82f6;\n}\n.modal-title {\n  font-size: 1.5rem;\n  font-weight: 700;\n  color: #111827;\n  text-align: center !important;\n  margin-bottom: 1rem;\n  line-height: 1.4;\n}\n.modal-message {\n  color: #6b7280;\n  text-align: center;\n  margin-bottom: 2rem;\n  line-height: 1.6;\n  font-size: 1rem;\n  justify-content: center !important;\n}\n.modal-actions {\n  display: flex;\n  gap: 1rem;\n  justify-content: center;\n}\n.btn {\n  padding: 0.75rem 1.5rem;\n  border-radius: 8px;\n  font-weight: 600;\n  font-size: 0.875rem;\n  cursor: pointer;\n  transition: all 0.2s;\n  border: none;\n  min-width: 100px;\n}\n.btn-cancel {\n  background: white;\n  color: #374151;\n  border: 2px solid #e5e7eb;\n}\n.btn-cancel:hover {\n  background: #f9fafb;\n  border-color: #d1d5db;\n}\n.btn-confirm {\n  color: white;\n}\n.btn-delete {\n  background: #dc2626;\n}\n.btn-delete:hover {\n  background: #b91c1c;\n}\n.btn-warning {\n  background: #f59e0b;\n}\n.btn-warning:hover {\n  background: #d97706;\n}\n.btn-info {\n  background: #3b82f6;\n}\n.btn-info:hover {\n  background: #2563eb;\n}\n.modal-container[dir=rtl] .close-btn {\n  left: auto;\n  right: 1rem;\n}\n.modal-container[dir=rtl] .modal-title,\n.modal-container[dir=rtl] .modal-message {\n  text-align: center;\n  justify-content: center;\n}\n@media (max-width: 480px) {\n  .modal-container {\n    padding: 1.5rem;\n    margin: 1rem;\n  }\n  .modal-actions {\n    flex-direction: column;\n  }\n  .btn {\n    width: 100%;\n  }\n}\n/*# sourceMappingURL=confirmation-modal.component-MJPYKMIE.css.map */\n"] }]
  }], null, { data: [{
    type: Input
  }], isRTL: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfirmationModalComponent, { className: "ConfirmationModalComponent", filePath: "src/app/components/shared/confirmation-modal/confirmation-modal.component.ts", lineNumber: 242 });
})();

export {
  ConfirmationModalComponent
};
//# sourceMappingURL=chunk-WRZNWFAQ.js.map

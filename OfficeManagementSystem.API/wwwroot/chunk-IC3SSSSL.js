...
function ProfileComponent_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ProfileComponent_div_7_Template_button_click_51_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.navigateToChangePassword());
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(52, "svg", 18);
    \u0275\u0275element(53, "rect", 45)(54, "path", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("ngIf", ctx_r0.saving());
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", ctx_r0.translate("profile.change_password"), " ");
  }
}
...
var ProfileComponent = class _ProfileComponent {
  ...
  selectedFile = null;
  profileForm;
  constructor(profileService, imageService, fb, translationService, langService, router) {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProfileComponent, selectors: [["app-profile"]], decls: 9, vars: 8, consts: [["imageInput", ""], [1, "profile-page", 3, "dir"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], ["class", "loading-state", 4, "ngIf"], ["class", "profile-content", 4, "ngIf"], ["class", "success-message", 4, "ngIf"], [1, "loading-state"], [1, "spinner"], [1, "profile-content"], [1, "profile-grid"], [1, "profile-image-section"], [1, "profile-image-container"], [1, "profile-image", 3, "error", "src", "alt"], ["class", "image-preview-overlay", 4, "ngIf"], [1, "image-controls"], [1, "change-image-btn", 3, "click"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"], ["cx", "12", "cy", "13", "r", "4"], ["class", "remove-preview-btn", "type", "button", 3, "click", 4, "ngIf"], ["type", "file", "accept", "image/*", 2, "display", "none", 3, "change"], [1, "profile-form-section"], [1, "profile-form", 3, "ngSubmit", "formGroup"], [1, "form-row"], [1, "form-group"], ["for", "firstName"], ["type", "text", "id", "firstName", "formControlName", "firstName", 1, "form-input", 3, "placeholder"], ["class", "error-message", 4, "ngIf"], ["for", "lastName"], ["type", "text", "id", "lastName", "formControlName", "lastName", 1, "form-input", 3, "placeholder"], ["for", "email"], ["type", "email", "id", "email", "disabled", "", 1, "form-input", "disabled", 3, "value"], [1, "form-help"], ["for", "phone"], ["type", "tel", "id", "phone", "formControlName", "phoneNumber", 1, "form-input", 3, "placeholder"], ["for", "department"], ["type", "text", "id", "department", "disabled", "", 1, "form-input", "disabled", 3, "value"], ["for", "roles"], ["type", "text", "id", "roles", "disabled", "", 1, "form-input", "disabled", 3, "value"], [1, "form-actions"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["x", "3", "y", "11", "width", "18", "height", "11", "rx", "2", "ry", "2"], ["d", "M7 11V7a5 5 0 0 1 10 0v4"], [1, "image-preview-overlay"], [1, "preview-badge"], ["width", "12", "height", "12", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["points", "20,6 9,17 4,12"], ["type", "button", 1, "remove-preview-btn", 3, "click"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "error-message"], [1, "success-message"], [1, "success-content"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "success-icon"], [1, "close-btn", 3, "click"]], template: function ProfileComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(5);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(6, ProfileComponent_div_6_Template, 4, 1, "div", 5)(7, ProfileComponent_div_7_Template, 56, 26, "div", 6)(8, ProfileComponent_div_8_Template, 8, 2, "div", 7);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
\r
          <div class="image-controls">\r
            <button class="change-image-btn" (click)="triggerImageUpload()">\r
              ...
              {{\r
                selectedImagePreview()\r
                  ? translate("profile.change_image")\r
                  : translate("profile.select_image")\r
              }}\r
            </button>\r
\r
            <button\r
...
\r
      ...
      <div class="profile-form-section">\r
        <form\r
          [formGroup]="profileForm"\r
          (ngSubmit)="onSubmit()"\r
          class="profile-form"\r
        >\r
          <div class="form-row">\r
            <div class="form-group">\r
              <label for="firstName">{{\r
                translate("profile.first_name")\r
              }}</label>\r
              <input\r
                type="text"\r
                id="firstName"\r
              ...
              <div\r
                ...
                *ngIf="\r
                  profileForm.get('firstName')?.invalid &&\r
                  profileForm.get('firstName')?.touched\r
                "\r
              >\r
...
\r
            <div class="form-group">\r
              ...
              <div\r
                class="error-message"\r
                *ngIf="\r
                  profileForm.get('lastName')?.invalid &&\r
                  profileForm.get('lastName')?.touched\r
                "\r
              >\r
...
\r
          <div class="form-group">\r
            ...
            />\r
            <small class="form-help">{{\r
              translate("profile.email_help")\r
            }}</small>\r
          </div>\r
\r
          <div class="form-group">\r
            ...
            <div\r
              class="error-message"\r
              *ngIf="\r
                profileForm.get('phoneNumber')?.invalid &&\r
                profileForm.get('phoneNumber')?.touched\r
              "\r
            >\r
...
\r
          <div class="form-group">\r
            <label for="department">{{\r
              translate("profile.department")\r
            }}</label>\r
            <input\r
              type="text"\r
              id="department"\r
              [value]="\r
                profile()?.departmentName || translate('profile.no_department')\r
              "\r
              disabled\r
              class="form-input disabled"\r
            />\r
...
\r
          <div class="form-group">\r
            ...
            <input\r
              ...
              id="roles"\r
              [value]="\r
                profile()?.roles?.join(', ') || translate('profile.no_roles')\r
              "\r
              disabled\r
              class="form-input disabled"\r
            />\r
...
\r
          <div class="form-actions">\r
            <button\r
              ...
              [disabled]="profileForm.invalid || saving()"\r
            >\r
            ...
            <button\r
              ...
              (click)="navigateToChangePassword()"\r
            >\r
              <svg\r
                width="16"\r
                height="16"\r
                ...
                stroke-width="2"\r
              >\r
                <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>\r
                <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>\r
              </svg>\r
              {{ translate("profile.change_password") }}\r
            </button>\r
          </div>\r
        </form>\r
      </div>\r
...
`, styles: ["/* src/app/components/profile/profile.component.css */\n.profile-page {\n  padding: 1.34rem;\n  max-width: 804px;\n  margin: 0 auto;\n}\n.page-header {\n  text-align: center;\n  margin-bottom: 2.01rem;\n}\n.page-title {\n  font-size: 1.3rem;\n  font-weight: 700;\n  color: #5f646d;\n  margin: 0 0 0.335rem 0;\n}\n.page-subtitle {\n  font-size: 0.737rem;\n  color: #6b7280;\n  margin: 0;\n}\n.loading-state {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 2.68rem 1.34rem;\n}\n.spinner {\n  width: 26.8px;\n  height: 26.8px;\n  border: 2.68px solid #e5e7eb;\n  border-top: 2.68px solid #B68A35;\n  border-radius: 50%;\n  animation: spin 1s linear infinite;\n  margin-bottom: 0.67rem;\n}\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.profile-grid {\n  display: grid;\n  grid-template-columns: 1fr 2fr;\n  gap: 2.01rem;\n  align-items: start;\n}\n.profile-image-section {\n  text-align: center;\n}\n.profile-image-container {\n  position: relative;\n  display: inline-block;\n}\n.profile-image {\n  width: 134px;\n  height: 134px;\n  border-radius: 50%;\n  object-fit: cover;\n  border: 2.68px solid #e5e7eb;\n  box-shadow: 0 6.7px 16.75px rgba(0, 0, 0, 0.1);\n}\n.profile-image-placeholder {\n  width: 134px;\n  height: 134px;\n  border-radius: 50%;\n  background: #f3f4f6;\n  border: 2.68px solid #e5e7eb;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #9ca3af;\n}\n.change-image-btn {\n  margin-top: 0.67rem;\n  background: #B68A35;\n  color: white;\n  border: none;\n  padding: 0.503rem 1.005rem;\n  border-radius: 0.335rem;\n  font-size: 0.586rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: background-color 0.2s ease;\n  display: flex;\n  align-items: center;\n  gap: 0.335rem;\n  margin-left: auto;\n  margin-right: auto;\n}\n.change-image-btn:hover {\n  background: #92722A;\n}\n.change-image-btn svg {\n  width: 10.72px;\n  height: 10.72px;\n}\n.image-preview-overlay {\n  position: absolute;\n  top: 0.335rem;\n  right: 0.335rem;\n  pointer-events: none;\n  z-index: 10;\n}\n.preview-badge {\n  background: #B68A35;\n  color: white;\n  padding: 0.168rem 0.335rem;\n  border-radius: 8.04px;\n  font-size: 0.503rem;\n  font-weight: 500;\n  display: flex;\n  align-items: center;\n  gap: 0.168rem;\n  box-shadow: 0 1.34px 2.68px rgba(0, 0, 0, 0.1);\n}\n.image-controls {\n  display: flex;\n  flex-direction: column;\n  gap: 0.335rem;\n  align-items: center;\n  width: 100%;\n  margin-top: 0.67rem;\n}\n.remove-preview-btn {\n  background: #c62828;\n  color: white;\n  border: none;\n  padding: 0.335rem 0.67rem;\n  border-radius: 0.251rem;\n  font-size: 0.503rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: background-color 0.2s ease;\n  display: flex;\n  align-items: center;\n  gap: 0.251rem;\n}\n.remove-preview-btn:hover {\n  background: #b91c1c;\n}\n.remove-preview-btn svg {\n  width: 9.38px;\n  height: 9.38px;\n}\n.profile-form-section {\n  background: white;\n  padding: 1.34rem;\n  border-radius: 0.67rem;\n  box-shadow: 0 2.68px 4.02px rgba(0, 0, 0, 0.05);\n  border: 1px solid #e5e7eb;\n}\n.profile-form {\n  display: flex;\n  flex-direction: column;\n  gap: 1.005rem;\n}\n.form-row {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 1.005rem;\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 0.335rem;\n}\n.form-group label {\n  font-weight: 600;\n  color: #374151;\n  font-size: 0.586rem;\n}\n.form-input {\n  padding: 0.503rem;\n  border: 1px solid #d1d5db;\n  border-radius: 0.335rem;\n  font-size: 0.586rem;\n  transition: border-color 0.2s ease, box-shadow 0.2s ease;\n}\n.form-input:focus {\n  outline: none;\n  border-color: #B68A35;\n  box-shadow: 0 0 0 2.01px rgba(21, 134, 56, 0.1);\n}\n.form-input.disabled {\n  background: #f9fafb;\n  color: #6b7280;\n  cursor: not-allowed;\n}\n.form-help {\n  color: #6b7280;\n  font-size: 0.503rem;\n  margin-top: 0.168rem;\n}\n.error-message {\n  color: #dc2626;\n  font-size: 0.503rem;\n  margin-top: 0.168rem;\n}\n.form-actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.67rem;\n  margin-top: 0.67rem;\n}\n.btn {\n  padding: 0.503rem 1.005rem;\n  border: none;\n  border-radius: 0.335rem;\n  font-size: 0.586rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s ease;\n  display: inline-flex;\n  align-items: center;\n  gap: 0.335rem;\n}\n.btn-primary {\n  background: #B68A35;\n  color: white;\n}\n.btn-primary:hover:not(:disabled) {\n  background: #92722A;\n}\n.btn-primary:disabled {\n  background: #9ca3af;\n  cursor: not-allowed;\n}\n.btn-secondary {\n  background: #6b7280;\n  color: white;\n}\n.btn-secondary:hover:not(:disabled) {\n  background: #4b5563;\n}\n.btn-secondary:disabled {\n  background: #9ca3af;\n  cursor: not-allowed;\n}\n.success-message {\n  position: fixed;\n  top: 1.34rem;\n  right: 1.34rem;\n  background: #3F8E50;\n  color: white;\n  padding: 0.67rem 1.005rem;\n  border-radius: 0.335rem;\n  box-shadow: 0 6.7px 16.75px rgba(0, 0, 0, 0.1);\n  z-index: 1000;\n  animation: slideIn 0.3s ease;\n}\n.success-content {\n  display: flex;\n  align-items: center;\n  gap: 0.503rem;\n}\n.success-icon {\n  color: white;\n}\n.close-btn {\n  background: none;\n  border: none;\n  color: white;\n  cursor: pointer;\n  font-size: 0.586rem;\n  text-decoration: underline;\n  margin-left: 0.67rem;\n}\n.close-btn:hover {\n  opacity: 0.8;\n}\n@keyframes slideIn {\n  from {\n    transform: translateX(100%);\n    opacity: 0;\n  }\n  to {\n    transform: translateX(0);\n    opacity: 1;\n  }\n}\n.profile-page.rtl {\n  direction: rtl;\n}\n.profile-page.rtl .form-actions {\n  justify-content: flex-start;\n}\n.profile-page.rtl .success-message {\n  right: auto;\n  left: 2rem;\n}\n.profile-page.rtl .close-btn {\n  margin-left: 0;\n  margin-right: 1rem;\n}\n@media (max-width: 1400px) {\n  .profile-page {\n    padding: 0 1.9rem;\n  }\n  .page-title {\n    font-size: 1.5rem;\n  }\n  .page-subtitle {\n    font-size: 0.8rem;\n  }\n  .profile-form-section {\n    padding: 0.8rem;\n  }\n  .form-row {\n    gap: 0.5rem;\n  }\n  .form-group {\n    gap: 0.25rem;\n  }\n  .form-group label {\n    font-size: 0.7rem;\n  }\n}\n@media (max-width: 1150px) {\n  .profile-page {\n    padding: 0 1.8 rem;\n  }\n  .profile-grid {\n    gap: 1rem;\n  }\n  .page-title {\n    font-size: 1.3rem;\n  }\n  .page-subtitle {\n    font-size: 1rem;\n  }\n  .profile-form-section {\n    padding: 0.5rem;\n  }\n  .form-row {\n    gap: 1.25rem;\n  }\n  .profile-image {\n    width: 190px;\n    height: 190px;\n  }\n  .profile-image-placeholder {\n    width: 190px;\n    height: 190px;\n  }\n  .profile-form {\n    gap: 1.5rem;\n  }\n}\n@media (max-width: 900px) {\n  .profile-page {\n    padding: 0 1.25rem;\n  }\n  .profile-grid {\n    gap: 2rem;\n  }\n  .page-title {\n    font-size: 1.75rem;\n  }\n  .page-subtitle {\n    font-size: 0.95rem;\n  }\n  .profile-form-section {\n    padding: 1rem;\n  }\n  .form-row {\n    gap: 1rem;\n  }\n  .profile-image {\n    width: 180px;\n    height: 180px;\n  }\n  .profile-image-placeholder {\n    width: 180px;\n    height: 180px;\n  }\n  .profile-form {\n    gap: 1.25rem;\n  }\n  .form-actions {\n    gap: 0.875rem;\n  }\n  .btn {\n    padding: 0.65rem 1.25rem;\n    font-size: 0.8125rem;\n  }\n}\n@media (max-width: 850px) {\n  .profile-page {\n    padding: 0 1rem;\n  }\n  .profile-grid {\n    gap: 1.75rem;\n  }\n  .page-title {\n    font-size: 1.625rem;\n  }\n  .page-subtitle {\n    font-size: 0.9rem;\n  }\n  .profile-form-section {\n    padding: 0.875rem;\n  }\n  .form-row {\n    gap: 0.875rem;\n  }\n  .profile-image {\n    width: 170px;\n    height: 170px;\n  }\n  .profile-image-placeholder {\n    width: 170px;\n    height: 170px;\n  }\n  .profile-form {\n    gap: 1.125rem;\n  }\n  .form-group label {\n    font-size: 0.8125rem;\n  }\n  .form-input {\n    padding: 0.65rem;\n    font-size: 0.8125rem;\n  }\n  .change-image-btn {\n    padding: 0.65rem 1.25rem;\n    font-size: 0.8125rem;\n  }\n  .form-actions {\n    gap: 0.75rem;\n    margin-top: 1.25rem;\n  }\n  .btn {\n    padding: 0.625rem 1.125rem;\n    font-size: 0.8125rem;\n  }\n}\n@media (max-width: 1024px) and (min-width: 769px) {\n  .profile-page {\n    padding: 1.005rem;\n  }\n  .profile-grid {\n    grid-template-columns: 1fr;\n    gap: 1.675rem;\n    align-items: center;\n  }\n  .profile-image-section {\n    order: 1;\n    margin-bottom: 0.67rem;\n  }\n  .profile-form-section {\n    order: 2;\n    max-width: 402px;\n    margin: 0 auto;\n    width: 100%;\n  }\n  .form-row {\n    grid-template-columns: 1fr 1fr;\n    gap: 1.005rem;\n  }\n  .profile-image {\n    width: 120.6px;\n    height: 120.6px;\n  }\n  .profile-image-placeholder {\n    width: 120.6px;\n    height: 120.6px;\n  }\n  .page-title {\n    font-size: 1.508rem;\n  }\n  .page-subtitle {\n    font-size: 0.804rem;\n  }\n  .profile-form {\n    gap: 1.173rem;\n  }\n  .form-actions {\n    justify-content: center;\n    margin-top: 1.34rem;\n  }\n}\n@media (max-width: 768px) {\n  .profile-page {\n    padding: 0.67rem;\n  }\n  .profile-grid {\n    grid-template-columns: 1fr;\n    gap: 1.34rem;\n  }\n  .form-row {\n    grid-template-columns: 1fr;\n    gap: 0.67rem;\n  }\n  .page-title {\n    font-size: 1.34rem;\n  }\n  .form-actions {\n    flex-direction: column;\n    gap: 0.5rem;\n  }\n  .btn {\n    width: 100%;\n    justify-content: center;\n  }\n  .success-message {\n    top: 0.67rem;\n    right: 0.67rem;\n    left: 0.67rem;\n  }\n  .profile-page.rtl .success-message {\n    right: 0.67rem;\n    left: 0.67rem;\n  }\n}\n@media (max-width: 480px) {\n  .profile-page {\n    padding: 0.335rem;\n  }\n  .profile-form-section {\n    padding: 1.005rem;\n  }\n  .profile-image-section {\n    justify-content: center;\n    width: 100% !important;\n  }\n  .profile-form-section {\n    justify-content: center;\n    padding: 0.335rem;\n    width: 100% !important;\n  }\n  #lastName,\n  #firstName {\n    width: 100% !important;\n  }\n  .profile-image {\n    width: 100.5px;\n    height: 100.5px;\n  }\n  .profile-image-placeholder {\n    width: 100.5px;\n    height: 100.5px;\n  }\n}\n/*# sourceMappingURL=profile.component-YP3NHTRZ.css.map */\n"] }]
  }], () => [{ type: ProfileService }, { type: ImageService }, { type: FormBuilder }, { type: TranslationService }, { type: LangService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProfileComponent, { className: "ProfileComponent", filePath: "src/app/components/profile/profile.component.ts", lineNumber: 26 });
})();
export {
  ProfileComponent
};
//# sourceMappingURL=chunk-IC3SSSSL.js.map

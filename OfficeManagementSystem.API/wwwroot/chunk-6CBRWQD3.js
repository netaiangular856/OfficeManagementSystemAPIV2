...
import {
  ImageService
} from "./chunk-P7M4GFLU.js";
import {
  ProfileService
} from "./chunk-MRSCLYQ7.js";
import {
...
function SidebarComponent_li_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "path", 59)(4, "polyline", 60);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, SidebarComponent_li_11_span_5_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 61);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "path", 62)(4, "rect", 63)(5, "path", 64);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, SidebarComponent_li_12_span_6_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "rect", 67)(4, "path", 62)(5, "path", 68)(6, "path", 69)(7, "path", 70)(8, "path", 71);
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, SidebarComponent_li_13_span_9_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 72);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 73);
    \u0275\u0275element(3, "path", 74)(4, "path", 75)(5, "path", 76)(6, "path", 77)(7, "path", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275template(8, SidebarComponent_li_14_span_8_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 79);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 41);
    \u0275\u0275element(3, "rect", 42)(4, "line", 43)(5, "line", 44)(6, "line", 45)(7, "circle", 80)(8, "circle", 81)(9, "circle", 82)(10, "circle", 83)(11, "line", 84)(12, "line", 85);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, SidebarComponent_li_15_span_13_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "path", 88);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, SidebarComponent_li_16_span_4_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_17_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 89);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 41);
    \u0275\u0275element(3, "path", 90)(4, "path", 91)(5, "path", 92);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, SidebarComponent_li_17_span_6_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function SidebarComponent_li_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "path", 107)(4, "polyline", 108)(5, "line", 109)(6, "line", 110)(7, "polyline", 111);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 112);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "path", 113)(4, "path", 114)(5, "path", 115)(6, "path", 116)(7, "path", 117);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_22_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 39);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function SidebarComponent_li_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 35)(1, "a", 118);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(2, "svg", 22);
    \u0275\u0275element(3, "rect", 119)(4, "rect", 120)(5, "rect", 121)(6, "rect", 122);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, SidebarComponent_li_22_span_7_Template, 2, 1, "span", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NotificationDropdownComponent, { className: "NotificationDropdownComponent" });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddNotificationModalComponent, { className: "AddNotificationModalComponent" });
})();
...
//# sourceMappingURL=chunk-6CBRWQD3.js.map

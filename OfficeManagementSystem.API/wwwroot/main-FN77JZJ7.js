...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-WFYXWZ7S.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-TN77XYAH.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-WIN3J4SQ.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-7WPICUGV.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-FN77JZJ7.js.map

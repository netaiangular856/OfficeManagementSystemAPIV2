...
/*# sourceMappingURL=add-letter-WI2ZZNQ6.css.map */`] });
};
(() => {
...
/*# sourceMappingURL=edit-letter-KR6XNNE4.css.map */`] });
};
(() => {
...
function LettersList_div_65_div_3_div_1_div_28_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "div", 107)(3, "div", 108)(4, "div", 109);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div", 110);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "div", 111)(9, "button", 90);
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(10, "svg", 100);
    \u0275\u0275element(11, "path", 112)(12, "path", 113);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(14, "svg", 100);
    \u0275\u0275element(15, "path", 115)(16, "path", 116)(17, "path", 117);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function LettersList_div_65_div_3_div_1_div_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(12, "div", 103);
    \u0275\u0275template(13, LettersList_div_65_div_3_div_1_div_28_div_13_Template, 18, 7, "div", 104);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const letter_r5 = \u0275\u0275nextContext().$implicit;
...
function LettersList_div_65_div_3_div_1_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 95)(1, "div", 9)(2, "small", 64);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(3, "svg", 118);
    \u0275\u0275element(4, "path", 62)(5, "polyline", 63);
    \u0275\u0275elementEnd();
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(9, "line", 101)(10, "line", 102);
    \u0275\u0275elementEnd();
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()()();
  }
...
function LettersList_div_65_div_3_div_1_button_40_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 123)(1, "span", 57);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function LettersList_div_65_div_3_div_1_button_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LettersList_div_65_div_3_div_1_button_40_span_1_Template, 3, 1, "span", 93);
    \u0275\u0275element(2, "i", 122);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
  }
...
function LettersList_div_65_div_3_div_1_button_41_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LettersList_div_65_div_3_div_1_button_41_span_1_Template, 3, 1, "span", 93)(2, LettersList_div_65_div_3_div_1_button_41_i_2_Template, 1, 0, "i", 125)(3, LettersList_div_65_div_3_div_1_button_41_i_3_Template, 1, 0, "i", 126);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function LettersList_div_65_div_3_div_1_span_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 123)(1, "span", 57);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function LettersList_div_65_div_3_div_1_i_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 129);
  }
}
function LettersList_div_65_div_3_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(39);
    \u0275\u0275elementEnd();
    \u0275\u0275template(40, LettersList_div_65_div_3_div_1_button_40_Template, 4, 5, "button", 86)(41, LettersList_div_65_div_3_div_1_button_41_Template, 5, 10, "button", 87);
    \u0275\u0275elementStart(42, "button", 88);
    \u0275\u0275listener("click", function LettersList_div_65_div_3_div_1_Template_button_click_42_listener() {
      const letter_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275text(44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "button", 90);
    \u0275\u0275listener("click", function LettersList_div_65_div_3_div_1_Template_button_click_45_listener() {
      const letter_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275listener("click", function LettersList_div_65_div_3_div_1_Template_button_click_48_listener() {
      const letter_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.deleteLetter(letter_r5.id, letter_r5.subject));
    });
    \u0275\u0275template(49, LettersList_div_65_div_3_div_1_span_49_Template, 3, 1, "span", 93)(50, LettersList_div_65_div_3_div_1_i_50_Template, 1, 0, "i", 94);
    \u0275\u0275text(51);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", \u0275\u0275pipeBind3(14, 36, letter_r5.body, 0, 100), "", letter_r5.body.length > 100 ? "..." : "", " ");
    \u0275\u0275advance(5);
...
function LettersList_div_65_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LettersList_div_65_div_3_div_1_Template, 52, 40, "div", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function LettersList_div_66_li_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "li", 142)(1, "button", 147);
...
function LettersList_div_66_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 130)(1, "div", 131)(2, "div", 132)(3, "label", 133);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "select", 134);
    ...
    \u0275\u0275text(13, "50");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "div", 139)(15, "span");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "nav", 140)(18, "ul", 141)(19, "li", 142)(20, "button", 143);
    ...
    \u0275\u0275element(22, "polyline", 144);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(23, LettersList_div_66_li_23_Template, 3, 3, "li", 145);
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(24, "li", 142)(25, "button", 143);
...
//# sourceMappingURL=chunk-VPHN2TYB.js.map

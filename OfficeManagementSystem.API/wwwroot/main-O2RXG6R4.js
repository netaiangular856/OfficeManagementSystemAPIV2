...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-WJICF6HP.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-G22633HF.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-CMKOXHRM.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-FRFIXR6N.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-O2RXG6R4.js.map

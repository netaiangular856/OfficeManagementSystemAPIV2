...
var routes = [
  {
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadChildren: () => import("./chunk-25EZIQ6S.js").then((m) => m.DashboardModule)
      },
      {
        path: "users",
        loadChildren: () => import("./chunk-ZHTLRCN4.js").then((m) => m.UsersModule)
      },
      {
        path: "roles",
        loadChildren: () => import("./chunk-GIJAM5OJ.js").then((m) => m.RolesModule)
      },
      {
        path: "employees",
        loadChildren: () => import("./chunk-CO7MAAYG.js").then((m) => m.EmployeesModule)
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-OQH4FDYN.js").then((m) => m.ProfileComponent)
      },
      {
        path: "departments",
        loadChildren: () => import("./chunk-5CZZ2MDI.js").then((m) => m.DepartmentsModule)
      },
      {
        path: "tasks",
        loadChildren: () => import("./chunk-RWDNXPRA.js").then((m) => m.TasksModule)
      },
      {
        path: "partners",
        loadChildren: () => import("./chunk-EC3KPDQA.js").then((m) => m.PartnersModule)
      },
      {
        path: "visits",
        loadChildren: () => import("./chunk-S66FAFYG.js").then((m) => m.VisitsModule)
      },
      {
        path: "travel",
        loadChildren: () => import("./chunk-JPHUU6YY.js").then((m) => m.TravelModule)
      },
      {
        path: "meetings",
        loadChildren: () => import("./chunk-SCOPUFYL.js").then((m) => m.MeetingsModule)
      },
      {
        path: "calendar",
        loadChildren: () => import("./chunk-4VNTPRA6.js").then((m) => m.CalendarModule)
      },
      {
        path: "letters",
        loadChildren: () => import("./chunk-LJ2JXLIY.js").then((m) => m.LettersModule)
      },
      {
        path: "documents",
        loadChildren: () => import("./chunk-BTOZVUJ7.js").then((m) => m.DocumentsModule)
      },
      {
        path: "workflow",
        loadChildren: () => import("./chunk-SQ32726L.js").then((m) => m.WorkflowModule)
      }
      // {
      //   path: '',
...
//# sourceMappingURL=chunk-ZS4BUL6P.js.map

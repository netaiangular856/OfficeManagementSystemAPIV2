...
function EditUserDrawerComponent_div_53_span_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const roleName_r4 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.getRoleDisplayNameFromString(roleName_r4), " ");
  }
}
...
var EditUserDrawerComponent = class _EditUserDrawerComponent {
  ...
  availableRoles = computed(() => this.roles(), ...ngDevMode ? [{ debugName: "availableRoles" }] : []);
  editForm;
  constructor(profileService, departmentService, rolesService, fb, translationService, langService) {
  ...
  translateRoleName(roleName) {
    const translationKey = `users.role_names.${roleName}`;
  ...
  getRoleDisplayNameFromString(roleName) {
    ...
    return this.translateRoleName(roleName);
  }
  getFullName() {
    const user = this.userData()?.user;
    if (user) {
  ...
  static \u0275fac = function EditUserDrawerComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EditUserDrawerComponent)(\u0275\u0275directiveInject(ProfileService), \u0275\u0275directiveInject(DepartmentService), \u0275\u0275directiveInject(RolesService), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(TranslationService), \u0275\u0275directiveInject(LangService));
  };
          ...
          <div class="form-group">\r
            ...
            <select \r
              *ngIf="isManager()" \r
              ...
              <option *ngFor="let role of availableRoles()" [value]="role.name">\r
                {{ getRoleDisplayName(role) }}\r
              </option>\r
            </select>\r
            <div *ngIf="!isManager()" class="roles-display">\r
              <span *ngFor="let roleName of userData()?.user?.roles" class="role-badge">\r
                {{ getRoleDisplayNameFromString(roleName) }}\r
              </span>\r
...
`, styles: ['/* src/app/components/users/edit-user-drawer/edit-user-drawer.component.css */\n.drawer-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  -webkit-backdrop-filter: blur(4px);\n  backdrop-filter: blur(4px);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 9999;\n  padding: 1rem;\n  isolation: isolate;\n}\n.drawer-container {\n  background: #FFFFFF;\n  border-radius: 12px;\n  width: 100%;\n  max-width: 600px;\n  max-height: 90vh;\n  overflow: hidden;\n  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);\n  animation: drawerSlideIn 0.3s ease-out;\n}\n@keyframes drawerSlideIn {\n  from {\n    opacity: 0;\n    transform: scale(0.95) translateY(-10px);\n  }\n  to {\n    opacity: 1;\n    transform: scale(1) translateY(0);\n  }\n}\n.drawer-header {\n  background: #D4AF5F;\n  color: white !important;\n  padding: 1.5rem 2rem;\n  border-bottom: 1px solid #e5e7eb;\n}\n.header-content {\n  position: relative;\n  display: flex;\n  align-items: center;\n  color: white !important;\n  min-height: 40px;\n}\n.drawer-title {\n  font-size: 1.5rem;\n  font-weight: 700;\n  color: white !important;\n  margin: 0;\n  flex: 1;\n}\n[dir=ltr] .drawer-title {\n  text-align: left;\n}\n[dir=rtl] .drawer-title {\n  text-align: right;\n}\n.close-btn {\n  position: absolute;\n  background: none;\n  border: none;\n  color: white;\n  cursor: pointer;\n  padding: 0.5rem;\n  border-radius: 6px;\n  transition: all 0.2s;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  top: 50%;\n  transform: translateY(-50%);\n}\n[dir=ltr] .close-btn {\n  right: 0;\n}\n[dir=rtl] .close-btn {\n  left: 0;\n}\n.close-btn:hover {\n  background: rgba(95, 100, 109, 0.1);\n  color: #5F646D;\n}\n.drawer-content {\n  padding: 2rem;\n  overflow-y: auto;\n  max-height: calc(90vh - 100px);\n}\n.user-avatar-section {\n  text-align: center;\n  margin-bottom: 2rem;\n  padding-bottom: 2rem;\n  border-bottom: 1px solid #e5e7eb;\n}\n.avatar-container {\n  margin-bottom: 1rem;\n}\n.user-avatar {\n  width: 80px;\n  height: 80px;\n  border-radius: 50%;\n  object-fit: cover;\n  border: 3px solid #e5e7eb;\n  box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);\n}\n.avatar-placeholder {\n  width: 80px;\n  height: 80px;\n  border-radius: 50%;\n  background: #f3f4f6;\n  border: 3px solid #e5e7eb;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #9ca3af;\n  margin: 0 auto;\n}\n.user-name {\n  font-size: 1.25rem;\n  font-weight: 600;\n  color: #111827;\n  margin: 0 0 0.5rem 0;\n}\n.user-email {\n  color: #6b7280;\n  margin: 0;\n  font-size: 0.875rem;\n}\n.form-section {\n  margin-bottom: 2rem;\n}\n.form-row {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 1rem;\n  margin-bottom: 1rem;\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n  margin-bottom: 1.5rem;\n}\n.form-group label {\n  font-weight: 600;\n  color: #374151;\n  font-size: 0.875rem;\n}\n.form-input {\n  padding: 0.75rem;\n  border: 2px solid #e5e7eb;\n  border-radius: 8px;\n  font-size: 1rem;\n  transition: all 0.2s;\n  font-family: inherit;\n  width: 100%;\n}\n.form-input:focus {\n  outline: none;\n  border-color: #B68A35;\n  box-shadow: 0 0 0 3px rgba(212, 170, 58, 0.1);\n}\n.form-input.disabled {\n  background: #f9fafb;\n  color: #6b7280;\n  cursor: not-allowed;\n}\n.form-help {\n  font-size: 0.875rem;\n  color: #6b7280;\n}\n.error-message {\n  color: #dc2626;\n  font-size: 0.875rem;\n  margin-top: 0.25rem;\n}\n.roles-display {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.5rem;\n  margin-top: 0.5rem;\n}\n.role-badge {\n  background: #158638;\n  color: white;\n  padding: 0.25rem 0.75rem;\n  border-radius: 999px;\n  font-size: 0.875rem;\n  font-weight: 500;\n}\n.no-roles {\n  color: #6b7280;\n  font-style: italic;\n}\n.department-display {\n  padding: 0.75rem;\n  background: #f9fafb;\n  border: 2px solid #e5e7eb;\n  border-radius: 8px;\n  color: #6b7280;\n}\n.department-value {\n  display: block;\n  font-weight: 500;\n  margin-bottom: 0.5rem;\n}\n.status-toggle {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  margin-top: 0.5rem;\n}\n.toggle-switch {\n  position: relative;\n  display: inline-block;\n  width: 50px;\n  height: 24px;\n}\n.toggle-input {\n  opacity: 0;\n  width: 0;\n  height: 0;\n}\n.toggle-slider {\n  position: absolute;\n  cursor: pointer;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #ccc;\n  transition: 0.4s;\n  border-radius: 24px;\n}\n.toggle-slider:before {\n  position: absolute;\n  content: "";\n  height: 18px;\n  width: 18px;\n  left: 3px;\n  bottom: 3px;\n  background-color: white;\n  transition: 0.4s;\n  border-radius: 50%;\n}\n.toggle-input:checked + .toggle-slider {\n  background-color: #2BA149;\n}\n.toggle-input:checked + .toggle-slider:before {\n  transform: translateX(26px);\n}\n.status-text {\n  font-weight: 500;\n  color: #374151;\n}\n.form-actions {\n  display: flex;\n  gap: 1rem;\n  padding-top: 1.5rem;\n  border-top: 1px solid #e5e7eb;\n}\n.btn {\n  padding: 0.75rem 1.5rem;\n  border-radius: 8px;\n  font-weight: 600;\n  cursor: pointer;\n  transition: all 0.2s;\n  border: none;\n  font-size: 0.875rem;\n  min-width: 100px;\n}\n.btn-primary {\n  background: #B68A35;\n  color: #FFFFFF;\n}\n.btn-primary:hover:not(:disabled) {\n  background: #A87D2A;\n  transform: translateY(-1px);\n}\n.btn-primary:disabled {\n  background: #9ca3af;\n  cursor: not-allowed;\n  transform: none;\n}\n.btn-secondary {\n  background: transparent;\n  color: #1B1D21 !important;\n  border: 1px solid #1B1D21;\n  font-weight: 600 !important;\n}\n.btn-secondary:hover {\n  background: #1B1D21;\n  color: #FFFFFF !important;\n}\n.drawer-container.rtl {\n  direction: rtl;\n}\n.drawer-container.rtl .form-actions {\n  justify-content: flex-start;\n}\n@media (max-width: 650px) {\n  .drawer-overlay {\n    z-index: 99999999999 !important;\n    position: fixed !important;\n    top: 0 !important;\n    left: 0 !important;\n    right: 0 !important;\n    bottom: 0 !important;\n  }\n  .drawer-container {\n    margin: 1rem;\n    max-height: calc(100vh - 2rem);\n    z-index: 99999999999 !important;\n    position: relative !important;\n  }\n  .drawer-content {\n    padding: 1.5rem;\n    overflow-y: auto;\n    max-height: calc(100vh - 200px);\n  }\n  .form-row {\n    grid-template-columns: 1fr;\n  }\n  .form-actions {\n    flex-direction: column;\n  }\n  .btn {\n    width: 100%;\n  }\n}\n@media (max-width: 430px) {\n  .drawer-overlay {\n    z-index: 99999999999 !important;\n    position: fixed !important;\n    top: 0 !important;\n    left: 0 !important;\n    right: 0 !important;\n    bottom: 0 !important;\n  }\n  .drawer-container {\n    margin: 0.5rem;\n    max-height: calc(100vh - 1rem);\n    z-index: 99999999999 !important;\n    position: relative !important;\n    max-width: calc(100vw - 1rem);\n  }\n  .drawer-content {\n    padding: 1rem;\n    overflow-y: auto;\n    max-height: calc(100vh - 150px);\n  }\n  .drawer-header {\n    padding: 1rem 1.5rem;\n  }\n  .drawer-title {\n    font-size: 1.25rem;\n  }\n}\n@media (max-width: 650px) {\n  .drawer-overlay {\n    z-index: 99999999999 !important;\n    position: fixed !important;\n    top: 0 !important;\n    left: 0 !important;\n    right: 0 !important;\n    bottom: 0 !important;\n    width: 100vw !important;\n    height: 100vh !important;\n    isolation: isolate !important;\n    transform: translateZ(0) !important;\n    will-change: transform !important;\n  }\n  .drawer-container {\n    z-index: 99999999999 !important;\n    position: relative !important;\n    isolation: isolate !important;\n    transform: translateZ(0) !important;\n  }\n}\n@media (max-width: 650px) {\n  .sidebar {\n    z-index: 1 !important;\n  }\n  .drawer-overlay ~ * .sidebar,\n  .drawer-overlay ~ * * .sidebar,\n  .drawer-overlay ~ * * * .sidebar {\n    z-index: 1 !important;\n  }\n}\n@media (max-width: 650px) {\n  body:has(.drawer-overlay) .sidebar {\n    z-index: 1 !important;\n  }\n  body:has(.drawer-overlay) .drawer-overlay {\n    z-index: 99999999999 !important;\n  }\n}\n/*# sourceMappingURL=edit-user-drawer.component-XQQKZ2B6.css.map */\n'] }]
  }], () => [{ type: ProfileService }, { type: DepartmentService }, { type: RolesService }, { type: FormBuilder }, { type: TranslationService }, { type: LangService }], { data: [{
    type: Input
  }], isRTL: [{
    type: Input
  }], close: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditUserDrawerComponent, { className: "EditUserDrawerComponent", filePath: "src/app/components/users/edit-user-drawer/edit-user-drawer.component.ts", lineNumber: 25 });
})();
...
function UsersList_div_39_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r1.translate("users.no_users_found"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.translate("users.get_started_message"));
    \u0275\u0275advance(2);
...
function UsersList_div_40_div_1_div_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 93)(1, "span", 76);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(5, "svg", 94);
    \u0275\u0275element(6, "rect", 13)(7, "rect", 14)(8, "rect", 15)(9, "rect", 16);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const user_r4 = \u0275\u0275nextContext().$implicit;
...
function UsersList_div_40_div_1_div_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(5, "svg", 94);
    \u0275\u0275element(6, "path", 95)(7, "circle", 96);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const user_r4 = \u0275\u0275nextContext().$implicit;
...
function UsersList_div_40_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(32, "div", 82)(33, "button", 83);
    \u0275\u0275listener("click", function UsersList_div_40_div_1_Template_button_click_33_listener() {
      const user_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openDeleteModal(user_r4));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(34, "svg", 48);
    \u0275\u0275element(35, "polyline", 84)(36, "path", 85);
    \u0275\u0275elementEnd();
    \u0275\u0275text(37);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(38, "button", 86);
    ...
    \u0275\u0275element(40, "path", 87)(41, "path", 88);
    \u0275\u0275elementEnd();
    \u0275\u0275text(42);
    \u0275\u0275elementEnd()()();
  }
...
function UsersList_div_40_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, UsersList_div_40_div_1_Template, 43, 12, "div", 64);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UsersList_div_41_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, UsersList_div_41_tr_21_img_3_Template, 1, 2, "img", 71)(4, UsersList_div_41_tr_21__svg_svg_4_Template, 3, 0, "svg", 101);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td")(16, "span", 102);
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "td")(19, "div", 103)(20, "button", 104);
    ...
    \u0275\u0275element(22, "path", 87)(23, "path", 88);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    ...
    \u0275\u0275element(26, "polyline", 84)(27, "path", 85);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function UsersList_div_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 97)(1, "table", 98)(2, "thead")(3, "tr")(4, "th");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "th");
    \u0275\u0275text(7);
    ...
    \u0275\u0275template(21, UsersList_div_41_tr_21_Template, 28, 10, "tr", 99);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function UsersList_li_66_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "li", 46)(1, "button", 107);
...
function UsersList_app_confirmation_modal_71_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-confirmation-modal", 108);
...
function UsersList_app_edit_user_drawer_72_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-edit-user-drawer", 109);
...
function UsersList_div_73_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(4, "path", 114)(5, "polyline", 115);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "h3", 116);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 117);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
...
var UsersList = class _UsersList {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UsersList, selectors: [["app-users-list"]], standalone: false, decls: 74, vars: 40, consts: [["pageSizeSelect", ""], [1, "users-page", "rounded-5"], [1, "page-title"], [1, "top-bar"], [1, "top-bar-left"], ["routerLink", "/users/add", 1, "add-user-btn"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "plus-icon"], ["x1", "12", "y1", "5", "x2", "12", "y2", "19"], ["x1", "5", "y1", "12", "x2", "19", "y2", "12"], [1, "top-bar-right"], [1, "view-toggle"], [1, "toggle-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x", "3", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "3", "width", "7", "height", "7"], ["x", "14", "y", "14", "width", "7", "height", "7"], ["x", "3", "y", "14", "width", "7", "height", "7"], ["d", "M3 3h18v18H3zM21 9H3M21 15H3M12 9v12"], [1, "search-section", "mb-4"], [1, "row"], [1, "col-md-5"], [1, "search-input-wrapper"], [1, "bi", "bi-search", "search-icon"], ["type", "text", 1, "form-control", "search-input", 3, "ngModelChange", "input", "keyup.enter", "placeholder", "ngModel"], [1, "col-md-2"], [1, "btn", "btn-primary", "w-100", 3, "click"], [1, "bi", "bi-search", "me-2"], [1, "btn", "btn-outline-secondary", "w-100", 3, "click"], [1, "bi", "bi-x-circle", "me-2"], [1, "col-md-3"], ["class", "loading-state", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "users-grid", 4, "ngIf"], ["class", "users-table", 4, "ngIf"], [1, "pagination-section", "ltr"], [1, "pagination-controls"], [1, "page-size-control"], ["for", "pageSize"], ["id", "pageSize", 3, "change", "value"], ["value", "6"], ["value", "12"], ["value", "24"], ["value", "48"], [1, "pagination-info"], ["aria-label", "Users pagination"], [1, "pagination"], [1, "page-item"], [1, "page-link", 3, "click", "disabled"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["points", "15,18 9,12 15,6"], ["class", "page-item", 3, "active", 4, "ngFor", "ngForOf"], ["points", "9,18 15,12 9,6"], [3, "data", "isRTL", "isVisible", "confirm", "cancel", 4, "ngIf"], [3, "data", "isRTL", "close", "userUpdated", 4, "ngIf"], ["class", "success-modal-overlay", 3, "click", 4, "ngIf"], [1, "loading-state"], [1, "spinner"], [1, "empty-state"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1", 1, "empty-icon"], ["d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 0 0-3-3.87"], ["d", "M16 3.13a4 4 0 0 1 0 7.75"], [1, "users-grid"], ["class", "user-card", 4, "ngFor", "ngForOf"], [1, "user-card"], [1, "card-header"], [1, "user-info"], [1, "user-name"], [1, "user-role"], [1, "user-avatar"], [3, "src", "alt", 4, "ngIf"], ["width", "40", "height", "40", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1", 4, "ngIf"], [1, "card-divider"], [1, "card-details"], [1, "detail-row", 3, "click"], [1, "detail-label"], [1, "detail-value"], ["title", "Copy to clipboard", 1, "copy-btn"], ["x", "9", "y", "9", "width", "13", "height", "13", "rx", "2", "ry", "2"], ["d", "M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"], ["class", "detail-row", 4, "ngIf"], [1, "card-actions"], [1, "delete-btn", 3, "click"], ["points", "3,6 5,6 21,6"], ["d", "M19,6v14a2,2,0,0,1-2,2H7a2,2,0,0,1-2-2V6m3,0V4a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2V6"], [1, "edit-btn", 3, "click"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], [3, "src", "alt"], ["width", "40", "height", "40", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1"], ["d", "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"], ["cx", "12", "cy", "7", "r", "4"], [1, "detail-row"], ["width", "16", "height", "16", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "detail-icon"], ["d", "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"], ["cx", "12", "cy", "10", "r", "3"], [1, "users-table"], [1, "table"], [4, "ngFor", "ngForOf"], [1, "user-avatar-small"], ["width", "32", "height", "32", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1", 4, "ngIf"], [1, "status-badge"], [1, "table-actions"], ["title", "Edit", 1, "edit-btn-small", 3, "click"], ["title", "Delete", 1, "delete-btn-small", 3, "click"], ["width", "32", "height", "32", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1"], [1, "page-link", 3, "click"], [3, "confirm", "cancel", "data", "isRTL", "isVisible"], [3, "close", "userUpdated", "data", "isRTL"], [1, "success-modal-overlay", 3, "click"], [1, "success-modal", 3, "click"], [1, "success-icon"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], [1, "success-title"], [1, "success-message"], [1, "success-close-btn", 3, "click"]], template: function UsersList_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function UsersList_Template_button_click_12_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.viewMode.set("cards"));
      });
      \u0275\u0275namespaceSVG();
      \u0275\u0275elementStart(13, "svg", 12);
      \u0275\u0275element(14, "rect", 13)(15, "rect", 14)(16, "rect", 15)(17, "rect", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275text(18);
      \u0275\u0275elementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(19, "button", 11);
      \u0275\u0275listener("click", function UsersList_Template_button_click_19_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275elementEnd()()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(23, "div", 18)(24, "div", 19)(25, "div", 20)(26, "div", 21);
      \u0275\u0275element(27, "i", 22);
      \u0275\u0275elementStart(28, "input", 23);
      \u0275\u0275listener("ngModelChange", function UsersList_Template_input_ngModelChange_28_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.searchTerm.set($event));
      })("input", function UsersList_Template_input_input_28_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSearchInput($event));
      })("keyup.enter", function UsersList_Template_input_keyup_enter_28_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSearchClick());
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(29, "div", 24)(30, "button", 25);
      \u0275\u0275listener("click", function UsersList_Template_button_click_30_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSearchClick());
      });
      \u0275\u0275element(31, "i", 26);
      \u0275\u0275text(32);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(33, "div", 24)(34, "button", 27);
      \u0275\u0275listener("click", function UsersList_Template_button_click_34_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275element(37, "div", 29);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(38, UsersList_div_38_Template, 4, 1, "div", 30)(39, UsersList_div_39_Template, 12, 3, "div", 31)(40, UsersList_div_40_Template, 2, 1, "div", 32)(41, UsersList_div_41_Template, 22, 9, "div", 33);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(6);
      \u0275\u0275property("placeholder", ctx.translate("users.search_users"))("ngModel", ctx.searchTerm());
      \u0275\u0275advance(4);
        ...
        <div class="search-input-wrapper">\r
          <i class="bi bi-search search-icon"></i>\r
           <input\r
             ...
             (ngModelChange)="searchTerm.set($event)"\r
...
\r
  ...
  <div class="empty-state" *ngIf="!loading() && users().length === 0">\r
    ...
    <h3>{{ translate('users.no_users_found') }}</h3>\r
    <p>{{ translate('users.get_started_message') }}</p>\r
    <button class="add-user-btn" routerLink="/users/add">\r
      {{ translate('users.add_user') }}\r
    </button>\r
  </div>\r
...
function AddUserComponent__svg_svg_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "path", 59)(2, "circle", 60);
    \u0275\u0275elementEnd();
  }
}
...
function AddUserComponent_div_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 62);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AddUserComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 62);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AddUserComponent_option_61_Template(rf, ctx) {
  if (rf & 1) {
...
function AddUserComponent_div_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 62);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AddUserComponent_option_69_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 63);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AddUserComponent_div_70_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 62);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function AddUserComponent__svg_svg_94_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function AddUserComponent_div_96_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 66);
    \u0275\u0275listener("click", function AddUserComponent_div_96_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeSuccessModal());
    });
    \u0275\u0275elementStart(1, "div", 67);
    \u0275\u0275listener("click", function AddUserComponent_div_96_Template_div_click_1_listener($event) {
      \u0275\u0275restoreView(_r5);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    ...
    \u0275\u0275element(4, "path", 70)(5, "polyline", 71);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "h3", 72);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function AddUserComponent_div_96_Template_button_click_10_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeSuccessModal());
    });
...
var AddUserComponent = class _AddUserComponent {
  ...
  departments = signal([], ...ngDevMode ? [{ debugName: "departments" }] : []);
  roles = signal([], ...ngDevMode ? [{ debugName: "roles" }] : []);
  constructor(fb, usersService, departmentService, rolesService, translationService, langService, router) {
    this.fb = fb;
    this.usersService = usersService;
    this.departmentService = departmentService;
    this.rolesService = rolesService;
  ...
  static \u0275fac = function AddUserComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AddUserComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(UsersService), \u0275\u0275directiveInject(DepartmentService), \u0275\u0275directiveInject(RolesService), \u0275\u0275directiveInject(TranslationService), \u0275\u0275directiveInject(LangService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddUserComponent, selectors: [["app-add-user"]], standalone: false, decls: 97, vars: 59, consts: [[1, "add-user-page", "rounded-5"], [1, "add-user-container"], [1, "page-header"], [1, "page-title"], [1, "close-btn", 3, "click"], ["width", "24", "height", "24", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["x1", "18", "y1", "6", "x2", "6", "y2", "18"], ["x1", "6", "y1", "6", "x2", "18", "y2", "18"], [1, "user-form", 3, "ngSubmit", "formGroup"], [1, "avatar-section"], [1, "avatar-upload"], [1, "avatar-preview"], ["alt", "Avatar preview", 3, "src", 4, "ngIf"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1", 4, "ngIf"], [1, "upload-instructions"], [1, "upload-text"], [1, "upload-hint"], [1, "upload-requirements"], [1, "upload-actions"], ["type", "file", "id", "avatar-input", "accept", "image/jpeg,image/jpg,image/png", 1, "file-input", 3, "change"], ["for", "avatar-input", 1, "upload-btn"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"], ["points", "7,10 12,15 17,10"], ["x1", "12", "y1", "15", "x2", "12", "y2", "3"], ["type", "button", "class", "remove-btn", 3, "click", 4, "ngIf"], [1, "form-fields"], [1, "form-row"], [1, "form-group"], ["for", "firstName", 1, "form-label"], ["type", "text", "id", "firstName", "formControlName", "firstName", 1, "form-input", 3, "placeholder"], ["class", "error-message", 4, "ngIf"], ["for", "lastName", 1, "form-label"], ["type", "text", "id", "lastName", "formControlName", "lastName", 1, "form-input", 3, "placeholder"], ["for", "phoneNumber", 1, "form-label"], ["type", "tel", "id", "phoneNumber", "formControlName", "phoneNumber", 1, "form-input", 3, "placeholder"], ["for", "email", 1, "form-label"], ["type", "email", "id", "email", "formControlName", "email", 1, "form-input", 3, "placeholder"], ["for", "role", 1, "form-label"], ["id", "role", "formControlName", "role", 1, "form-select"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], ["for", "departmentId", 1, "form-label"], ["id", "departmentId", "formControlName", "departmentId", 1, "form-select"], ["for", "password", 1, "form-label"], ["type", "password", "id", "password", "formControlName", "password", 1, "form-input", 3, "placeholder"], ["for", "timeZone", 1, "form-label"], ["id", "timeZone", "formControlName", "timeZone", 1, "form-select"], ["value", "Asia/Dubai"], ["value", "UTC"], ["value", "America/New_York"], ["value", "Europe/London"], [1, "form-actions"], ["type", "button", 1, "cancel-btn", 3, "click"], ["type", "submit", 1, "submit-btn", 3, "disabled"], ["class", "spinner", "width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 4, "ngIf"], ["class", "success-modal-overlay", 3, "click", 4, "ngIf"], ["alt", "Avatar preview", 3, "src"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1"], ["d", "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"], ["cx", "12", "cy", "7", "r", "4"], ["type", "button", 1, "remove-btn", 3, "click"], [1, "error-message"], [3, "value"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", 1, "spinner"], ["d", "M21 12a9 9 0 11-6.219-8.56"], [1, "success-modal-overlay", 3, "click"], [1, "success-modal", 3, "click"], [1, "success-icon"], ["width", "48", "height", "48", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["d", "M22 11.08V12a10 10 0 1 1-5.93-9.14"], ["points", "22,4 12,14.01 9,11.01"], [1, "success-title"], [1, "success-message"], [1, "success-close-btn", 3, "click"]], template: function AddUserComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(31, "div", 26)(32, "div", 27)(33, "div", 28)(34, "label", 29);
      \u0275\u0275text(35);
      \u0275\u0275elementEnd();
      \u0275\u0275element(36, "input", 30);
      \u0275\u0275template(37, AddUserComponent_div_37_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(38, "div", 28)(39, "label", 32);
      \u0275\u0275text(40);
      \u0275\u0275elementEnd();
      \u0275\u0275element(41, "input", 33);
      \u0275\u0275template(42, AddUserComponent_div_42_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(43, "div", 27)(44, "div", 28)(45, "label", 34);
      \u0275\u0275text(46);
      \u0275\u0275elementEnd();
      \u0275\u0275element(47, "input", 35);
      \u0275\u0275template(48, AddUserComponent_div_48_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "div", 28)(50, "label", 36);
      \u0275\u0275text(51);
      \u0275\u0275elementEnd();
      \u0275\u0275element(52, "input", 37);
      \u0275\u0275template(53, AddUserComponent_div_53_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(54, "div", 27)(55, "div", 28)(56, "label", 38);
      \u0275\u0275text(57);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "select", 39)(59, "option", 40);
      \u0275\u0275text(60);
      \u0275\u0275elementEnd();
      \u0275\u0275template(61, AddUserComponent_option_61_Template, 2, 2, "option", 41);
      \u0275\u0275elementEnd();
      \u0275\u0275template(62, AddUserComponent_div_62_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(63, "div", 28)(64, "label", 42);
      \u0275\u0275text(65);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(66, "select", 43)(67, "option", 40);
      \u0275\u0275text(68);
      \u0275\u0275elementEnd();
      \u0275\u0275template(69, AddUserComponent_option_69_Template, 2, 2, "option", 41);
      \u0275\u0275elementEnd();
      \u0275\u0275template(70, AddUserComponent_div_70_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(71, "div", 27)(72, "div", 28)(73, "label", 44);
      \u0275\u0275text(74);
      \u0275\u0275elementEnd();
      \u0275\u0275element(75, "input", 45);
      \u0275\u0275template(76, AddUserComponent_div_76_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(77, "div", 28)(78, "label", 46);
      \u0275\u0275text(79);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(80, "select", 47)(81, "option", 48);
      \u0275\u0275text(82, "Asia/Dubai");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(83, "option", 49);
      \u0275\u0275text(84, "UTC");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(85, "option", 50);
      \u0275\u0275text(86, "America/New_York");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(87, "option", 51);
      \u0275\u0275text(88, "Europe/London");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(89, AddUserComponent_div_89_Template, 2, 1, "div", 31);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(90, "div", 52)(91, "button", 53);
      \u0275\u0275listener("click", function AddUserComponent_Template_button_click_91_listener() {
        return ctx.cancel();
      });
      \u0275\u0275text(92);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(93, "button", 54);
      \u0275\u0275template(94, AddUserComponent__svg_svg_94_Template, 2, 0, "svg", 55);
      \u0275\u0275text(95);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275template(96, AddUserComponent_div_96_Template, 12, 3, "div", 56);
    }
    if (rf & 2) {
      \u0275\u0275classProp("rtl", ctx.isRTL());
      \u0275\u0275advance(4);
      ...
      \u0275\u0275property("placeholder", ctx.translate("users.email_placeholder"));
      \u0275\u0275advance();
      ...
      \u0275\u0275property("placeholder", ctx.translate("users.password_placeholder"));
      \u0275\u0275advance();
...
\r
          <div class="form-group">\r
            ...
            <input \r
              ...
              [placeholder]="translate('users.email_placeholder')">\r
...
\r
        ...
        <div class="form-row">\r
            ...
            <input \r
              ...
              [placeholder]="translate('users.password_placeholder')">\r
...
`, styles: ['/* src/app/components/users/add-user/add-user.component.css */\n.add-user-page {\n  padding: 0 2rem;\n  font-family: "IBM Plex Sans Arabic", sans-serif;\n  min-height: 100vh;\n}\n.add-user-page.rtl {\n  direction: rtl;\n}\n.add-user-container {\n  max-width: 1800px;\n  margin: 0 auto;\n  background: white;\n  border-radius: 16px;\n  box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);\n  overflow: hidden;\n}\n.page-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 2rem;\n  flex-direction: row;\n  border-bottom: 1px solid #e5e7eb;\n  background: #D4AF5F;\n}\n.page-title {\n  font-size: 1.875rem;\n  font-weight: 700;\n  color: white !important;\n  margin: 0;\n}\n.close-btn {\n  background: none;\n  border: none;\n  padding: 0.5rem;\n  cursor: pointer;\n  color: white !important;\n  border-radius: 0.375rem;\n  transition: background-color 0.2s ease, color 0.2s ease;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.close-btn:hover {\n  background-color: #f3f4f62c;\n  color: #374151;\n}\n.user-form {\n  padding: 2rem;\n}\n.avatar-section {\n  margin-bottom: 2rem;\n  padding: 1rem;\n  background-color: #f9fafb;\n  border-radius: 12px;\n  border: 2px dashed #d1d5db;\n  text-align: center;\n  max-width: 400px;\n  margin-left: auto;\n  margin-right: auto;\n}\n.avatar-upload {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 1.5rem;\n}\n.avatar-preview {\n  width: 120px;\n  height: 120px;\n  border-radius: 50%;\n  background-color: #e5e7eb;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  overflow: hidden;\n  border: 3px solid #f3f4f6;\n}\n.avatar-preview.has-image {\n  border-color: var(--brand-green, #158638);\n}\n.avatar-preview img {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n}\n.avatar-preview svg {\n  color: #9ca3af;\n  width: 64px;\n  height: 64px;\n}\n.upload-instructions {\n  text-align: center;\n}\n.upload-text {\n  font-size: 1.125rem;\n  font-weight: 600;\n  color: #374151;\n  margin: 0 0 0.5rem 0;\n}\n.upload-hint {\n  font-size: 0.875rem;\n  color: #6b7280;\n  margin: 0 0 0.25rem 0;\n}\n.upload-requirements {\n  font-size: 0.75rem;\n  color: #9ca3af;\n  margin: 0;\n}\n.upload-actions {\n  display: flex;\n  gap: 1rem;\n  align-items: center;\n}\n.file-input {\n  display: none;\n}\n.upload-btn,\n.remove-btn {\n  padding: 0.75rem 1.5rem;\n  border: none;\n  border-radius: 0.5rem;\n  font-weight: 600;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  transition: all 0.2s ease;\n  font-family: inherit;\n  font-size: 0.875rem;\n}\n.upload-btn {\n  background-color: #B68A35;\n  color: #FFFFFF;\n}\n.upload-btn:hover {\n  background-color: #A87D2A;\n  box-shadow: 0 4px 12px rgba(212, 170, 58, 0.3);\n}\n.remove-btn {\n  background-color: #fef2f2;\n  color: #dc2626;\n  border: 1px solid #fecaca;\n}\n.remove-btn:hover {\n  background-color: #fee2e2;\n  border-color: #fca5a5;\n}\n.form-fields {\n  margin-bottom: 2rem;\n}\n.form-row {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 1.5rem;\n  margin-bottom: 0.5rem;\n}\n.form-group {\n  margin-bottom: 1.5rem;\n}\n.form-label {\n  display: block;\n  font-size: 0.875rem;\n  font-weight: 600;\n  color: #374151;\n  margin-bottom: 0.5rem;\n}\n.form-input,\n.form-select,\n.form-textarea {\n  width: 100%;\n  padding: 0.75rem;\n  border: 1px solid #d1d5db;\n  border-radius: 0.5rem;\n  font-size: 0.875rem;\n  font-family: inherit;\n  transition: border-color 0.2s ease, box-shadow 0.2s ease;\n  background-color: white;\n}\n.form-input:focus,\n.form-select:focus,\n.form-textarea:focus {\n  outline: none;\n  border-color: #B68A35;\n  box-shadow: 0 0 0 3px rgba(212, 170, 58, 0.1);\n}\n.form-input.invalid,\n.form-select.invalid {\n  border-color: #dc2626;\n}\n.form-input.invalid:focus,\n.form-select.invalid:focus {\n  box-shadow: 0 0 0 3px rgba(220, 38, 38, 0.1);\n}\n.form-textarea {\n  resize: vertical;\n  min-height: 100px;\n}\n.error-message {\n  color: #dc2626;\n  font-size: 0.75rem;\n  margin-top: 0.25rem;\n}\n.status-toggle {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n}\n.toggle-input {\n  display: none;\n}\n.toggle-label {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n  cursor: pointer;\n}\n.toggle-slider {\n  position: relative;\n  width: 48px;\n  height: 24px;\n  background-color: #d1d5db;\n  border-radius: 12px;\n  transition: background-color 0.2s ease;\n}\n.toggle-slider::before {\n  content: "";\n  position: absolute;\n  top: 2px;\n  left: 2px;\n  width: 20px;\n  height: 20px;\n  background-color: white;\n  border-radius: 50%;\n  transition: transform 0.2s ease;\n}\n.toggle-input:checked + .toggle-label .toggle-slider {\n  background-color: var(--brand-green, #158638);\n}\n.toggle-input:checked + .toggle-label .toggle-slider::before {\n  transform: translateX(24px);\n}\n.toggle-text {\n  font-size: 0.875rem;\n  font-weight: 500;\n  color: #374151;\n}\n.form-actions {\n  display: flex;\n  gap: 1rem;\n  padding-top: 2rem;\n  border-top: 1px solid #e5e7eb;\n}\n.submit-btn,\n.cancel-btn {\n  padding: 0.75rem 2rem;\n  border: none;\n  border-radius: 0.5rem;\n  font-weight: 600;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  transition: all 0.2s ease;\n  font-family: inherit;\n  font-size: 0.875rem;\n  min-width: 120px;\n  justify-content: center;\n}\n.submit-btn {\n  background-color: #B68A35 !important;\n  color: #FFFFFF;\n}\n.submit-btn:hover:not(:disabled) {\n  background-color: #A87D2A !important;\n  box-shadow: 0 4px 12px rgba(212, 170, 58, 0.3);\n}\n.submit-btn:disabled {\n  background-color: #9ca3af;\n  cursor: not-allowed;\n}\n.cancel-btn {\n  background-color: transparent;\n  border: 1px solid #1B1D21;\n  color: #1B1D21;\n  font-weight: 600 !important;\n}\n.cancel-btn:hover {\n  background-color: #1B1D21;\n  color: #FFFFFF;\n}\n.spinner {\n  animation: spin 1s linear infinite;\n}\n@keyframes spin {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n.add-user-page.rtl .form-actions {\n  justify-content: flex-start;\n}\n@media (max-width: 768px) {\n  .add-user-page {\n    padding: 1rem;\n  }\n  .avatar-section {\n    max-width: 100%;\n  }\n  .add-user-container {\n    border-radius: 12px;\n  }\n  .page-header {\n    padding: 1.5rem;\n  }\n  .user-form {\n    padding: 1.5rem;\n  }\n  .form-row {\n    grid-template-columns: 1fr;\n    gap: 1rem;\n  }\n  .form-actions {\n    flex-direction: column;\n  }\n  .submit-btn,\n  .cancel-btn {\n    width: 100%;\n  }\n  .upload-actions {\n    flex-direction: column;\n    width: 100%;\n  }\n  .upload-btn,\n  .remove-btn {\n    width: 100%;\n    justify-content: center;\n  }\n}\n.success-modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background: rgba(0, 0, 0, 0.5);\n  -webkit-backdrop-filter: blur(4px);\n  backdrop-filter: blur(4px);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 9999;\n  padding: 1rem;\n}\n.success-modal {\n  background: white;\n  border-radius: 12px;\n  padding: 2rem;\n  text-align: center;\n  max-width: 400px;\n  width: 100%;\n  box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);\n  animation: modalSlideIn 0.3s ease-out;\n}\n@keyframes modalSlideIn {\n  from {\n    opacity: 0;\n    transform: scale(0.95) translateY(-10px);\n  }\n  to {\n    opacity: 1;\n    transform: scale(1) translateY(0);\n  }\n}\n.success-icon {\n  margin-bottom: 1rem;\n  color: #158638;\n}\n.success-title {\n  font-size: 1.5rem;\n  font-weight: 700;\n  color: #111827;\n  margin: 0 0 0.5rem 0;\n}\n.success-message {\n  color: #6b7280;\n  margin: 0 0 1.5rem 0;\n  font-size: 1rem;\n}\n.success-close-btn {\n  background: #B68A35;\n  color: #FFFFFF;\n  border: none;\n  padding: 0.75rem 1.5rem;\n  border-radius: 8px;\n  font-weight: 600;\n  cursor: pointer;\n  transition: all 0.2s;\n  font-size: 0.875rem;\n  min-width: 100px;\n}\n.success-close-btn:hover {\n  background: #A87D2A;\n  transform: translateY(-1px);\n}\n.add-user-page.rtl .success-modal {\n  direction: rtl;\n}\n@media (min-width: 1400px) {\n  .add-user-page {\n    padding: 1.5rem;\n  }\n  .add-user-container {\n    max-width: 1400px;\n  }\n  .page-header {\n    padding: 1.25rem 1.5rem;\n  }\n  .page-title {\n    font-size: 1.5rem;\n  }\n  .user-form {\n    padding: 1.25rem 1.5rem;\n  }\n  .form-row {\n    gap: 1rem;\n    margin-bottom: 0.5rem;\n  }\n  .form-group {\n    margin-bottom: 1rem;\n  }\n  .form-label {\n    font-size: 0.9rem;\n  }\n  .form-input,\n  .form-select,\n  .form-textarea {\n    padding: 0.6rem 0.7rem;\n    font-size: 0.9rem;\n  }\n  .avatar-section {\n    max-width: 360px;\n    padding: 0.75rem;\n    margin-bottom: 1rem;\n  }\n  .avatar-upload {\n    gap: 0.5rem;\n  }\n  .avatar-preview {\n    width: 84px;\n    height: 84px;\n  }\n  .upload-text {\n    font-size: 0.95rem;\n    margin: 0 0 0.2rem 0;\n  }\n  .upload-hint {\n    font-size: 0.8rem;\n    margin: 0 0 0.15rem 0;\n  }\n  .upload-requirements {\n    font-size: 0.7rem;\n  }\n  .form-actions {\n    padding-top: 1.25rem;\n    gap: 0.75rem;\n  }\n  .submit-btn,\n  .cancel-btn {\n    padding: 0.6rem 1.2rem;\n    font-size: 0.85rem;\n    min-width: 110px;\n  }\n}\n@media (max-width: 1400px) and (min-width: 1025px) {\n  .add-user-page {\n    padding: 1rem;\n  }\n  .add-user-container {\n    max-width: 1600px;\n  }\n  .page-header {\n    padding: 1.6rem;\n  }\n  .page-title {\n    font-size: 1.6rem;\n  }\n  .close-btn {\n    padding: 0.45rem;\n  }\n  .user-form {\n    padding: 1.6rem;\n  }\n  .avatar-section {\n    margin-bottom: 0.75rem;\n    padding: 0.5rem;\n    max-width: 440px;\n  }\n  .avatar-preview {\n    width: 96px;\n    height: 96px;\n  }\n  .avatar-upload {\n    gap: 0.5rem;\n  }\n  .upload-text {\n    font-size: 1rem;\n    margin: 0 0 0.25rem 0;\n  }\n  .upload-hint {\n    font-size: 0.82rem;\n    margin: 0 0 0.15rem 0;\n  }\n  .upload-requirements {\n    font-size: 0.7rem;\n    margin: 0;\n  }\n  .upload-actions {\n    gap: 0.75rem;\n  }\n  .upload-btn,\n  .remove-btn {\n    padding: 0.65rem 1.3rem;\n    font-size: 0.82rem;\n  }\n  .form-fields {\n    margin-bottom: 1.6rem;\n  }\n  .form-row {\n    gap: 1.25rem;\n    margin-bottom: 0.5rem;\n  }\n  .form-group {\n    margin-bottom: 1.25rem;\n  }\n  .form-label {\n    font-size: 0.82rem;\n    margin-bottom: 0.45rem;\n  }\n  .form-input,\n  .form-select,\n  .form-textarea {\n    padding: 0.65rem;\n    font-size: 0.85rem;\n  }\n  .toggle-text {\n    font-size: 0.82rem;\n  }\n  .toggle-slider {\n    width: 44px;\n    height: 22px;\n  }\n  .toggle-slider::before {\n    width: 18px;\n    height: 18px;\n  }\n  .form-actions {\n    gap: 0.75rem;\n    padding-top: 1.6rem;\n  }\n  .submit-btn,\n  .cancel-btn {\n    padding: 0.65rem 1.6rem;\n    font-size: 0.85rem;\n    min-width: 110px;\n  }\n  .success-modal {\n    padding: 1.6rem;\n  }\n  .success-title {\n    font-size: 1.3rem;\n  }\n  .success-message {\n    font-size: 0.95rem;\n  }\n  .success-close-btn {\n    padding: 0.65rem 1.3rem;\n    font-size: 0.85rem;\n  }\n}\n/*# sourceMappingURL=add-user.component-MWJNHXFK.css.map */\n'] }]
  }], () => [{ type: FormBuilder }, { type: UsersService }, { type: DepartmentService }, { type: RolesService }, { type: TranslationService }, { type: LangService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddUserComponent, { className: "AddUserComponent", filePath: "src/app/components/users/add-user/add-user.component.ts", lineNumber: 19 });
})();
...
//# sourceMappingURL=chunk-CI3HVERU.js.map

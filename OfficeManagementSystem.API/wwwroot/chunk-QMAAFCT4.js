...
var UnauthorizedComponent = class _UnauthorizedComponent {
  ...
  authService;
  currentLang = "en";
  constructor(router, translationService, langService, authService) {
    this.router = router;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UnauthorizedComponent, selectors: [["app-unauthorized"]], standalone: false, decls: 40, vars: 8, consts: [[1, "unauthorized-container"], [1, "language-toggle"], [1, "lang-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2"], ["cx", "12", "cy", "12", "r", "10"], ["x1", "2", "y1", "12", "x2", "22", "y2", "12"], ["d", "M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"], [1, "content"], [1, "error-icon"], [1, "lock-icon"], [1, "lock-body"], [1, "lock-shackle"], [1, "error-number"], [1, "error-message"], [1, "error-title"], [1, "error-description"], [1, "action-buttons"], [1, "btn", "btn-primary", 3, "click"], ["x", "3", "y", "3", "width", "18", "height", "18", "rx", "2", "ry", "2"], ["x1", "9", "y1", "9", "x2", "15", "y2", "9"], ["x1", "9", "y1", "12", "x2", "15", "y2", "12"], ["x1", "9", "y1", "15", "x2", "15", "y2", "15"], [1, "btn", "btn-secondary", 3, "click"], ["d", "M19 12H5M12 19l-7-7 7-7"]], template: function UnauthorizedComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function UnauthorizedComponent_Template_button_click_35_listener() {
...
\r
    ...
    <div class="action-buttons">\r
      ...
      <button class="btn btn-secondary" (click)="goToLogin()">\r
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">\r
          <path d="M19 12H5M12 19l-7-7 7-7"></path>\r
        </svg>\r
        <span>{{ translate('unauthorized.go_to_login') }}</span>\r
      </button>\r
    </div>\r
  </div>\r
</div>\r
`, styles: ['/* src/app/components/unauthorized/unauthorized.component.css */\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n.unauthorized-container {\n  min-height: 100vh;\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: "Poppins", sans-serif;\n  background:\n    linear-gradient(\n      135deg,\n      #F9F7ED 0%,\n      #F2ECCF 100%);\n  padding: 1.34rem;\n  position: relative;\n}\n.language-toggle {\n  position: absolute;\n  top: 1.34rem;\n  right: 1.34rem;\n  z-index: 10;\n}\n.lang-btn {\n  display: flex;\n  align-items: center;\n  gap: 0.34rem;\n  padding: 0.5rem 0.67rem;\n  background: rgba(255, 255, 255, 0.9);\n  border: 0.67px solid #B68A35;\n  border-radius: 5.36px;\n  color: #1B1D21;\n  font-size: 0.59rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s ease;\n  box-shadow: 0 1.34px 2.68px rgba(0, 0, 0, 0.1);\n  -webkit-backdrop-filter: blur(6.7px);\n  backdrop-filter: blur(6.7px);\n}\n.lang-btn:hover {\n  background: #B68A35;\n  color: white;\n  transform: translateY(-0.67px);\n  box-shadow: 0 2.68px 5.36px rgba(191, 171, 134, 0.3);\n}\n.unauthorized-container.rtl .language-toggle {\n  right: auto;\n  left: 1.34rem;\n}\n.content {\n  text-align: center;\n  max-width: 335px;\n  width: 100%;\n}\n.error-icon {\n  margin-bottom: 1.34rem;\n  display: flex;\n  justify-content: center;\n}\n.lock-icon {\n  width: 53.6px;\n  height: 53.6px;\n  background: #B68A35;\n  border-radius: 10.72px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n  box-shadow: 0 6.7px 16.75px rgba(191, 171, 134, 0.3);\n}\n.lock-body {\n  width: 21.44px;\n  height: 16.08px;\n  background: white;\n  border-radius: 4.02px 4.02px 0 0;\n  position: relative;\n}\n.lock-shackle {\n  width: 10.72px;\n  height: 10.72px;\n  border: 2px solid white;\n  border-radius: 50%;\n  position: absolute;\n  top: -5.36px;\n  left: 50%;\n  transform: translateX(-50%);\n  border-bottom: none;\n  border-right: none;\n}\n.error-number {\n  font-size: 2.68rem;\n  font-weight: 700;\n  color: #1B1D21;\n  margin-bottom: 0.67rem;\n  letter-spacing: -0.02em;\n}\n.error-message {\n  margin-bottom: 2rem;\n}\n.error-title {\n  font-size: 1.26rem;\n  font-weight: 600;\n  color: #1B1D21;\n  margin-bottom: 0.67rem;\n  line-height: 1.2;\n}\n.error-description {\n  font-size: 0.75rem;\n  color: #5F646D;\n  line-height: 1.6;\n  max-width: 268px;\n  margin: 0 auto;\n}\n.action-buttons {\n  display: flex;\n  gap: 0.67rem;\n  justify-content: center;\n  flex-wrap: wrap;\n}\n.btn {\n  display: flex;\n  align-items: center;\n  gap: 0.34rem;\n  padding: 0.59rem 1rem;\n  border: none;\n  border-radius: 5.36px;\n  font-size: 0.67rem;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.2s ease;\n  text-decoration: none;\n  min-width: 107.2px;\n  justify-content: center;\n}\n.btn-primary {\n  background:\n    linear-gradient(\n      135deg,\n      #B68A35 0%,\n      #B68A35 100%);\n  color: white;\n  box-shadow: 0 2.68px 9.38px 0 rgba(191, 171, 134, 0.4);\n}\n.btn-primary:hover {\n  background:\n    linear-gradient(\n      135deg,\n      #B68A35 0%,\n      #92722A 100%);\n  transform: translateY(-0.67px);\n  box-shadow: 0 4px 13.4px 0 rgba(191, 171, 134, 0.5);\n}\n.btn-secondary {\n  background: white;\n  color: #1B1D21;\n  border: 0.67px solid #B68A35;\n  box-shadow: 0 0.67px 2px 0 rgba(0, 0, 0, 0.1);\n}\n.btn-secondary:hover {\n  background: #F9F7ED;\n  border-color: #B68A35;\n  transform: translateY(-0.67px);\n  box-shadow: 0 2.68px 4px -0.67px rgba(0, 0, 0, 0.1);\n}\n.unauthorized-container.rtl {\n  direction: rtl;\n  text-align: right;\n  font-family: "IBM Plex Sans Arabic", sans-serif;\n}\n.unauthorized-container.rtl .content {\n  text-align: center;\n}\n.unauthorized-container.rtl .action-buttons {\n  flex-direction: row-reverse;\n}\n.unauthorized-container.rtl .btn {\n  flex-direction: row-reverse;\n}\n@media (max-width: 768px) {\n  .unauthorized-container {\n    padding: 1rem;\n  }\n  .language-toggle {\n    top: 1rem;\n    right: 1rem;\n  }\n  .unauthorized-container.rtl .language-toggle {\n    right: auto;\n    left: 1rem;\n  }\n  .content {\n    max-width: 100%;\n  }\n  .error-number {\n    font-size: 3rem;\n  }\n  .error-title {\n    font-size: 1.5rem;\n  }\n  .error-description {\n    font-size: 1rem;\n  }\n  .action-buttons {\n    flex-direction: column;\n    align-items: center;\n  }\n  .btn {\n    width: 100%;\n    max-width: 280px;\n  }\n  .unauthorized-container.rtl .action-buttons {\n    flex-direction: column;\n  }\n  .unauthorized-container.rtl .btn {\n    flex-direction: row;\n  }\n}\n@media (max-width: 480px) {\n  .error-number {\n    font-size: 2.5rem;\n  }\n  .error-title {\n    font-size: 1.25rem;\n  }\n  .lock-icon {\n    width: 60px;\n    height: 60px;\n  }\n  .lock-body {\n    width: 24px;\n    height: 18px;\n  }\n  .lock-shackle {\n    width: 12px;\n    height: 12px;\n    top: -6px;\n  }\n}\n/*# sourceMappingURL=unauthorized.component-S7MQ4VCF.css.map */\n'] }]
  }], () => [{ type: Router }, { type: TranslationService }, { type: LangService }, { type: AuthService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UnauthorizedComponent, { className: "UnauthorizedComponent", filePath: "src/app/components/unauthorized/unauthorized.component.ts", lineNumber: 13 });
})();
...
//# sourceMappingURL=chunk-QMAAFCT4.js.map

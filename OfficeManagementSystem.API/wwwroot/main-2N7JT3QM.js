...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-AEOVGTSD.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-VZSZQ23Q.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-U4BE7CPO.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-WT7HLPK5.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-2N7JT3QM.js.map

...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-5HP6SLQL.js").then((m) => m.LayoutModule)
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-4LI7HD75.js").then((m) => m.AuthModule)
  },
  {
    path: "unauthorized",
    loadChildren: () => import("./chunk-YTLNVRW2.js").then((m) => m.UnauthorizedModule)
  },
  {
    path: "**",
    loadChildren: () => import("./chunk-WEFQA3X2.js").then((m) => m.NotFoundModule)
  }
];
...
//# sourceMappingURL=main-RTRNIZ2X.js.map
